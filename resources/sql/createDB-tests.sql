...
create table fs_geds (fs_fid1 varchar(40), fs_fid2 varchar(40), fs_ged double, constraint pk_fs_geds primary key (fs_fid1, fs_fid2)) engine=InnoDB;

create table fs_cluster_assignments (fs_fragment_version_id varchar(40), fs_cluster_id varchar(80), fs_clone_id varchar(40), fs_maximal boolean, fs_core_object_nb int, constraint pk_fs_cluster_assignments primary key (fs_fragment_version_id, fs_cluster_id)) engine=InnoDB;
