...
public class Parser extends java_cup_grappa.runtime.lr_parser {
	...
	public java_cup_grappa.runtime.Symbol do_action(
			int act_num,
			java_cup_grappa.runtime.lr_parser parser,
...
class CUP$Parser$actions {
	...
	void attrStmt(int kind, String macroName) {
		...
		for (int i = 0; i < attrs.size(); i++) {
			if ((attr = (Attribute) (attrs.elementAt(i))).getValue() == null) {
				...
				switch (kind) {
					case Grappa.NODE:
						parser.debug_message(1,
								"adding node default attr (" + attr.getName() + ") to thisGraph(" +
								thisGraph.getName() + ")");
						thisGraph.setNodeAttribute(attr);
						break;
					case Grappa.EDGE:
						parser.debug_message(1,
								"adding edge default attr (" + attr.getName() + ") to thisGraph(" +
								thisGraph.getName() + ")");
						thisGraph.setEdgeAttribute(attr);
						break;
					case Grappa.SUBGRAPH:
						parser.debug_message(1,
								"adding subg default attr (" + attr.getName() + ") to thisGraph(" +
								thisGraph.getName() + ")");
	...
	void closeSubg() {
		...
		parser.debug_message(1,
				"Created subgraph (" + lastSubgraph.getName() + ") in subgraph (" +
				thisGraph.getName() + ")...");
		parser.debug_message(1, "thisGraph(" + thisGraph.getName() + ")");
	}
	...
	void appendNode(String name, String port) {
		if ((thisNode = rootSubgraph.findNodeByName(name)) == null) {
			...
			parser.debug_message(1,
					"Node already in subgraph (" + thisNode.getSubgraph().getName() + ")...");
		}
		...
		for (int i = 1; i < edges.size(); i++) {
			...
			if (((Boolean) (tailPair[1])).booleanValue()) { // true if node list
				...
				while (enu.hasMoreElements()) {
					edgeRHS((Node) (enu.nextElement()), null, headPair, key, name);
				}
			}
			tailPair = headPair;
		}
	...
	void edgeRHS(Node tail, String tailPort, Object[] headPair, Attribute keyAttr,
		...
		if (((Boolean) (headPair[1])).booleanValue()) { // true if node list
			...
			for (int j = 0; j < list.size(); j++) {
				nodePair = (Object[]) (list.elementAt(j));
				thisEdge = new Edge(thisGraph, tail, tailPort, (Node) (nodePair[0]),
						   (String) (nodePair[1]), key, name);
				parser.debug_message(1,
						"Creating edge in subgraph (" + thisGraph.getName() + ")...");
			...
			Enumeration enu = subg.elements(Grappa.NODE);
			while (enu.hasMoreElements()) {
				thisEdge = new Edge(thisGraph, tail, tailPort, (Node) (enu.nextElement()), null,
						   key, name);
				parser.debug_message(1,
						"Creating edge in subgraph (" + thisGraph.getName() + ")...");
				parser.debug_message(1, "thisEdge(" + thisEdge.getName() + ")");
	...
	void applyAttrs(Element elem, Attribute skip1, Attribute skip2) {
		...
		for (int i = 0; i < attrs.size(); i++) {
			...
			if (elem instanceof Edge && attr.getName().equals(GrappaConstants.POS_ATTR)) {
				//added by little@2007.11.27
				//modify the pos attribute to append arrow tail and arrow head
				String arrowhead = (String) elem.getAttributeValue(GrappaConstants.ARROWHEAD_ATTR);
				...
				String arrowtail = (String) elem.getAttributeValue(GrappaConstants.ARROWTAIL_ATTR);
				...
				String newValue = attr.getStringValue() + " " + itail + "," + ihead;
	...
	public final java_cup_grappa.runtime.Symbol CUP$Parser$do_action(
		...
		switch (CUP$Parser$act_num) {
			...
			case 62: { // optSeparator ::=
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(17 /*optSeparator*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
			...
			case 59: { // optSemi ::=
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(16 /*optSemi*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 57: { // optSubgHdr ::=
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(5 /*optSubgHdr*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 55: { // optSubgHdr ::= SUBGRAPH ATOM
				String RESULT = null;
				int valleft = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top -
							  0)).left;
				int valright = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top -
							   0)).right;
				String val = (String) ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
			...
			case 54: { // subgraph ::= optSubgHdr NT$2 body
				...
				if (((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top -
						1)).value != null) {
					RESULT = (Object) ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
							 CUP$Parser$top - 1)).value;
				}
				int valleft = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top -
							  2)).left;
				int valright = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top -
							   2)).right;
				String val = (String) ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
							 CUP$Parser$top - 2)).value;

				closeSubg();

				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(22 /*subgraph*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 2)).left,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			}
			return CUP$Parser$result;
			...
			case 52: { // graphAttrDefs ::= attrAssignment
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(25 /*graphAttrDefs*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).left,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 51: { // attrMacro ::= ATSIGN ATOM
				Object RESULT = null;
				int nameleft = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top -
							   0)).left;
				int nameright = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
								CUP$Parser$top - 0)).right;
				String name = (String) ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
							  CUP$Parser$top - 0)).value;

				appendAttr(name, null);

				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(30 /*attrMacro*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 1)).left,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 50: { // attrAssignment ::= ATOM EQUAL ATOM
				...
				int nameleft = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top -
							   2)).left;
				int nameright = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
								CUP$Parser$top - 2)).right;
				String name = (String) ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
							  CUP$Parser$top - 2)).value;
				int valueleft = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
								CUP$Parser$top - 0)).left;
				int valueright = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
								 CUP$Parser$top - 0)).right;
				String value = (String) ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
							   CUP$Parser$top - 0)).value;

				appendAttr(name, value);

				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(29 /*attrAssignment*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 2)).left,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 49: { // attrItem ::= attrMacro
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(28 /*attrItem*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).left,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 47: { // attrDefs ::= attrDefs optSeparator attrItem
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(27 /*attrDefs*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 2)).left,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 45: { // optAttrDefs ::=
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(26 /*optAttrDefs*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 43: { // attrList ::= optAttr LBR optAttrDefs RBR
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(24 /*attrList*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 3)).left,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			}
			return CUP$Parser$result;
			...
			case 42: { // optAttr ::=
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(20 /*optAttr*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 40: { // optMacroName ::=
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(7 /*optMacroName*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 38: { // attrType ::= EDGE
				...
				int valright = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top -
							   0)).right;
				Integer val = (Integer) ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
							  CUP$Parser$top - 0)).value;

				RESULT = new Integer(Grappa.EDGE);

				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(4 /*attrType*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).left,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 35: { // attrStmt ::= graphAttrDefs
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(15 /*attrStmt*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).left,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 34: { // attrStmt ::= attrType optMacroName attrList
				Object RESULT = null;
				int typeleft = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top -
							   2)).left;
				int typeright = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
								CUP$Parser$top - 2)).right;
				Integer type = (Integer) ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
							   CUP$Parser$top - 2)).value;
				int nameleft = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top -
							   1)).left;
				int nameright = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
								CUP$Parser$top - 1)).right;
				String name = (String) ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
							  CUP$Parser$top - 1)).value;
			...
			case 33: { // optPort ::=
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(8 /*optPort*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 31: { // node ::= ATOM optPort
				...
				String name = (String) ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
							  CUP$Parser$top - 1)).value;
				int portleft = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top -
							   0)).left;
				int portright = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
								CUP$Parser$top - 0)).right;
				String port = (String) ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
							  CUP$Parser$top - 0)).value;
			...
			case 30: { // nodeList ::= nodeList COMMA node
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(21 /*nodeList*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 2)).left,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 28: { // rCompound ::=
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(3 /*rCompound*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 27: { // rCompound ::= edge_op NT$1 simple rCompound
				...
				if (((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top -
						2)).value != null) {
					RESULT = (Boolean) ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
							 CUP$Parser$top - 2)).value;
				}
				int valleft = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top -
							  0)).left;
				int valright = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top -
							   0)).right;
				Boolean val = (Boolean) ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
							  CUP$Parser$top - 0)).value;
			...
			case 25: { // edge_op ::= ND_EDGE_OP
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(31 /*edge_op*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).left,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 23: { // simple ::= subgraph
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(19 /*simple*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).left,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 21: { // compound ::= simple rCompound optAttr
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(18 /*compound*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 2)).left,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 18: { // stmtList ::= stmt
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(13 /*stmtList*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).left,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 16: { // optStmtList ::=
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(12 /*optStmtList*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 13: { // optGraphName ::=
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(6 /*optGraphName*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 11: { // graphType ::= DIGRAPH
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(2 /*graphType*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).left,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 9: { // optStrict ::=
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(1 /*optStrict*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 5: { // hdr ::= optStrict graphType optGraphName
				Object RESULT = null;
				int strictleft = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
								 CUP$Parser$top - 2)).left;
				int strictright = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
								  CUP$Parser$top - 2)).right;
				Boolean strict = (Boolean) ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
								 CUP$Parser$top - 2)).value;
				int typeleft = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top -
							   1)).left;
				int typeright = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
								CUP$Parser$top - 1)).right;
				Boolean type = (Boolean) ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
							   CUP$Parser$top - 1)).value;
				int nameleft = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top -
							   0)).left;
				int nameright = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
			...
			case 4: { // graph ::=
				...
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(9 /*graph*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
			...
			case 3: { // graph ::= error
				...
				int valright = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top -
							   0)).right;
				Object val = (Object) ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
							 CUP$Parser$top - 0)).value;

				//CUP$parser.report_error ("An error was encountered while graph parsing (" + val.toString() + ").", null);
				parser.report_error("An error was encountered while graph parsing (" + val.toString() +
						").", null);
			...
			case 0: { // $START ::= graph EOF
				Object RESULT = null;
				int start_valleft = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 1)).left;
				int start_valright = ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									 CUP$Parser$top - 1)).right;
				Object start_val = (Object) ((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
								   CUP$Parser$top - 1)).value;
				RESULT = start_val;
				CUP$Parser$result = new java_cup_grappa.runtime.Symbol(0 /*$START*/,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 1)).left,
									((java_cup_grappa.runtime.Symbol) CUP$Parser$stack.elementAt(
									CUP$Parser$top - 0)).right, RESULT);
