 ...
 * @version 1.0
 */
public class EPCSubstFunctionShape extends GrappaShape implements CustomRenderer {
	...
	public EPCSubstFunctionShape(Element element, double x_, double y_, double width_,
			double height_) {
