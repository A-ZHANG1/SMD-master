...
public class MultiAtomic extends GrappaShape implements CustomRenderer {
	private Element element;
	private static final float F = (float) 0.8;

	public MultiAtomic(Element element, double x_, double y_, double width_, double height_) {
