...
public class SplitJoinCompositeTask extends GrappaShape implements CustomRenderer {
	...
	public SplitJoinCompositeTask(Element element, double x_, double y_, double width_,
			double height_) {
