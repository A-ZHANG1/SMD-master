...
public class SplitJoinTask extends GrappaShape implements CustomRenderer {
	...
	public SplitJoinTask(Element element, double x_, double y_, double width_, double height_) {
