...
public class EPCFromMerge {
	...
	public static EPCFromMerge loadEPML(String fileLocation){
		EPCFromMerge result = new EPCFromMerge();
		
        EPCParserFromMerge handler = new EPCParserFromMerge(result);
