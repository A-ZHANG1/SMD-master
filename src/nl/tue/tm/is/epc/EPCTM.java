...
public class EPCTM {
	 ...
	 * @return the EPC.
	 */
	public static EPCTM loadEPML(String fileLocation){
	 ...
	 * @return the EPC
	 */
	public static EPCTM loadEPML(String fileLocation, String epcId){
		EPCTM result = new EPCTM();
		
        DefaultHandler handler = new EPCParserTM(result, epcId, null);
	 ...
	 * @return the EPC
	 */
	public static EPCTM loadEPMLByName(String fileLocation, String epcName){
		EPCTM result = new EPCTM();
		
        DefaultHandler handler = new EPCParserTM(result, null, epcName);
        SAXParserFactory factory = SAXParserFactory.newInstance();
