...
public interface NamedQueries {
	...
	public static final String DELETE_ALL_CLUSTER_ASSIGNMENTS = "clusterAssignment.deleteAllCusterAssignments";
	public static final String DELETE_ALL_CLUSTERS = "clusterInfo.deleteAllCusters";
	public static final String GET_ALL_CLUSTERS = "clusterInfo.getAllClusters";
	public static final String GET_CLUSTER_BY_ID = "clusterInfo.getClusterById";
    public static final String GET_FILTERED_CLUSTERS = "clusterInfo.getFilteredClusters";
    ...
    public static final String GET_ROOT_FRAGMENT_IDS_ABOVE_SIZE = "fragmentVersion.getRootFragmentIdAboveSize";
    ...
    public static final String GET_EDGES_BY_FRAGMENT = "edge.getEdgesByFragmentId";
    ...
    public static final String GET_ALL_DAGS_WITH_SIZE = "fragmentVersionDag.getAllDagsWithSize";
    public static final String GET_ALL_DAGS_WITHIN_SIZE = "fragmentVersionDag.getAllDagsWithinSize";
    ...
    public static final String GET_VERTICES_BY_FRAGMENT = "node.getVerticesByFragmentId";
    public static final String GET_STORED_VERTICES = "node.getStoredVertices";
    
	public static final String GET_FRAGMENTS_OF_PROCESS_NAME = "fragmentVersion.getFragmentsOfProcessName";
	public static final String GET_SHARED_FRAGMENT_IDS = "fragmentVersion.getSharedFragmentIds";
	public static final String GET_PROCESS_NAMES_OF_FRAGMENT = "fragmentVersion.getProcessesOfFragment";
	public static final String GET_ROOT_FRAGMENT_ID_OF_CURRENT_VERSION = "processModelVersion.getCurrentRootFragmentId";
