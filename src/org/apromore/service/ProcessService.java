...
public interface ProcessService {
	...
	List<String> importProcesses(String username, String folderPath, String domain, String documentation, String created,
			String lastUpdate) throws ImportException;
     ...
     * @return
     */
	String exportProcessAsEPML(String processName);

	String getRootFragmentId(int processId);

	void addProcessModel(String processName, String epmlString) throws ImportException;

	String getRootFragmentId(String processName);
}
