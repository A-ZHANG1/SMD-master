...
public interface RepositoryService {
     ...
     * @param processModelGraph the actual model in a process graph format
    ...
    /**
     * Deletes all repository data except the user information.
     */
     ...
     */
    void deleteProcessModel(String processName, String branchName);

	Collection<String> deleteProcess(String processName);
}
