...
public class Decomposer implements IDecomposer {
...
//        String hash = HashUtil.computeHash(f, op);
	...
	private FragmentVersion addFragmentVersion(RPSTNode f, String hash, Map<String, String> childMappings, int fragmentSize,
		...
		// mappins (UUIDs generated for pocket Ids -> Pocket Ids assigned to pockets when they are persisted in the database)
