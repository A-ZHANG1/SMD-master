...
//        unlockDescendantFragments(fragVersionDagDao.findFragmentVersionDag(fragmentId));
        fragVersionDao.setLockStatus(fragmentId, Constants.NO_LOCK);
        List<FragmentVersionDagId> childIds = fragVersionDagDao.getChildMappings(fragmentId);
     ...
     */
    @Override
    public void unlockDescendantFragments(FragmentVersionDagId fragmentVersionDag) {
//        unlockChildFragments(fragmentVersionDag.getFragmentVersionByFragVerId());
    	fragVersionDao.setLockStatus(fragmentVersionDag.getFragmentVersionId(), Constants.NO_LOCK);
        List<FragmentVersionDagId> childIds = fragVersionDagDao.getChildMappings(fragmentVersionDag.getFragmentVersionId());
        for (FragmentVersionDagId childId : childIds) {
            unlockDescendantFragments(childId);
        }
    }
