 ...
 */
@Service("SubprocessAwareComposer")
@Transactional(propagation = Propagation.REQUIRED)
public class SubprocessAwareComposer {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(SubprocessAwareComposer.class);
    ...
    // original code
    @Autowired
    private ProcessStandardizer standardizer;
