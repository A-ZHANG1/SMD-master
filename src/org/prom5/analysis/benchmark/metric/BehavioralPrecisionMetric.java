...
public class BehavioralPrecisionMetric implements BenchmarkMetric {
	 ...
	 * behavioral precision value of
	 *   the mined model.
	 * @param referenceModel The Petri net used to measure
	 *   behavioral precision of the mined model.
	 * @param progress Progress
	 * @return The behavioral precision value (<code>[0, 1]</code>) of the mined model. If the
	 * behavioral precision value cannot be calculated, the value <code>BenchmarkMetric.INVALID_MEASURE_VALUE</code> is returned.
	 */
	public double measure(PetriNet model, LogReader referenceLog, PetriNet referenceModel,
		...
		try {
			...
			TraceParsing behavioralMetrics = new TraceParsing(referenceLog, HNreferenceModel,
											 HNmodel);
			return behavioralMetrics.getPrecision();
		} catch (Exception e) {
			System.err.println(
					"BehavioralPrecisionMetric >>> Could not calculate the behavioral precision value!");
			e.printStackTrace();
	...
	/**
	 *
	 * @return A human-readable name of this metric (less than 30
	 *   characters, preferably)
	 * @todo Implement this
