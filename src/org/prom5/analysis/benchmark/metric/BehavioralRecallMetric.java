...
public class BehavioralRecallMetric implements BenchmarkMetric {
	 ...
	 * behavioral recall value of
	 *   the mined model.
	 * @param referenceModel The Petri net used to measure
	 *   behavioral recall of the mined model.
	 * @param progress Progress
	 * @return The behavioral recall value (<code>[0, 1]</code>) of the mined model. If the
	 * behavioral recall value cannot be calculated, the value <code>BenchmarkMetric.INVALID_MEASURE_VALUE</code> is returned.
	 */
