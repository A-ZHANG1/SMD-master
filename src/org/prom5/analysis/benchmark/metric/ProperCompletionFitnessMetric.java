...
public class ProperCompletionFitnessMetric implements BenchmarkMetric {
	 ...
	 *  proper completion fitness value.
	 * @param referenceModel This parameter is not used and, therefore, can be
	 *  <code>null</code>
	 * @param progress Progress
	 * @return The proper completion fitness value (<code>[0, 1]</code>) of the mined model. If the
	...
	public double measure(PetriNet model, LogReader referenceLog, PetriNet referenceModel,
		...
		try {
			...
			Fitness fitness = FitnessFactory.getFitness(FitnessFactory.PROPER_COMPLETION_INDEX, referenceLog,
			...
			System.err.println(
					"ProperCompletionFitnessMetric >>> Could not calculate the proper completion fitness value!");
			e.printStackTrace();
