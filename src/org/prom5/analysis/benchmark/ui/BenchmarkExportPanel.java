...
public class BenchmarkExportPanel extends JPanel {
	...
	public BenchmarkExportPanel(List<BenchmarkItem> benchmarkItems, List<BenchmarkMetric> benchmarkMetrics) {
		...
		semicolonBox = new JCheckBox("use semicolon separators (MS Excel compliant)");
		...
		exportButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				export(columnHeaderBox.isSelected(), rowHeaderBox.isSelected(), semicolonBox.isSelected());
			}
		});
	...
	public void export(boolean exportColumnHeaders, boolean exportRowHeaders, boolean useSemicolons) {
		String separator = ", ";
		if(useSemicolons == true) {
			separator = "; ";
		}
		FileDialog saveDialog = new FileDialog(MainUI.getInstance(), "Choose save location...", FileDialog.SAVE);
	...
	protected void writeCsv(Writer writer, boolean exportColumnHeaders, boolean exportRowHeaders, String separator) 
			throws IOException {
