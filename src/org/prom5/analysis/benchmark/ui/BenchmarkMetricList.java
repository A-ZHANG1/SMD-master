...
public class BenchmarkMetricList extends RoundedPanel {
	...
	public BenchmarkMetricList(BenchmarkUI bUI) {
		...
		metricScrollPane.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
		metricScrollPane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
