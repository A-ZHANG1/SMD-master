...
public class CausalFootprintSimilarity implements AnalysisPlugin {
	...
	public AnalysisInputItem[] getInputItems() {
		AnalysisInputItem[] items = {
									new AnalysisInputItem("Causal footprints", 2, 2) {
	...
	public JComponent analyse(AnalysisInputItem[] analysisInputItemArray) {
		...
		return new CausalFootprintSimilarityResult(analysisInputItemArray[0].getProvidedObjects()[0],analysisInputItemArray[0].getProvidedObjects()[1]);
	}
