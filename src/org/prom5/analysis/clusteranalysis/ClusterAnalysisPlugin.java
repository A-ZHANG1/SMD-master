 ...
 * @version 1.0
 */
public class ClusterAnalysisPlugin implements AnalysisPlugin {

	protected AggregateProfile agProfiles;
	protected ClusterSet clusters;

	public ClusterAnalysisPlugin() {
	}

	public String getHtmlDescription() {
		return "<p> This plug-in read trace clustering result and make decision tree.<p> ";
	}
	...
	public String getName() {
		return "Decision tree for clustering";
	}
...
//				agProfiles = clusters.getAGProfiles();
		...
		ClusterDecisionAnalyzer ana = new ClusterDecisionAnalyzer();
