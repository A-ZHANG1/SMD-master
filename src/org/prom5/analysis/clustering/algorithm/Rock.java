...
public class Rock {
	...
	double theta = 0.3; //�Ѱ谪(threshold). theta���� similarity�� ũ��, neighbor�� �����Ѵ�.
	double[][] goodness = new double[numOfProcess][numOfProcess]; //���μ����� Ŭ�����͸� ���յ�
	double indexOnEstimation = 0.5; //Ŭ�����͸� �򰡰��

	double[][] q = new double[numOfProcess][numOfProcess - 1]; //���� �ִ�����(goodness)
	int[][] q1 = new int[numOfProcess][numOfProcess - 1]; //���� �ִ�����(������μ����� �ε���)
	...
	int[] includingProcess = new int[numOfProcess]; //Ŭ�����Ͱ� �����ϰ� �ִ� ���μ����� ����

	int[] belongedCluster = new int[numOfProcess]; //���μ����� ���Ե� Ŭ������ �ε���{0,,,k-1}
	...
	public void mergeCluster() {
		...
		for (int i = 0; i < numOfProcess; i++) {
			...
			if (i == u) { //u�� ���������� ���� ��, makeLocalHeap()�Լ��� ����.
				int qSize = 0;
				for (int j = 0; j < numOfProcess; j++) { //u�� �ٸ� ��� ���μ����鿡 ���Ͽ� �ٽ� ���� ������ ��
