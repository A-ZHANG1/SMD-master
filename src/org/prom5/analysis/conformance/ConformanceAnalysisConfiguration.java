...
/**
 * Creates a configuration object that contains all the analysis categories
 * and options that are available for the ConformanceAnalysisPlugin.
 *
 * @author arozinat
 */
public class ConformanceAnalysisConfiguration extends AnalysisConfiguration {
	...
	public ConformanceAnalysisConfiguration() {
		...
		fractionSE_option.setToolTip("The fraction of successfully executed process instances");
		fractionSE_option.setDescription("The <b>successful execution</b> metric <i>p<sub>SE</sub></i> determines the fraction of successfully executed process instances (taking the number of occurrences per trace into account).");
		...
		fractionPC_option.setToolTip("The fraction of properly completed process instances");
		fractionPC_option.setDescription("The <b>proper completion</b> metric <i>p<sub>PC</sub></i> determines the fraction of properly completed process instances (taking the number of occurrences per trace into account).");
		...
		fitnessOptions.setDescription("Fitness evaluates whether the observed process <i>complies with</i> the control flow specified by the process. " +
		...
		aB_option.setToolTip(
				"Simple behavioral appropriateness based on the mean number of enabled transitions");
		aB_option.setDescription("The <b>simple behavioral appropriateness</b> metric <i>sa<sub>B</sub></i> is based on the mean number of enabled transitions during log replay " +
		...
		aaB_option.setToolTip(
				"Advanced behavioral appropriateness based on activity relations that were not observed i the log");
		aaB_option.setDescription("The <b>advanced behavioral appropriateness</b> metric <i>aa<sub>B</sub></i> is based on successorship relations among activities with respect the event relations observed  in the log " +
		...
		behAppropOptions.setDescription(
				"Precision, or Behavioral Appropriateness, evaluates <i>how precisely</i> the model describes the observed process.");
		...
		behAppropOptions.addRequestedMethod(AnalysisMethodEnum.STATE_SPACE); // for improved metric!
		...
		aaS_option.setToolTip(
				"Advanced structural appropriateness based on the punishement of redundant invisible and alternative duplicate tasks.");
		aaS_option.setDescription("The <b>advanced structural appropriateness</b> metric <i>aa<sub>S</sub></i> is based on the detection of redundant invisible tasks (simply superfluous) " +
		...
		structAppropOptions.addRequestedMethod(AnalysisMethodEnum.STATE_SPACE); // for improved metric!
