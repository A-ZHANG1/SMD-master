...
/**
 * The plugin provides some basic conformance analysis between a log and a
 * Petri net model by replaying the log in the model in a non-blocking way.
 *
 * @author arozinat
 */
public class ConformanceAnalysisPlugin implements AnalysisPlugin {
	...
	public JComponent analyse(AnalysisInputItem[] analysisInputItemArray) {
		...
		return new ConformanceAnalysisSettings(this, analysisInputItemArray, petriNet, logReader);
	}
}
