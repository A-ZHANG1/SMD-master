...
public class DiagnosticLogTrace extends ReplayedLogTrace {
	...
	/**
	 * TODO: replace by pointers (potentially proxy objects) to those
	 * ATEs that have actually failed
	 *
	 * Relates each audit trail entry with a diagnostic data structure
	 * that records its conformance check results.
	 */
	 ...
	 * @param ate the audit trail entry for which the diagnostic data is requested
	 * @return the diagnostic data structure for the given audit trail entry if found,
