...
/**
 * The diagnostic edge can be enhanced by diagnostic information
...
public class DiagnosticPNEdge extends ReplayedEdge {
	 ...
	 * store results of the replay analysis in this diagnostic edge
	 */
	public DiagnosticPNEdge(DiagnosticTransition trans, DiagnosticPlace place, ArrayList caseIDs) {
	 ...
	 * store results of the replay analysis in this diagnostic edge
	 */
	public DiagnosticPNEdge(DiagnosticPlace place, DiagnosticTransition trans, ArrayList caseIDs) {
	...
	protected void initDiagnosticDataStructures(ArrayList caseIDs) {
		...
		//	// (because the log reader always creates a new process instance object)
	 ...
	 * @return the number of times passing this edge during log replay for this edge
	 */
