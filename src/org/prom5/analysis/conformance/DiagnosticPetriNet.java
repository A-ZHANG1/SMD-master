 ...
 * Derive subclasses to create custom visualizations of these.
 *
 * @author arozinat
 */
public class DiagnosticPetriNet extends ReplayedPetriNet {
	 ...
	 * TODO - think about how this can be done in better way (writeToDot mechanism must be there)
	 */
	 ...
	 */
	public DiagnosticPetriNet(PetriNet net, ArrayList caseIDs, DiagnosticLogReader replayedLog) {
		super(net, caseIDs);
	 ...
	 * when the visualization state has changed in ConformanceCheckResult.
	 ...
	 * Nevertheless, the list of selected instances and the associated diagnostic log
	...
	/**
	 * {@inheritDoc}
	 * Produces a {@link DiagnosticTransition DiagnosticTransition}.
	 */
	...
	/**
	 * {@inheritDoc}
	 * Produces a {@link DiagnosticPlace DiagnosticPlace}.
	 */
	...
	/**
	 * {@inheritDoc}
	 * Produces a {@link DiagnosticPNEdge DiagnosticPNEdge}.
	 */
	 ...
	 * @return The amount of missing tokens (sum up for all places in the model).
	 */
	 ...
	 * @return The amount of remaining tokens for log trace pi (sum up for all places in the model).
	 */
	public int getRemainingTokens() {
		...
		while (myPlaces.hasNext()) {
			DiagnosticPlace currentPlace = (DiagnosticPlace) myPlaces.next();
			requestedAmount = requestedAmount + currentPlace.getRemainingTokens();
		}
		return requestedAmount;
	}
}
