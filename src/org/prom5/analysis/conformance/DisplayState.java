...
public class DisplayState {
	...
	/**
	 * Represents the model visualization option of indicating
	 * the token counter results.
	 */
	public boolean alwaysFollowsOption = false;

	/**
	 * Represents the model visualization option of indicating
	 * the tasks that have remained enabled.
	 */
	public boolean neverFollowsOption = false;

	/**
	 * Represents the model visualization option of indicating
	 * the tasks that have failed execution.
	 */
	...
	/**
	 * Represents the model visualization option of indicating
	 * the number of times an edge has been passed during log replay.
	 */
	public boolean passedEdgesOption = false;

	/**
	 * Represents the log visualization option of indicating
	 * the log events that have failed execution.
	 */
	public boolean failedEventsOption = false;

	/**
	 * The constructor is private to only allow for pre-defined display states.
	 * @param name The new display state.
	 */
