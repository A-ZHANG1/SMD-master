 ...
 * todo: consider to replace by real enumeration type available in later Java versions
 *
...
public class DecisionAttributeType {
	 ...
	 */
	public static final DecisionAttributeType NOMINAL = new DecisionAttributeType("nominal");

	/**
	 * Denotes a numeric attribute type (i.e., represents a continous numeric type space).
	 */
	public static final DecisionAttributeType NUMERIC = new DecisionAttributeType("numeric");
	...
	public HLTypes.AttributeType getHighLevelAttributeType() {
		// TODO - the whole DecisionAttributeType should be replaced by that AttributeType enum
