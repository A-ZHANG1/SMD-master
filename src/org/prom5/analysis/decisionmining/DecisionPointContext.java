...
/**
 * A decision point context keeps track of the case attributes that have been selected
 * for analysis of the belonging decision point (and their type).
 *
...
public interface DecisionPointContext {
	...
	/**
	 * Data type for specifying the different scoping rules that can be 
	 * applied during the decision point analysis.
	 */
	public enum AttributeSelectionScope { 
		
		ALL_BEFORE("all before"), 
		...
		private AttributeSelectionScope(String name) {
	      ...
	      * @param init the given default will be the first in the list
	      * @return ArrayList a list with all possible values
	      */
	    public static ArrayList<AttributeSelectionScope> getValues(AttributeSelectionScope init) {
	 ...
	 * @return the panel reflecting the content of the attributes view tab
	 * for the belonging decision point
	 */
	public JPanel getAttributesViewPanel();

	/**
	 * Returns the current model view for the belonging decision point.
	 * @return the panel reflecting the content of the model view tab
	 * for the belonging decision point
	 */
	 ...
	 * @return the panel reflecting the content of the results tab
	 * for the belonging decision point
	 */
	 ...
	 * @param the panel containing the new result content
	 */
	 ...
	 * @return the panel reflecting the content of the evaluation tab
	 * for the belonging decision point
	 */
	 ...
	 * @param the panel containing the new evaluation content
	 */
	public void setEvaluationViewPanel(JPanel newResult);

	/**
	 * Returns a vector of those attributes that have been selected for
	 * analysis (can be directly used to build up a data set).
	 ...
	 * @return the currently selected scope for looking at the data attributes in the log
	 */
