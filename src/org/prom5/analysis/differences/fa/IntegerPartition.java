...
/** 
* The IntegerPartition is a class for sets of IntegerSets. No actual checking is done to ensure that the "partition"
* actually is a valid integer partition (i.e. that no different sets of the partition contain the same element).
*
...
public class IntegerPartition {
   ...
   /**
    * Adds a group to the partition. If the group already exists, nothing happens.
    *
    ...
    *
    * @param 	p			The array of groups to add.
    * @param	size		The size of the array of groups.
    * 
    */
    ...
    *
    * @param 	groupNum	The index of the group to return.
    ...
    * @return				An int containing the group index containing the given element. -1 if not found.
    * 
    */
    ...
    *
    * @param 	s			The group to search for.
    ...
    *
    * @param 	p			The partition to check for equality with.
