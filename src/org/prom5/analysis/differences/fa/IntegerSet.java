...
public class IntegerSet {
	...
	public int[] getArray() {
		...
		if(i != currSize) System.out.println("BAHAJANO!!!");
		return array;
	}
	 ...
	 *
	 * @param 	m			The IntegerSet to union with.
	 ...
	 *
	 * @param 	m			The IntegerSet to intersect with.
	 ...
	 *
	 * @param 	d			The integer to look for.
	...
	/**
	 * Removes a given integer from the set. If the integer does not exist in the set, nothing happens.
	 *
	 * @param 	d			The integer to remove.
	 * 
	 */
	...
	/**
	 * Returns the first element of the set (the set is not sorted, so the "first" element is practically the oldest element).
	 *
	...
	/**
	 * Checks if the set is identical (contains the same elements) to a given set.
	 *
	 * @param		m		The set to check for equality with.
