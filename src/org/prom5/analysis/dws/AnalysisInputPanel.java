...
public class AnalysisInputPanel extends JPanel {
	...
	private void jbInit() throws Exception {
		...
		firstPanel.add(testoLabel1, new GridBagConstraints(0, x + y, 1, 1, 0.0D, 0.0D, 17, 0,
				new Insets(0, 33, 0, 0), 0, 0));
		firstPanel.add(sigma, new GridBagConstraints(1, x + y++, 1, 1, 0.0D, 0.0D, 17, 0,
				new Insets(0, 33, 0, 0), 0, 0));
		firstPanel.add(testoLabel2, new GridBagConstraints(0, x + y, 1, 1, 0.0D, 0.0D, 17, 0,
				new Insets(0, 33, 0, 0), 0, 0));
		firstPanel.add(gamma, new GridBagConstraints(1, x + y++, 1, 1, 0.0D, 0.0D, 17, 0,
				new Insets(0, 33, 0, 0), 0, 0));
		firstPanel.add(testoLabel3, new GridBagConstraints(0, x + y, 1, 1, 0.0D, 0.0D, 17, 0,
				new Insets(0, 33, 0, 0), 0, 0));
		firstPanel.add(kField, new GridBagConstraints(1, x + y++, 1, 1, 0.0D, 0.0D, 17, 0,
				new Insets(0, 33, 0, 0), 0, 0));
		firstPanel.add(testoLabel4, new GridBagConstraints(0, x + y, 1, 1, 0.0D, 0.0D, 17, 0,
				new Insets(0, 33, 0, 0), 0, 0));
		firstPanel.add(lField, new GridBagConstraints(1, x + y++, 1, 1, 0.0D, 0.0D, 17, 0,
				new Insets(0, 33, 0, 0), 0, 0));
		firstPanel.add(testoLabel5, new GridBagConstraints(0, x + y, 1, 1, 0.0D, 0.0D, 17, 0,
				new Insets(0, 33, 0, 0), 0, 0));
		firstPanel.add(maxFeatField, new GridBagConstraints(1, x + y++, 1, 1, 0.0D, 0.0D, 17, 0,
				new Insets(0, 33, 0, 0), 0, 0));
