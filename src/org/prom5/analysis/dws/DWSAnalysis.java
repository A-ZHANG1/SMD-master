...
/**
 *  This is the main class implementing the DWS (Disjunctive Workflow Schema) analysis plugin.
 *
 *  It requires that a logReader object and a HeuristicNet model are available( discovered through the corresponding mining plugin).
 *
 *  @author Gianluigi Greco, Antonella Guzzo, Luigi Pontieri
 *  @version 1.0
 *  @see org.prom5.framework.models.heuristics.HeuristicsNet
 */
...
public class DWSAnalysis implements AnalysisPlugin {
	...
	public AnalysisInputItem[] getInputItems() {
		AnalysisInputItem[] items = {
									new AnalysisInputItem("Mined heuristicnet") {
...
// fin qui
				/* gianluigi
				 Object[] o = object.getObjects();
					   ...
					   if (o[1] instanceof LogReader && o[0] instanceof HeuristicsNet) return true;
					   return false;*/
			}
		}
		} ;
	...
	/*
	 * Crea una finestra di input alla quale passa come parametri
	 * il LogReader e l'HeuristicNet ottenuti in automatico nella funzione
	 * getInputItems
	 */
