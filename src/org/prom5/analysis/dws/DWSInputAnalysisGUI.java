...
/*
 * La classe definisce un pannello dwsp di tipi MiningInputPanel per leggere i parametri di input
 * Alla pressione del bottone jButto viene lanciato il clustering
 */
...
//	private Object[]o;
	 ...
	 */
	public DWSInputAnalysisGUI(AnalysisPlugin plugIn, LogReader log, HeuristicsNet net,
		...
		if (jButton == null) {
			...
			jButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					/*
					 * Crea la radice della gerarchia e fa il mining
					 * delle features e fa lo split dei log.
					 * Tuttavia i cluster non sono equipaggiati di features e di un loro
					 * modello.
					 */
					...
					//crea una nuova finestra nella quale visualizzare il risultato del plugin
					MainUI.getInstance().createAnalysisResultFrame(plugIn, inputs,
							new DWSOutputGUI(root));
				}
			});
		}
		return jButton;
