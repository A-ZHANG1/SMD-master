...
public class EPCSoundnessUI extends JPanel implements Provider {
    ...
    public EPCSoundnessUI(ConfigurableEPC epc, TransitionSystem transitionSystem, String message) {
        this.epc=epc;
    ...
    public ProvidedObject[] getProvidedObjects() {
        ...
        new ProvidedObject("Pruned Transition System", new Object[]{transitionSystem}),
