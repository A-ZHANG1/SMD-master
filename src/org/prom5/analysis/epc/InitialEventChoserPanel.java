...
public class InitialEventChoserPanel extends JPanel {
	...
	private void jbInit() throws Exception {
		...
		while (it.hasNext()) {
			...
			eventPanels.add(p);
			eventPanelContainer.add(p, new GridBagConstraints(0,
					i++, 1, 1, 0.0, 0.0
		...
		addButton.addActionListener(new AddButtonActionListener(eventPanels, gridModel));
		...
		showButton.addActionListener(new ShowSelButtonActionListener(grid, graphPanel));
