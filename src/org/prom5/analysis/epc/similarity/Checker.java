...
public class Checker {
	 ...
	 * (see normalizeWord) 3. remove 'stop-words', e.g.: 'for', 'an', 'on' 4.
	 * word 'stemming', e.g.: accounts -> account, accounting -> account, ... 5.
	 * take each word from the shortest label (in number of words) and compute
	 * the 'semantic-match score': semantic match score = 1 if there is an
	 * identical word in the other label semantic match score = 0.75 if there is
	 * a synonym in the other label semantic match score = 0 otherwise 6. add
	 * the semantic match scores for each word in the shortest label and divide
	 * by the number of words in the longest label 7. this is the semantic
	 * equivalence score for the labels
	 * 
	 * @param label1
	 * @param label2
