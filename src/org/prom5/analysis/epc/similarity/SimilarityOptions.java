...
public class SimilarityOptions {
	...
	public SimilarityOptions(double eventThreshold,
			double functionThreshold,
			double eventSemanticWeight,
			double eventSyntaxWeight,
			double functionSemanticWeight,
			double functionSyntaxWeight,
			double functionStructureWeight,
			String footprintFolder,
			int parallelThreads,
			boolean removeInitialFinalNodes,
