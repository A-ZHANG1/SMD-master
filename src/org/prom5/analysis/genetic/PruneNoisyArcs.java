...
/**
 * <p>Title: Prune Noisy Arcs </p>
 * <p>Description: Prune the arcs of an individual. The pruning is based on how often
 * an arc is used while parsing a log. The arcs usage depends on the selected
 * fitness measurement.</p>
...
public class PruneNoisyArcs implements AnalysisPlugin {
	 ...
	 * @param net HeuristicsNet net to be pruned.
	 * @param percentage double pruning percentage. (min value = 0 and max value = 100).
	 * @return double arc usage number.
	 */
	public static double calculatePruningThreshold(HeuristicsNet net, double percentage) {
