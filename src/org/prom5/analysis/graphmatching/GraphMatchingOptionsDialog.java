package org.prom5.analysis.graphmatching;
...
import org.prom5.analysis.graphmatching.algos.DistanceAlgoAbstr;
import org.prom5.analysis.graphmatching.algos.GraphEditDistanceAStarSim;
import org.prom5.analysis.graphmatching.algos.GraphEditDistanceAllOptions;
import org.prom5.analysis.graphmatching.algos.GraphEditDistanceGreedy;
import org.prom5.analysis.graphmatching.algos.GraphEditDistanceLexical;
import org.prom5.analysis.graphmatching.algos.GraphEditDistanceProcessHeuristic;
...
public class GraphMatchingOptionsDialog extends JDialog {
	...
	public GraphMatchingOptionsDialog(){
		...
		this.add(algoLabel, new GridBagConstraints(0, i, 1, 1, 0.0, 0.0,
				GridBagConstraints.EAST, GridBagConstraints.BOTH, INSETS, 0, 0));
		this.add(algoList, new GridBagConstraints(1, i++, 1, 1, 0.0, 0.0,
		...
		this.add(wskipvLabel, new GridBagConstraints(0, i, 1, 1, 0.0, 0.0,
				GridBagConstraints.EAST, GridBagConstraints.BOTH, INSETS, 0, 0));
		this.add(wskipvSlider, new GridBagConstraints(1, i++, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.BOTH, INSETS, 0, 0));
		
		this.add(wskipeLabel, new GridBagConstraints(0, i, 1, 1, 0.0, 0.0,
				GridBagConstraints.EAST, GridBagConstraints.BOTH, INSETS, 0, 0));
		this.add(wskipeSlider, new GridBagConstraints(1, i++, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.BOTH, INSETS, 0, 0));

		this.add(wsubvLabel, new GridBagConstraints(0, i, 1, 1, 0.0, 0.0,
				GridBagConstraints.EAST, GridBagConstraints.BOTH, INSETS, 0, 0));
		this.add(wsubvSlider, new GridBagConstraints(1, i++, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.BOTH, INSETS, 0, 0));

		this.add(ledcutoffLabel, new GridBagConstraints(0, i, 1, 1, 0.0, 0.0,
				GridBagConstraints.EAST, GridBagConstraints.BOTH, INSETS, 0, 0));
		this.add(ledcutoffSlider, new GridBagConstraints(1, i++, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.BOTH, INSETS, 0, 0));

		this.add(pruneatLabel, new GridBagConstraints(0, i, 1, 1, 0.0, 0.0,
				GridBagConstraints.EAST, GridBagConstraints.BOTH, INSETS, 0, 0));
		this.add(pruneatTextBox, new GridBagConstraints(1, i++, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.BOTH, INSETS, 0, 0));

		this.add(prunetoLabel, new GridBagConstraints(0, i, 1, 1, 0.0, 0.0,
				GridBagConstraints.EAST, GridBagConstraints.BOTH, INSETS, 0, 0));
		this.add(prunetoTextBox, new GridBagConstraints(1, i++, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.BOTH, INSETS, 0, 0));

		this.add(eventsLabel, new GridBagConstraints(0, i, 1, 1, 0.0, 0.0,
				GridBagConstraints.EAST, GridBagConstraints.BOTH, INSETS, 0, 0));
		this.add(eventsCheck, new GridBagConstraints(1, i++, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.BOTH, INSETS, 0, 0));

		this.add(groupingLabel, new GridBagConstraints(0, i, 1, 1, 0.0, 0.0,
				GridBagConstraints.EAST, GridBagConstraints.BOTH, INSETS, 0, 0));
		this.add(groupingCheck, new GridBagConstraints(1, i++, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.BOTH, INSETS, 0, 0));
	...
	private void initialize(){
		String algos[] = {"Greedy", "Exhaustive", "Heuristic", "A-star", "Lexical"};
	...
	public DistanceAlgoAbstr showDialog() {
		...
		if (ok){
			...
			Object weights[] = {"vweight",vweight,"sweight",sweight,"eweight",eweight,"ledcutoff",ledcutoff,"prunewhen",prunewhen,"pruneto",pruneto,"useepsilon",useepsilon,"useevents",useevents,"dogrouping",dogrouping};
