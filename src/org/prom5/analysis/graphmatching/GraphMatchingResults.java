...
public class GraphMatchingResults extends JPanel{
    ...
    public GraphMatchingResults(List<String> searchModelNames, List<String> docModelNames, double similarities[][], String matches) {
        ...
        JTable table = new JTable(new SimilarityTableModel(searchModelNames,docModelNames,similarities));
...
class SimilarityTableModel extends AbstractTableModel {
    ...
    public SimilarityTableModel(List<String> searchModelNames, List<String> docModelNames, double similarities[][]){
