...
public class GraphEditDistanceLexical extends DistanceAlgoAbstr implements DistanceAlgo{
	...
	public double compute(SimpleGraph sg1, SimpleGraph sg2) {
		...
		for (Integer g1Func : sg1.getVertices()) {
			for (Integer g2Func : sg2.getVertices()) {
				...
				double edScore = StringEditDistance.similarity(sg1.getLabel(g1Func), sg2.getLabel(g2Func));
