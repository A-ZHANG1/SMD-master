package org.prom5.analysis.graphmatching.graph;
...
public class SimpleGraph {
	...
	private SimpleGraph(Set<Integer> vertices, Map<Integer,Set<Integer>> outgoingEdges, Map<Integer,Set<Integer>> incomingEdges, Map<Integer,String> labels, Set<Integer> functionVertices, Set<Integer> eventVertices, Set<Integer> connectorVertices){
	...
	public SimpleGraph removeVertices(Set<Integer> toRemove){
		...
		Set<Integer> newFunctionVertices = new HashSet<Integer>(functionVertices);
		...
		Set<Integer> newConnectorVertices = new HashSet<Integer>(connectorVertices);
		newConnectorVertices.removeAll(toRemove);
		
		return new SimpleGraph(newVertices, newOutgoingEdges, newIncomingEdges, newLabels, newFunctionVertices, newEventVertices, newConnectorVertices);
	}	
}
