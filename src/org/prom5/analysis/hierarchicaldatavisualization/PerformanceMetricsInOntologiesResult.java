...
public class PerformanceMetricsInOntologiesResult extends JPanel implements Provider {
	...
	public PerformanceMetricsInOntologiesResult(HierarchicalData processingTimes, HierarchicalData throughputTimes) {
		this.setLayout(new BorderLayout());
		this.processingTimes = processingTimes;
		this.throughputTimes = throughputTimes;
		
		final JRadioButton selectProcessingTime = new JRadioButton("Show processing times");
		final JRadioButton selectThroughputTime = new JRadioButton("Show throughput times");
		...
		HeaderBar header = new HeaderBar("Visualize performance metrics in ontologies");
		header.setHeight(40);
	...
	private void update(boolean showProcessingTimes) {
		...
		shownResult = new HierarchicalDataVisualizationResult(showProcessingTimes ? processingTimes : throughputTimes);
	...
	public ProvidedObject[] getProvidedObjects() {
		return shownResult == null ? new ProvidedObject[0] : shownResult.getProvidedObjects();
	}
}
