...
class ThroughputTimeDataElement implements HierarchicalDataElement {
	...
	public ThroughputTimeDataElement(String key, LogStatistic value, Map<String, ModelGraphVertex> mapping) {
		this.value = value.getTimeStampStatistics().getMax() - value.getTimeStampStatistics().getMin();
