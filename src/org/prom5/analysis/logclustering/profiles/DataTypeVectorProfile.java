...
/**
 * Profile which measures the usage of attribute keys, or data
 * types, used in all traces.
 * 
...
public class DataTypeVectorProfile extends VectorProfile {
	...
	public DataTypeVectorProfile(LogReader log) 
		...
		super("Data type profile", "Profile for attribute keys",
		log.getLogSummary().getNumberOfProcessInstances(),
		(String[])scanNumberOfDataTypes(log).toArray());
	}
	
	/**
	 * Helper method; scans a log for the set of observed data
	 * types, i.e. attribute keys.
	 * @param log
	 * @return
