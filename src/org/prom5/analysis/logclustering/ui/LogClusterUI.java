package org.prom5.analysis.logclustering.ui;
...
import org.prom5.analysis.logclustering.LogClusterPlugin;
import org.prom5.analysis.logclustering.clusteringalgorithm.AHClustering;
import org.prom5.analysis.logclustering.clusteringalgorithm.ClusteringAlgorithm;
import org.prom5.analysis.logclustering.clusteringalgorithm.DefaultClustering;
import org.prom5.analysis.logclustering.clusteringalgorithm.KMeansClustering;
import org.prom5.analysis.logclustering.profiles.ActivityVectorProfile;
import org.prom5.analysis.logclustering.profiles.AggregateProfiles;
import org.prom5.analysis.logclustering.profiles.OriginatorVectorProfile;
...
public class LogClusterUI extends JPanel implements GuiNotificationTarget {
	...
	public LogClusterUI (LogClusterPlugin algorithm, AnalysisInputItem[] input, LogReader log) {
	...
	private void jbInit() {
		...
		casGuiList = new GUIPropertyListEnumeration("Clustering Algorithm", casList, this);

	    rightPanel = new JPanel();
		rightPanel.setLayout(new BoxLayout(rightPanel, BoxLayout.Y_AXIS));
		rightPanel.add(casGuiList.getPropertyPanel());
		rightPanel.add(((ClusteringAlgorithm)casGuiList.getValue()).getOptionPanel());
...
//			System.out.println(summary.getModelElements()[i].toString());
		...
		agProfiles = new AggregateProfiles(summary.getNumberOfProcessInstances());
		...
		LogClusterResultUI result = new LogClusterResultUI(myLog,clusteringAlgorithm);
