...
public class HNetLogReaderConnectionPlugin implements AnalysisPlugin {
	...
	public JComponent analyse(AnalysisInputItem[] inputs) {
		...
		HeuristicsNetResultWithLogReader result = new HeuristicsNetResultWithLogReader(hnet, null);

		if (MainUI.getInstance().connectResultWithLog(result, log, this,true,false)) {
			Message.add("</ConnectHeuristicNetWithLog>",Message.TEST);
