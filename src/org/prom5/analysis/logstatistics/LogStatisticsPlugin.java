...
/**
 * Basic analysis plugin initially tailored towards the ASML data set
 * (adjacent Start and End events are assumed for each activity).
 * General functionality should be moved to the LogSummaryPlugin at 
