...
//		}
	...
	public void doTestRun(String reasoningEngine) throws Exception {
		...
		Ontology exampleOntology = loadOntology(
								   "c:\\cygwin\\home\\peter\\workspace\\ProM\\examples\\ontologies\\TaskOntology.wsml");
...
//					WSMLReasonerFactory.BuiltInReasoner.XSB);
		...
		Set<Concept> concepts = reasoner.getAllConcepts((IRI) exampleOntology.getIdentifier());

	     for (Concept concept: concepts){

			 System.out.println(concept.getIdentifier());
//			 System.out.println("superconcepts = " + concept.listSuperConcepts().size());
//			 System.out.println("subconcepts = " + concept.listSubConcepts().size());
//			 System.out.println("instances = " + concept.listInstances().size());


		}

//
//		Set<IRI> attributes = reasoner.getAllAttributes((IRI) exampleOntology.getIdentifier());
//
//
