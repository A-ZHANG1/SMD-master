...
public class SimilarityResultTableUI extends RoundedPanel {
	...
	public SimilarityResultTableUI(SimilarityUI sUI, SimilarityResultTableModel matrix) {
		super(10, 5, 5);
	...
	public void jbInit() throws Exception {
		...
		for (int i = 1; i < table.getColumnCount(); i++) {
			DefaultTableCellRenderer renderer = new ColoredCellRenderer(matrix,sUI.getSelectedMetric());
