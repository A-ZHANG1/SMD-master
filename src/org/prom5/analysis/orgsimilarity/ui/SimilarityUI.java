...
package org.prom5.analysis.orgsimilarity.ui;
...
import org.prom5.analysis.orgsimilarity.SimilarityItem;
import org.prom5.analysis.orgsimilarity.SimilarityModel;
import org.prom5.analysis.orgsimilarity.SimilarityResultTableModel;
...
//	protected JLabel helpHeader;
				...
				for(ProvidedObject providedObject : providedObjects) {
					for(Object object : providedObject.getObjects()) {
						if(object instanceof OrgModel) {
							orgModels.put(frame.getTitle() + " - " + providedObject.getName(), (OrgModel)object);
	...
	protected void showConfigurationPanel() {
		if(configurationPanel == null) {
			...
			metricsEnumeration = new GUIPropertyListEnumeration("Metrics :", null, values, null, 180);
	...
	public void startCalculation() {
		...
		final List<SimilarityItem> similarityItems = itemList.getSimilarityItems();
		simModel = new SimilarityModel(similarityItems);
		SimilarityResultTableModel tableModel = simModel.getResult(0, 1, metricsEnumeration.getValue().toString());
