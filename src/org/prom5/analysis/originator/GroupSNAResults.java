...
public class GroupSNAResults extends JPanel implements Provider {
	...
	private JButton removeButton = new JButton("          Remove isolated nodes          ");
	...
	public GroupSNAResults(SocialNetworkMatrix snMatrix)
	{
		   ...
		   thresholdButton.addActionListener(new ActionListener() {
					 public void actionPerformed(ActionEvent e) {
						 getSNMatrix().applyThresholdValue(Double.valueOf(thresholdField.getText()).doubleValue());
						 redrawGraphPanel();
						 redrawMatrixPanel();
					 };
		   });
		   ...
		   removeButton.addActionListener(new ActionListener() {
			...
			menuPane.add(thresholdField, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0
					, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));

			menuPane.add(thresholdButton, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0
					, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
