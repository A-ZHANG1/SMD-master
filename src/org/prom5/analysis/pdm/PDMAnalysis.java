...
public class PDMAnalysis implements AnalysisPlugin {
	...
	public JComponent analyse(AnalysisInputItem[] inputs) {
		...
		return new PDMAnalysisUI(model);
	...
	public String getHtmlDescription() {
		return "http://is.tm.tue.nl/staff/ivanderfeesten/ProM/documentation/PDMAnalysis.htm";
	}
