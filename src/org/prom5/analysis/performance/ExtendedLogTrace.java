...
public class ExtendedLogTrace extends ReplayedLogTrace {
	 ...
	 *
	 * @param fireTime Date: time at which a transition fires
	 */
	public void recordThroughputTimeMeasurement(Date fireTime) {
		//compare fireTime with beginDate. If fireTime occurs earlier or beginDate
		//equals null, set beginDate to fireTime
		if ((beginDate == null) || (fireTime.before(beginDate))){
			beginDate = fireTime;
		}
		//compare fireTime with endDate. If fireTime occurs later or endDate equals
