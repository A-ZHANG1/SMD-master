 ...
 * {@link AnalysisMethod AnalysisMethod} and provides those categories with the
 * results that have asked for it.
 * It is required to have the analysis running in a thread.
 *
...
public class PerformanceAnalysisMethodExecutionThread extends Thread {
	 ...
	 * @param conf BottleneckConfiguration: the BottleneckConfiguration-object
	 * used
	 * @param set PerformanceAnalysisSettings: the PerformanceAnalysisSettings
	 * object used
	 */
	public PerformanceAnalysisMethodExecutionThread(LogReplayAnalysisMethod method,
		    	PerformanceConfiguration conf, PerformanceAnalysisSettings set) {
		myMethod = method;
		config = conf;
		mySettings = set;
	}
	...
	/**
	 * Executes the given analysis method, provides all registered categories with the
