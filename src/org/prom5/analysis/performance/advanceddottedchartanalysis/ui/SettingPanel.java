...
//	private JButton chooseColorButton = new JButton();
	...
	private void initColorPanel() {
		...
		String type = dottedChartAnalysis.getDottedChartOptionPanel().getColorStandard();
		...
		randomizeColorButton.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(ActionEvent e) {
				randomizeColor(e);
			}
		});
...
//		colorMainPanel.add(chooseColorButton);
	...
	private void randomizeColor(ActionEvent e) {
		ArrayList<String> keySet = dcModel.getItemArrayList(dottedChartAnalysis.getDottedChartOptionPanel().getColorStandard());
