...
public class BoxAndWhiskerChart extends AbstractChart {
	...
	protected DefaultBoxAndWhiskerCategoryDataset getBoxAndWhiskerCategoryDataset(AbstractPerformance performance)
	{
	...
	protected DefaultBoxAndWhiskerCategoryDataset getBoxAndWhiskerCategoryDataset(AbstractPerformance2D performance2D)
	{	
	...
	protected JPanel getOptionPanel()
	{
		...
		performanceSort = new GUIPropertyListEnumeration("Time Sort:", "", performanceList, this, 150);
