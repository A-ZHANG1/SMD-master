...
//        chartPanel.setMaximumDrawWidth( 2000 ); 
	...
	protected JPanel getOptionPanel()
	{
		...
		// for zoom slide bar
		zoomSliderX = new JSlider(JSlider.VERTICAL, 0, 2000, 0); // zooms in view
...
/*	
	...
	public void stateChanged(ChangeEvent e) {
		...
		if((e.getSource()==zoomSliderX)){
			double zoom = Math.max(1.0,(double)zoomSliderX.getValue() / 100.0);
...
//			rangeAxis.setLabelFont(new Font("SansSerif", Font.PLAIN, 10));
			...
			axis.setLabelFont(new Font("SansSerif", Font.PLAIN, (10-updWidth/300)));
