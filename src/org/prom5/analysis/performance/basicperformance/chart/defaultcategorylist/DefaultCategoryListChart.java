package org.prom5.analysis.performance.basicperformance.chart.defaultcategorylist;
...
import org.prom5.analysis.performance.basicperformance.chart.defaultcategory.DefaultCategoryChart;
...
public class DefaultCategoryListChart extends DefaultCategoryChart implements ItemListener {
	...
	public DefaultCategoryListChart(String name,String desc, BasicPerformanceAnalysisUI pm) {
		super(name, desc, pm);
		nullCheckBox.setSelected(false);
		nullCheckBox.addItemListener(this);
	}
	...
	// Spider Chart //////////////////////////////////////////////////////////////////////////////
	protected ArrayList<DefaultCategoryDataset> getDefaultCategoryListDataset(AbstractPerformance performance)
	{
		...
		for (String aItem : items) {
			if(performanceSort.getValue().equals("Waiting Time")||performanceSort.getValue().equals("Both")||performanceSort.getValue().equals("All")){
			...
			if(performanceSort.getValue().equals("Working Time")||performanceSort.getValue().equals("Both")||performanceSort.getValue().equals("All")){
			...
			if(performanceSort.getValue().equals("Sojourn Time")||performanceSort.getValue().equals("Both")||performanceSort.getValue().equals("All")){
		...
		if(performanceSort.getValue().equals("Waiting Time")||performanceSort.getValue().equals("Both")||performanceSort.getValue().equals("All")) datasetArray.add(tempdataset);
		if(performanceSort.getValue().equals("Working Time")||performanceSort.getValue().equals("Both")||performanceSort.getValue().equals("All")) datasetArray.add(tempdataset2);
		if(performanceSort.getValue().equals("Sojourn Time")||performanceSort.getValue().equals("Both")||performanceSort.getValue().equals("All")) datasetArray.add(tempdataset3);
		return datasetArray;
	}

	
	protected ArrayList<DefaultCategoryDataset> getDefaultCategoryListDataset(AbstractPerformance2D performance2D)
	{
			...
			for (String aItem : items) {
				...
				for (String bItem : items2) {
					if(performanceSort.getValue().equals("Working Time")){
						StatisticUnit su = performance2D.getExecutionTimeSU(aItem+" - "+bItem); 
						if(su!=null&&su.getStatistics().getN()!=0) {
						...
						StatisticUnit su = performance2D.getWaitingTimeSU(aItem+" - "+bItem);
						if(su!=null&&su.getStatistics().getN()!=0) {
							addDate(tempdataset,su, aItem, bItem);
						}
						else if(nullCheckBox.isSelected())
						...
						su = performance2D.getWaitingTimeSU(aItem+" - "+bItem);
						if(su!=null&&su.getStatistics().getN()!=0) {
