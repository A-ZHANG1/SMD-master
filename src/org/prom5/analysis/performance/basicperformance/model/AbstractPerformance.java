...
public abstract class AbstractPerformance {
	 ...
	 * Creates a new profile with the given name and description
	 */
	public AbstractPerformance(String aName, String aDescription, List<String> aItems) {
		name = aName;
		itemName = aName;
		description = aDescription;
		items = aItems;
...
/*	public AbstractPerformance(String aName, String aDescription, List<String> aItems) {
	...
	*/
	...
	public void addTaskSeries(String aItem, Date start, Date end)
	{
		...
		taskSeries.add(new Task(aItem+"_"+indexGannt++,new SimpleTimePeriod(start,end)));
	}
