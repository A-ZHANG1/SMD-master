...
public class InstOriTPerformance extends AbstractPerformance2D {
	public InstOriTPerformance(LogReader inputLog){
		super("Instance-Originator", "Instance", "Originator", "Instance-Originator performance");

		items = new ArrayList<String>();
		items2 = new ArrayList<String>(Arrays.asList(inputLog.getLogSummary().getOriginators()));
