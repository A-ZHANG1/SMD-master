...
package org.prom5.analysis.performance.dottedchart;
...
import org.prom5.analysis.performance.dottedchart.ui.OverviewPanel;
import org.prom5.analysis.performance.dottedchart.ui.SettingPanel;
...
public class DottedChartAnalysis extends JPanel implements Provider{
	...
	private int[] selectedInstanceIndicesfromScreen; // indices of the process instances used
	...
	public DottedChartAnalysis(DottedChartPlugin algorithm, AnalysisInputItem[] input, LogReader log) {
	...
	private void jbInit() {
		...
		chartPane = new JScrollPane(dottedChartPanel, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS, JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
		...
		settingPanel = new SettingPanel(inputLog, this, dottedChartPanel, dcModel);
			...
			if (selectedInstanceIndices != null) {
				...
				if(selectedInstanceIndicesfromScreen==null){
					...
					ProvidedObject[] objects = {
											   ...
											   selectedInstanceIndices),
											   dottedChartPanel.getColorReference()}),
											   new ProvidedObject("Log Selection from Screen", new Object[] {
											   LogReaderFactory.createInstance(inputLog,
				...
				ProvidedObject[] objects = new ProvidedObject[] {new ProvidedObject("Dotted Chart",
										   new Object[] {inputLog,dottedChartPanel.getColorReference()})};
				return objects;
