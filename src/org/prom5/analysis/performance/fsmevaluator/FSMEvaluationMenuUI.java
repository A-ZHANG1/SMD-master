...
public class FSMEvaluationMenuUI extends JPanel implements Provider {
	...
	public void startCalculation() {
		...
		fsmEvaluationStatistics.analysis(logReaders.get(logsEnumeration.getValue()),acceptFSM,fsmStatistics,(String)estimatorSort.getValue());
		FSMEvaluationAnalysisUI ui = new FSMEvaluationAnalysisUI(acceptFSM, fsmEvaluationStatistics);
...
//				};
	   ...
	   protected void initTimeSort()
	   {
			...
			timeList.add("months");
			timeList.add("years");
			timeUnitSort = new GUIPropertyListEnumeration("Time Unit:", "", timeList, null, 150);
