...
import org.prom5.mining.regionmining.ParikhLanguageRegionMiner;
 ...
 * @version 1.0
 */
public class ParikhLanguageNetExtender extends ParikhLanguageRegionMiner implements
        AnalysisPlugin {
    ...
    public AnalysisInputItem[] getInputItems() {
        AnalysisInputItem[] items = {
                                    ...
                                    new AnalysisInputItem(
                "Petrinet with associated Log") {
            ...
            public boolean accepts(ProvidedObject object) {
                ...
                for (int i = 0; i < o.length; i++) {
                    if (o[i] instanceof LogReader) {
                        ...
                        hasPetriNet = true; //((PetriNet) o[i]).findRandomInvisibleTransition() == null;;
                    }
                }
    ...
    public JComponent analyse(AnalysisInputItem[] analysisInputItemArray) {
        ...
        return (JComponent)new MiningSettings(logReader,
                                  "Settings for parikhMining Analysis plugin", this).getContentPane();
