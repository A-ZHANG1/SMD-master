 ...
 * CPN tools. In the case that a new color set has to be defined, only the write method
 * needs to be implemented, because all the other properties hold for each colorset in
 * CPN tools. If needed any inheriting class may be defined its own additional properties
 * and methods
 *
 * @author rmans
 * @author arozinat
...
public abstract class CpnColorSet {
	 ...
	 * @param name String the name of the colorset.
	 */
	 ...
	 * @param o Object the object that needs to be compared with this object.
	 * @return boolean true, if both objects are of the same type and have the same name.
	 */
	public boolean equals(Object o) {
		return (o instanceof CpnColorSet && ((CpnColorSet) o).getNameColorSet().equals(getNameColorSet()));
	}
