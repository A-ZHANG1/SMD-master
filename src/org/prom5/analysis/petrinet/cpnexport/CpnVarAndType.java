...
public class CpnVarAndType {
	 ...
	 * @param typeName String the type
	 */
	...
	public void write(BufferedWriter bw) throws IOException{
		bw.write("\t\t\t<var id=\"" + ManagerID.getNewID() + "\">\n" +
			"\t\t\t\t<type>\n" +
			"\t\t\t\t\t<id>" + CpnUtils.getCpnValidName(myTypeName) + "</id>\n" +
			"\t\t\t\t</type>\n" +
			"\t\t\t\t<id>" + CpnUtils.getCpnValidName(myVarName) + "</id>\n" +
			"\t\t\t\t<layout>" + "var " + myVarName + " : " + myTypeName + ";" + "</layout>\n" +
			"\t\t\t</var>\n");
	}

	/**
	 * Returns the complete cpn compliant representation for the variable
	 * and its type
	 ...
	 * Returns true if both are a CpnVarAndType object and have the same variable name.
	 * @param o Object object to be compared for equality with this CpnVarAndType.
	 * @return boolean if the specified object is equal to this CpnVarAndType.
	 */
	public boolean equals(Object o) {
		return (o instanceof CpnVarAndType &&
				((CpnVarAndType) o).getVarName().equals(getVarName()));
	}
