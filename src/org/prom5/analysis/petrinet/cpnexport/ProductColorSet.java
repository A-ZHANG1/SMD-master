...
public class ProductColorSet extends CpnColorSet {
	...
	/**
	 * Constructor
	 * @param name String the name of the product color set.
	 */
	 ...
	 * @param nameColorSet String the name of the color set to be added.
	 */
	...
	public void write(BufferedWriter bw) throws IOException {
		...
		bw.write("\t\t\t\t</product>\n");
		if (myTimed) {
			bw.write("\t\t\t\t<layout>" + "colset " + CpnUtils.getCpnValidName(myNameColorSet) + " = product "
