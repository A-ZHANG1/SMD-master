...
public class SubpageMapping implements Cloneable{
	 ...
	 * @param id the cpnID for the subpage of a transition.
	 */
	 ...
	 * @param sub ColoredPlace the subplace
	 * @param top ColoredPlace the topplace
	 */
	 ...
	 * @param sub ColoredPlace the place on the sub page
	 ...
	 * @param top ColoredPlace the place on the top page
	 ...
	 * Note, that because a cloned mapping from a place on the subpage to a place on the top page
	 * has to be made, that the cloned places on the subpage and top page level has to
	 * be provided.
	 * @param topPlacesNew ArrayList the cloned places on the top page level
	 * @param subPlacesNew ArrayList the cloned places on the sub page level
	 * @return Object the cloned subpage mapping
	 * @throws CloneNotSupportedException
	 */
	public Object clone(ArrayList topPlacesNew, ArrayList subPlacesNew) throws CloneNotSupportedException {
		...
		while (allMappings.hasNext()) {
			...
			// Find the corresponding cloned places for oldSubplace and oldTopPlace
	...
	/**
	 * A mapping from a place on a subpage (subplace) to a place on the upper page
	 * (topplace) is defined.
	 * @author arozinat
	 * @author Ronny Mans
	 */
	class Mapping {
		 ...
		 * @return String the string representation for this mapping that can
		 * be used for writing to the cpn-file.
		 */
		...
		/**
		 * returns the string representation of the cpn-id of the subplace for this
		 * mapping.
		 * @return String
		 */
		...
		/**
		 * Returns the string representation of the cpn-id of the topplace for this
		 * mapping.
		 * @return String
		 */
