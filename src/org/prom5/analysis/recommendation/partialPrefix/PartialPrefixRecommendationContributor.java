package org.prom5.analysis.recommendation.partialPrefix;

import org.prom5.analysis.recommendation.contrib.LogBasedContributor;
import org.prom5.framework.models.logabstraction.PartialPrefixAbstractionFactory;
...
/*
	public RecommendationResult generateFilteredRecommendations(RecommendationQuery query,
		...
		// TODO generalize the int
		LogAbstraction incompletePIAbstraction = ((PartialPrefixAbstractionFactory)logAbstractionFactory).getAbstraction(pi, scale, 3);
