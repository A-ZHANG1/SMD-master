...
public class PetriNetGraph extends GGGraph {
  ...
  */
    public PetriNetGraph(final RedesignAnalysisUI parent, final HLPetriNet model) {
       ...
       /**
        * at selection of the node, the associated model displays the nodes,
        * node colors may have been updated.
        */
       ...
       /**
        * at selection reset of the node, the associated model displays the nodes,
        * node colors may have been updated.
        */
  ...
  /** 
   * Returns a specific transition contained in this graph by the first element
   * of its label. This is its identifier. 
   */ 
    ...
    /**
     * Returns the petri net nodes which are currently selected in the GUI
     * of this graph. If no nodes are selected, all nodes of the petri net
     * are returned.
     *
     ...
     * of this graph. If no transitions are selected, all transitions of the petri net
     * are returned.
     *
     * @return ArrayList<Transition> selectedTransitionList the selected transitions or
     * ArrayList<Transition> AllTransitionList all transitions in the petrinet
     */
