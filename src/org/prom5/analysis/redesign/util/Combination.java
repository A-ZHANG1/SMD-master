		    ...
		    */
		    public static List<List<PNNode>> getCombinations(List<PNNode> list) {
		        ...
		        if (list.size() > 1) {
		            ...
		            /**
		             *  Remove the object at the current position from objects
		             *  this method is called with all resulting objects
		             */
...
//		=============Determination of the power set of a set of strings============    
	    public static void main(String[] args) {
	        
	        //construct the set S = {a,b,c}
	        String set[] = {"a", "b", "c","d","e","f","g","h","i","j","k","l",
	        		"m","n","o","p","q","r"};
