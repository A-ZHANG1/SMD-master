package org.prom5.analysis.sample;
...
public class SampleAnalysisPlugin {
	...
	@Analyzer(name = "Sample double Petri net analyzer", names = {"Petri net A", "Petri net B"}, connected = false)
	...
	@Analyzer(name = "Sample Log with Petri net analyzer", names = {"Log", "Petri net"})
	...
	@Analyzer(name = "Sample Disconnected Log with Petri net analyzer", names = {"Petri net", "Log"}, connected = false)
