...
//	private NumberVertexValue vertex_weight = null;
	...
	public  String calculateDegree(boolean[] selectedDegreeOptions) {
		...
		if (selectedDegreeOptions[0]) stringBuffer.append("In Degree\t");
		if (selectedDegreeOptions[1]) stringBuffer.append("Out Degree\t");
		stringBuffer.append("\n");
		...
		if (selectedDegreeOptions[0])
			stringBuffer.append("average in Degree = " + String.valueOf(inDegree_sum/vertices.size())+"\n");
		if (selectedDegreeOptions[1])
			stringBuffer.append("average out Degree = " + String.valueOf(outDegree_sum/vertices.size())+"\n\n\n");
