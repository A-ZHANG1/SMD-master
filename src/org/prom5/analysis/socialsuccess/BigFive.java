...
import org.prom5.analysis.socialsuccess.bigfive.Agreeableness;
import org.prom5.analysis.socialsuccess.bigfive.Conscientiousness;
import org.prom5.analysis.socialsuccess.bigfive.Extraversion;
import org.prom5.analysis.socialsuccess.bigfive.Neuroticism;
import org.prom5.analysis.socialsuccess.bigfive.Openness;
...
public class BigFive {
	...
	public BigFive(PersonalityData ssd) {
		...
		if (testModus){
			...
			t.add(0,0.25+additionConst); t.add(1,0.6666666666+additionConst); t.add(2, 0.916666+additionConst); t.add(3, 0.0833333+additionConst); t.add(4, 0.25+additionConst);
			test.put("U_1", new Vector<Double>(t));
			t.removeAllElements();
			t.add(0,0.5+additionConst); t.add(1, 0.58333+additionConst); t.add(2, 0.41666+additionConst); t.add(3, 0.3333+additionConst); t.add(4, 0.625+additionConst);
			test.put("U_2", new Vector<Double>(t));
			t.removeAllElements();
			t.add(0,0.75+additionConst); t.add(1, 0.6666+additionConst); t.add(2, 0.5+additionConst); t.add(3, 0.75+additionConst); t.add(4, 0.75+additionConst);
			test.put("U_3", new Vector<Double>(t));
			t.removeAllElements();
			t.add(0, 1.+additionConst); t.add(1, 0.58333+additionConst); t.add(2, 0.41666+additionConst); t.add(3, 0.41666+additionConst); t.add(4, 0.75+additionConst);
			test.put("U_4", new Vector<Double>(t));
			t.removeAllElements();
			t.add(0, 0.+additionConst); t.add(1, 0.+additionConst); t.add(2, 0.25+additionConst); t.add(3, 0.91666+additionConst); t.add(4, 0.125+additionConst);
