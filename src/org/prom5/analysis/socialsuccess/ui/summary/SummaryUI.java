package org.prom5.analysis.socialsuccess.ui.summary;
...
import org.prom5.analysis.socialsuccess.ui.SettingsTab;
...
public class SummaryUI extends JPanel {
	...
	public SummaryUI(PersonalityData socialSuccessData) {
		...
		FlatTabbedPane tabbedPane = new FlatTabbedPane("Summary", 
	 ...
	 * @return the summary of the inputs (which are currently a log file and a org-model)
	 */
