 ...
 * @author Minseok Song
 */
public class ParametricClustering  extends ClusteringAlgorithm implements DotFileWriter, GuiNotificationTarget {
	...
	protected GUIPropertyInteger numberOfCluster = new GUIPropertyInteger("Number of Clusters= ", 3, 1, Integer.MAX_VALUE);
...
//				System.out.println("index = " + index);
				if (index >= clusterSize) index = clusterSize - 1;
			...
			clusters.getClusters().get(clusterSize-1).addTrace(instances[agProfiles.numberOfInstances()-1]);
		}
	...
	protected void setupGUI()
	{
	    ...
	    selectItemBox = new GUIPropertyListEnumeration("Select items =",null,values,null,230);
		menuPanel.add(selectItemBox.getPropertyPanel());

		ArrayList<String> values2 = new ArrayList<String>();
		values2.add(ST_UNIT);
		values2.add(ST_NUMBER);
		selectMethodmBox = new GUIPropertyListEnumeration("Method =",null,values2,null,230);
