 ...
 * @author Minseok Song
 */
public abstract class WekaAlgorithm  extends ClusteringAlgorithm implements DotFileWriter, GuiNotificationTarget {
	...
	{
		super("Weka Clustering",
				"Weka Clustering allows the user to specify"
	...
	protected void assignInstace()
	{
		...
		try{
			for(int i=0;i<data.numInstances();i++) {
				...
				((Cluster) clusters.getClusters().get(k)).addTrace(traceList.get(i));
			}
