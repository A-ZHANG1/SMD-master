package org.prom5.analysis.traceclustering.model;

import java.util.ArrayList;
import java.util.List;

import org.prom5.analysis.traceclustering.util.EfficientSparseDoubleArray;
...
public class InstancePoint {
	...
	public double get(String itemKey) {
		int index = itemKeys.indexOf(itemKey);
		if(index < 0) {
			throw new AssertionError("Item key not contained in this instance point!");
		} else {
