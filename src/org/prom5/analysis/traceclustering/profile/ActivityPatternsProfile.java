...
public class ActivityPatternsProfile extends ActivityCharStreamProfile {
	...
	public ActivityPatternsProfile(LogReader log) throws IndexOutOfBoundsException, IOException{
		super("Activity Patterns Profile", "Compares patterns in process instances", log);
		buildProfile(log);
	}
...
//					currentStreamPatterns.put(currentRepeat, 1);
					incrementValue(i, currentRepeat, 1.0/currentCharStreamLength);
...
//					currentStreamPatterns.put(currentRepeat, count);
					incrementValue(i, currentRepeat, count/currentCharStreamLength);
				}
			}
		}
		charStreams = null;
