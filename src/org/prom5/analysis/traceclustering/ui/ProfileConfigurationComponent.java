 ...
 *
 */
public class ProfileConfigurationComponent extends SmoothPanel implements ChangeListener {
	...
	public ProfileConfigurationComponent(Profile aProfile) {
		...
		JLabel descrLabel = new JLabel(profile.getDescription() + " (" + profile.numberOfItems() + " items)");
