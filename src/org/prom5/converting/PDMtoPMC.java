...
public class PDMtoPMC implements ConvertingPlugin
{
	...
	public PetriNet convert(PDMModel model) {
		...
		// Create an input place, a transition, and an output place for every data element in the PDM
		...
		// Create a transition for every operation in the PDM, except for the leaf operations
