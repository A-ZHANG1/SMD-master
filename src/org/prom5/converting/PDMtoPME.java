...
//		Ps.addToken(to);
		...
		/**/
		// Because of this implementation, operations that have cs = {} are not included.
		// Therefore these operations are dealt with seperately - they are supposed to be
		...
		for (int j=0; j<opArray.length; j++){
			...
			if (inputs.isEmpty()) {
				...
				// Connect the place with the transition belonging to the operation
				...
				// Connect this place with the transition created while translating this data-element.
				// Connect this place with the transition translated from this operation.
