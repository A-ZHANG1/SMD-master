...
package org.prom5.converting.bpmn2yawl;
...
/**
 * <p>Title: BPMN to YAWL model convertor</p>
 *
 * <p>Description: Takes a BPMN and converts it into a YAWL model.</p>
 *
...
public class BPMNToYAWL implements ConvertingPlugin {
    ...
    public YAWLModel convert(BpmnGraph bpmn) {
        ...
        YAWLDecompositionBPMN ydRoot = new YAWLDecompositionBPMN("root", "true",
                "NetFactsType");
    ...
    private void addSubprocess(BpmnGraph bpmn, YAWLModel yawl,
        ...
        HashMap<String, ArrayList<YAWLNode>>
                arCancelPreds = new HashMap<String, ArrayList<YAWLNode>>();
        HashMap<String, ArrayList<YAWLNode>>
                arCancelSuccs = new HashMap<String, ArrayList<YAWLNode>>();
        ...
        for (BpmnObject node : arNodes) {
            ...
            if (node instanceof BpmnTask) {
                ...
                YAWLTask task = ydRoot.addTask(nameAndId,
        ...
        for (int i = 0; i < arDiffCancels.size(); i++) {
            ...
            YAWLTask cancelTask = ydRoot.addTask(cancelId,
