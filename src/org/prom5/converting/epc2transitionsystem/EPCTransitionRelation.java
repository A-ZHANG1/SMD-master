...
public class EPCTransitionRelation {
	...
	public EPCTransitionRelation(HashSet<String> prev, HashSet<String> follow, String firing){
	...
	public boolean addToTransitionSystem(TransitionSystem TS){
		TransitionSystemVertexSet from = new TransitionSystemVertexSet(previousMarking,"",TS);
		TransitionSystemVertexSet to2 = new TransitionSystemVertexSet(followingMarking,"",TS);
		from = (TransitionSystemVertexSet) TS.addVertex(from);
		TransitionSystemVertexSet to = (TransitionSystemVertexSet) TS.addVertex(to2);
