...
public class EpcToTransitionSystem implements ConvertingPlugin {
    ...
    public String getHtmlDescription() {
        return
                "http://is.tm.tue.nl/trac/prom/wiki/ProMPlugins/EPC2STSConversion";
    }
...
//        Message.add("Set of start markings is " + interMarkings.size());
        ...
        while (!interMarkings.isEmpty()) {
            ...
            // Message.add("Current Marking "+currentMarking.toString(), Message.DEBUG);
...
//        showWarningDialog(checkSoundness(TS, Epc));
    ...
    public ArrayList<EPCMarking> getStartMarkings(ConfigurableEPC epc) {
        ...
        ArrayList<EPCObject> nodes = new ArrayList<EPCObject>(epc.getVerticeList().size());
...
//        Message.add("Set of startArcs is " + startArcs.size(), Message.DEBUG);
...
//                    Message.add(" " + z + " - " + 1);
            ...
            if (allnegative == false) {
                ...
                Message.add("Marking added " + newone.toString(), Message.DEBUG);
