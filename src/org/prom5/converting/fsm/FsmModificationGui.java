...
import org.prom5.mining.fsm.FsmGuiColorScheme;

/**
 * <p>Title: FsmModificationGui</p>
 *
 * <p>Description: GUI for the FSM Modification plug-in</p>
 *
...
public class FsmModificationGui extends JPanel {
    ...
    public FsmModificationGui(FsmModificationSettings settings,
        ...
        useKillSelfLoopsCheckBox = new JCheckBox("Remove self loops",
                                                 settings.
                                                 getUse(FsmModificationSettings.
                KILLSELFLOOPSTRATEGY));
        useKillSelfLoopsCheckBox.setBackground(FsmGuiColorScheme.FIELDBACKGROUNDCOLOR);
        useKillSelfLoopsCheckBox.setForeground(FsmGuiColorScheme.FOREGROUNDCOLOR);
        constraints.gridy = 0;
        constraints.anchor = constraints.WEST;
        layout.setConstraints(useKillSelfLoopsCheckBox, constraints);
        panel.add(useKillSelfLoopsCheckBox);

        useExtendCheckBox = new JCheckBox("Improve diamond structure",
                                          settings.getUse(FsmModificationSettings.
                EXTENDSTRATEGY));
        ...
        useMergeByOutputCheckBox = new JCheckBox("Merge states with identical outputs",
                                                 settings.
                                                 getUse(FsmModificationSettings.
                MERGYBYOUTPUTSTRATEGY));
        useMergeByOutputCheckBox.setBackground(FsmGuiColorScheme.FIELDBACKGROUNDCOLOR);
        useMergeByOutputCheckBox.setForeground(FsmGuiColorScheme.FOREGROUNDCOLOR);
        constraints.gridy = 2;
        layout.setConstraints(useMergeByOutputCheckBox, constraints);
        panel.add(useMergeByOutputCheckBox);

        useMergeByInputCheckBox = new JCheckBox("Merge states with identical inputs",
                                                settings.
                                                getUse(FsmModificationSettings.
                MERGYBYINPUTSTRATEGY));
        useMergeByInputCheckBox.setBackground(FsmGuiColorScheme.FIELDBACKGROUNDCOLOR);
        useMergeByInputCheckBox.setForeground(FsmGuiColorScheme.FOREGROUNDCOLOR);
        constraints.gridy = 3;
        layout.setConstraints(useMergeByInputCheckBox, constraints);
        panel.add(useMergeByInputCheckBox);

        panel2.setBorder(new TitledBorder("Select the appropriate post-mine FSM modifications"));
    }
