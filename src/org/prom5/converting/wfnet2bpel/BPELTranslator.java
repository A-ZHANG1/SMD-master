...
import org.prom5.converting.wfnet2bpel.pattern.BPELLibraryComponent;
import org.prom5.converting.wfnet2bpel.pattern.FlowComponent;
import org.prom5.converting.wfnet2bpel.pattern.PickComponent;
import org.prom5.converting.wfnet2bpel.pattern.SwitchComponent;
...
import org.prom5.framework.models.petrinet.PetriNetNavigation;
...
import org.prom5.framework.models.petrinet.pattern.SequenceComponent;
import org.prom5.framework.models.petrinet.pattern.WhileComponent;
...
public class BPELTranslator {
	...
	private static BPELSequence translateSequence(PetriNet wfnet,
		...
		if (source instanceof Transition)
			...
			transition = PetriNetNavigation.getOutgoingTransitions(source)
					.get(0);
		while (transition != null) {
			newSequence.appendChildActivity(annotations.get(transition
					.getName()).cloneActivity());
