...
public class WorkflowNet2BPEL4WS implements ConvertingPlugin {
	...
	/**
	 * @see org.prom5.exporting.ExportPlugin#accepts(org.prom5.framework.plugin.ProvidedObject)
	 */
	...
	/**
	 * @see org.prom5.exporting.ExportPlugin#export(org.prom5.framework.plugin.ProvidedObject,
...
//		String path = "/Users/kbl/PhD/Implementationer/WorkflowNet to BPEL4WS/BPM course (CPN)";
//		List<Pair<String, PetriNet>> nets = new ArrayList<Pair<String, PetriNet>>();
...
//			converter1.count = 0;
//			converter1.path = petriNet.first.substring(0, petriNet.first.lastIndexOf(".")) + ".C";
