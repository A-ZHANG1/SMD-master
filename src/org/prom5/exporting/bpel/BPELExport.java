...
package org.prom5.exporting.bpel;
...
/**
 * <p>Title: BPELExport</p>
 *
 * <p>Description: Export a BPEL object to a BPEL 1.1 file</p>
 *
...
public class BPELExport implements ExportPlugin {
	...
	public void export(ProvidedObject object, OutputStream output) throws IOException {
		...
		for (int i = 0; i < o.length; i++) {
			if (o[i] instanceof BPEL) {
				try {
					// Have the underlying Document (bpel.getDocument) written out.
					BPEL bpel = (BPEL) o[i];
