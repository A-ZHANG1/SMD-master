package org.prom5.exporting.csv;
...
public class ExportAnyJTableToCSV {
	...
	@Exporter(
			name = "Standard CSV (Excel)",
			help = "Export a table to a CSV file. This file can be opened in Microsoft Excel or any other spreadsheet application.",
			extension = "csv"
	)
	public static void export(AbstractTableModel model, OutputStream out) throws IOException {
