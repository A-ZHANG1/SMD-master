 ...
 * <p>Title: FSMExport</p>
 *
 * <p>Description: Export an FSM to an FSM file using as less binary attributes as possible.</p>
 *
...
public class FSMExport {
	...
	@Exporter(
			name = "Binary-attributed FSM file",
			help = "http://www.win.tue.nl/~hverbeek/doku.php?id=projects:prom:plug-ins:export:fsm2bfsm",
			extension = "fsm"
	)
	...
	public static void FSMExportStates(FSM fsm, BufferedWriter bw, int m, int n) throws IOException {
		int k = 1;
	...
	public static void FSMExportTransitions(FSM fsm, BufferedWriter bw) throws IOException {
