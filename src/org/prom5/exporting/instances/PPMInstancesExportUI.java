	...
	private void jbInit() throws Exception {
		...
		okButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ok = (proctypegrouptext.getText() != "") && (proctypetext.getText() != "");
				setVisible(false);
			}
		});

		panel.add(proctypegrouplabel, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
		panel.add(proctypegrouptext, new GridBagConstraints(0, 1, 1, 1, 1.0, 0.0
		...
		panel.add(okButton, new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0
				, GridBagConstraints.SOUTHEAST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5),
				0, 0));
