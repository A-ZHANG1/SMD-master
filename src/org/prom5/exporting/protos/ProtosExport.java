...
package org.prom5.exporting.protos;
...
import org.prom5.framework.models.protos.ProtosString;
import org.prom5.framework.plugin.ProvidedObject;


/**
 * <p>Title: Protos XML Export export</p>
 *
 * <p>Description: Export plug-in for Protos XML Export</p>
 *
...
public class ProtosExport implements ExportPlugin {
	...
	public void export(ProvidedObject object, OutputStream output) throws IOException {
		...
		for (int i = 0; i < o.length; i++) {
			if (o[i] instanceof ProtosModel) {
				String xml = ((ProtosModel) o[i]).writeXMLExport(ProtosString.ProtosModel);
