...
public class InfoItem {
	 ...
	 * @param name Name of the information item
	 * @param description Description string
	 * @param data Map containing a set of attributes,
	 * @param modelReferences List containing a the model references
	 * stored as key-value pairs.
	 */
	public InfoItem(String name, String description, DataSection data, List<String> modelReferences) {
	 ...
	 * @param data The information item's attributes.
	 */
	 ...
	 * @param modelReferences The information item's model references.
	 */
	public void setModelReferences(List<String> modelReferences) {
		this.modelReferences = (modelReferences == null ? EMPTY_LIST : modelReferences);
	}
	
	/**
	 * Adds an attribute as key-value pair to this
	 * information item.
	 * @param key Key of the given attribute.
	...
	public String toString() {
		return "name: " + name + ", desc: " + description + ", data: " + data.toString();
	}
	...
	public boolean equals(Object other) {
		...
		return (this.name.equals(otherItem.name)
				...
				&& (this.data.equals(otherItem.data)));
	}
