...
public class LogEvent implements Comparable, Serializable, Cloneable {
	...
	/**
	 * serialization version id; not used, implement properly if you want to use!
	 */
	...
	public boolean equals(String name, String type) {
		return ((modelElementName.equals(name)) && (modelElementType.equals(type)));
	}

	/**
	 * Overrides the equals method in order to specify when two log events 
	...
	/**
	 * Overridden to specify when a log event is considered smaller or 
	 * greate than another. 
	 * @param o the object to be compared with
	 * @return the value yielded when comparing the string representation 
	 * of this log event with the one of the given object
	 * @see toString()
	 */
