...
public class LogEvents extends ArrayList<LogEvent> {
	...
	/**
	 * Find a <code>LogEvent</code> object by its name and type.
	 * Returns null if there is no such <code>LogEvent</code> in the list.
	 *
	 * @param name the name of the <code>LogEvent</code> to find
	 * @param type the type of the <code>LogEvent</code> to find
	 ...
	 * @param name the name of the <code>LogEvent</code> to find
	 * @param type the type of the <code>LogEvent</code> to find
	 * @return the index of the <code>LogEvent</code> object in the list if it is found, -1 otherwise
	 */
	...
	/**
	 * Returns the maximal occurrence count 
	 * (i.e., occurrence count of the most frequent log
	 * event in the set)
	 * @return
	 */
