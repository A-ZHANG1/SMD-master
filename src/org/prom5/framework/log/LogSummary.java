...
public interface LogSummary {
	 ...
	 * Provides the 'description' attribute of the 'workflow' tag
	 * and the contents of the 'data' section.
	 *
	 ...
	 * Provides 'program' attribute of the 'source' tag
	 * and the contents of the 'data' section.
	 *
	 ...
	 * Provides an array with one entry per process.
	 * Each entry contains the 'id' and 'description' attributes of the 'process' tag
	 * and the contents of the 'data' section.
	 *
	 ...
	 * @return Date null in case the log does not contain any timestamp for this process
	 */
	 ...
	 * @return an alphabetically sorted list of all model element names in the log
	 */
	...
	/**
	 * Returns a list of all log events (unique model element name and
	 * event type combinations) in the log.
	 * @return a list of all log events in the log
	 */
	public LogEvents getLogEvents();

	/**
	 * Returns a set of (references to) process instances, in which
	 * the provided log event occurs.
	 * @param event Log event to find instances for.
	 * @return A set of process instances.
	 */
	public Set<ProcessInstance> getInstancesForEvent(LogEvent event);

	/**
	 * Returns the set of log events occurring in the specified
	 * process instance.
	 * @param instance Process instance to find log events for.
	 ...
	 * specified originator. The values for each key indicate how often the originator
	 * has performed the task.
	 * @param originator Originator as string.
	 * @return A hashmap with log events executed by the specified originator, and the number
	 * of times that the originator performed each event.
	 */
	public Map<LogEvent, Integer> getEventsForOriginator(String originator);

	/**
	 * Returns the mapping between process instances occurrences and
	 * the names of the process instances that occurred a certain
	 * amount of times.
	...
	/**
	 * Returns the mapping between the starting log events and the
	 * number of times they start a process instance.
	 * @return A mapping between starting log events occurrence.
	 */
	public Map<LogEvent, Integer> getStartingLogEvents();

	/**
	 * Returns the mapping between the ending log events and the
	 * number of times they end a process instance.
	 * @return A mapping between starting log events occurrence.
	 */
