...
/**
 * A list of <code>AuditTrailEntry</code> objects connected to an iterator
 * in order to walk through them.
 * This usually corresponds to one audit trail, or trace, in the log (that is,
 * an ordered sequence of activities that took place for one process instance.
 *
...
public class AuditTrailEntriesClassic implements AuditTrailEntries {
	...
	private int currentPosition = 0; // position stored in order to provide a clone() method
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.AuditTrailEntriesIF#add(org.processmining.framework.log.AuditTrailEntry)
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.AuditTrailEntriesIF#add(org.processmining.framework.log.AuditTrailEntry, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.AuditTrailEntriesIF#cloneIteratorOnly()
	 */
	public AuditTrailEntries cloneIteratorOnly() {
		AuditTrailEntriesClassic newObject = new AuditTrailEntriesClassic(entries);
