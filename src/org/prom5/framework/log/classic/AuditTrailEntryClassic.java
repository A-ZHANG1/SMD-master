 ...
 * <p>
 * This class only provides some simple getter methods to get the information
 * in an audit trail entry.
 *
 * @author Peter van den Brand
 * @version 1.0
 */

public class AuditTrailEntryClassic extends AuditTrailEntry implements Cloneable {
	 ...
	 * @param data HashMap
	 */
	private void construct(String element, String type, Date timestamp, String originator,
	 ...
	 * @param data HashMap
	 */
	public AuditTrailEntryClassic(String element, String type, Date timestamp, String originator,
			Map<String, String> data) {
	 ...
	 * @param data Map
	 */
	public AuditTrailEntryClassic(String element, String type, String timestamp, String originator,
			Map<String, String> data) {
...
//		SimpleDateFormat dateParser = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS");
	...
	public String toString() {
		return "[ATE: " + element + ", " + type + ", " + timestamp + ", " + originator + ", "
				+ data.toString() + "]";
	}

	/* (non-Javadoc)
	 * @see org.processmining.framework.log.AuditTrailEntryIF#equals(java.lang.Object)
	 */
	public boolean equals(Object o) {
		...
		else if ((timestamp != null) && (((AuditTrailEntryClassic) o).timestamp != null)) {
	 ...
	 */
	public Object clone() {
		AuditTrailEntryClassic o =
			new AuditTrailEntryClassic(element, type, timestamp, originator, data);
		...
		if (data != null) {
			 ...
			 * (cast necessary as Map itself does not provide a clone method) */
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.AuditTrailEntryIF#addDataAttribute(java.lang.String, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.AuditTrailEntryIF#setData(java.util.Map)
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.AuditTrailEntryIF#setElement(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.AuditTrailEntryIF#setOriginator(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.AuditTrailEntryIF#setTimestamp(java.util.Date)
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.AuditTrailEntryIF#setType(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.LogEntity#setDataAttributes(DataSection)
	 */
