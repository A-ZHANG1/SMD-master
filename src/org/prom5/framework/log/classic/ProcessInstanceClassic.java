...
public class ProcessInstanceClassic extends ProcessInstance {
	...
	public ProcessInstanceClassic(String process, String name, String description, Map<String, String> data,
			ArrayList entries) {
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.log.classic.ProcessInstance#getDescription()
	 */
	...
	public AuditTrailEntryList getAuditTrailEntryList() {
		// if new methods are used with classic log reader, interface must be mediated
		AuditTrailEntries ate = getAuditTrailEntries();
	...
	public ProcessInstance cloneInstance() {
		...
		if (attributes != null) {
			// TODO check whether holds - strings are expected to be copied anyway (as they are treated 
			// as basic data types)
			o.attributes = (DataSection) attributes.clone();
		}
		if (entries != null) {
			o.entries = (ArrayList)((AuditTrailEntries) getAuditTrailEntries().clone()).toArrayList();
		}
		if (elements != null) {
