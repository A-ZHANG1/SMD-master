...
/**
 * <p>Title: AddArtificialEndTaskLogFilter </p>
 *
 * <p>Description:
 * This class adds an artificial task to the <i>end</i> of every process instance in the log.
 * </p>
 *
...
public class AddArtificialEndTaskLogFilter extends LogFilter {
	...
	protected static Date FUTURE_DATE = (new GregorianCalendar(2500, 1, 1)).getTime();
	...
	protected boolean doFiltering(ProcessInstance instance) {
		...
		//ate.setTimestamp(new Date(System.currentTimeMillis() + 100000));	// future
	...
	public LogFilterParameterDialog getParameterDialog(LogSummary summary) {
		return new LogFilterParameterDialog(summary, AddArtificialEndTaskLogFilter.this) {
			...
			public LogFilter getNewLogFilter() {
				return new AddArtificialEndTaskLogFilter(taskName.getText(),
						LogStateMachine.EVENT_TYPES[eventTypes.getSelectedIndex()]);
			}
