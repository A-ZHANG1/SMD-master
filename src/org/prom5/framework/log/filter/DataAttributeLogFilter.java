...
/**
 * Data attribute log filter can be used to both filter log events 
 * and process instances based on the existence of specific data attributes, 
 * and based on specific data attribute values. 
 * 
...
public class DataAttributeLogFilter extends LogFilter {
	...
	/*
	 * (non-Javadoc)
	 * @see org.processmining.framework.log.LogFilter#doFiltering(org.processmining.framework.log.ProcessInstance)
	 */
	protected boolean doFiltering(ProcessInstance pi) {
		...
		try {
			...
			Message.add("Problem while accessing attributes: " +
	...
	/*
	 * (non-Javadoc)
	 * @see org.processmining.framework.log.LogFilter#getParameterDialog(org.processmining.framework.log.LogSummary)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.processmining.framework.log.LogFilter#writeSpecificXML(java.io.BufferedWriter)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.processmining.framework.log.LogFilter#readSpecificXML(org.w3c.dom.Node)
	 */
...
/**
 * Specifies parameters for the data attribute log filter.
 * Provides the GUI for the settings of the filter, and can create a 
 * filter object according to the user configuration.  
 * 
 * @author Boudewijn van Dongen
 */
class AttributeFilterParameterDialog extends LogFilterParameterDialog {
	...
	/** 
	 * Creates a new filter settings instance based on the log summary and a log filter 
	 * instance. 
	 * 
	 * @param summary the Log summary for the log
	 * @param filter - ?? TODO: check
	 */
	public AttributeFilterParameterDialog(LogSummary summary, DataAttributeLogFilter filter) {
		super(summary, filter);
	}

	/*
	 * (non-Javadoc)
	 * @see org.processmining.framework.log.filter.LogFilterParameterDialog#getAllParametersSet()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.processmining.framework.log.filter.LogFilterParameterDialog#getPanel()
	 */
	protected JPanel getPanel() {
		...
		JLabel label =new JLabel("Type an attribute and a comma separated list of allowed values");
		panel.add(label,
				new GridBagConstraints(0, 0,2, 1, 0.0, 0.0, GridBagConstraints.WEST,
				GridBagConstraints.NONE, new Insets(1, 1, 1, 1), 0, 0));
		attribute.setPreferredSize(new Dimension((int)label.getPreferredSize().getWidth()/2, (int)label.getPreferredSize().getHeight() ));
		values.setPreferredSize(new Dimension((int)label.getPreferredSize().getWidth()/2, (int)label.getPreferredSize().getHeight() ));
		panel.add(attribute,
	...
	/*
	 * (non-Javadoc)
	 * @see org.processmining.framework.log.filter.LogFilterParameterDialog#getNewLogFilter()
	 */
