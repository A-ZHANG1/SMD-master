...
/**
 * This filter retains only the first occurrence of any activity in the process instance
 * 
...
//		}
		...
		while(it.hasNext()){
			...
			LogEvent e = eventsToFilter.findLogEvent(currentActivity, currentAuditTrailEntry.getType()); 
...
//		System.out.println(initialSize+" @ "+entries.size());
	...
	public LogFilterParameterDialog getParameterDialog(LogSummary summary) {
		return new LogFilterParameterDialog(summary, FirstOnlyActivityFilter.this) {
