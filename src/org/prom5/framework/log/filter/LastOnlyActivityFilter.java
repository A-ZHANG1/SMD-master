...
/**
 * This filter retains only the last occurrence of any activity in the process instance
 * 
...
//		Iterator<String> it2 = activityLastOccurrenceMap.keySet().iterator();
		...
		while(it.hasNext()){
			...
			if(e != null && !activityLastOccurrenceMap.containsValue(currentIndex)){
				it.remove();
			}
...
//		System.out.println(activityLastOccurrenceMap.values().toString());
	...
	public LogFilterParameterDialog getParameterDialog(LogSummary summary) {
		return new LogFilterParameterDialog(summary,LastOnlyActivityFilter.this){
