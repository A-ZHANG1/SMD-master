...
public class OntologyURIFilterParamDialog extends LogFilterParameterDialog {
	...
	protected JPanel getPanel() {
		...
		for (Map.Entry<String, String> item : ((OntologyURIFilter) this.filter).getMapping().entrySet()) {
			...
			body.add(labelPanel, new GridBagConstraints(0, i * 2, 1, 1, 1.0, 1.0, GridBagConstraints.LINE_START, 
			...
			body.add(textPanel, new GridBagConstraints(0, i * 2 + 1, 1, 1, 1.0, 1.0, GridBagConstraints.LINE_START, 
					GridBagConstraints.HORIZONTAL, new Insets(0,0,0,0), 0, 0));	
			i++;
		}
		
		JLabel title1 = new JLabel("Please enter the ontology URIs you would like to use.");
		JLabel title2 = new JLabel("If you leave a field blank, then all model references to that ontology will be removed.");
