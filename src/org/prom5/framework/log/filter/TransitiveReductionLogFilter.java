 ...
 * @version 1.0
 */
public class TransitiveReductionLogFilter extends TransitiveCalculationLogFilter{
	...
	private void transitivelyReduce(int[][] adj, int N) {
	 ...
	 private void removeDirectSuc(int[][]adj, int v, int w, int[] done, int[] removed, final int n, final int N) {
		 for (int x = 0; x < n; x++) {
