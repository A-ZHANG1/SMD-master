...
//		tree.setRootVisible(false);
	 ...
	 *
	 * @param child Object to add as a child
	 * @param label String representing the label of the object in the tree
	 ...
	 *
	 * @param child Object to add as a child
	 * @param parent Object that is the required parent of the child
	 * @param label String representing the label of the object in the tree
	 * @return Object That represents the parent to which the child is added
	 *   (i.e. parent).
	 */
	public Object addHierarchyObject(Object child, Object parent, final String label) {
		...
		if (parentLoc > -1) {
			// The parent exists
			IntArrayList parentsChildren = (IntArrayList) children.get(parentLoc);
			DefaultMutableTreeNode pn = (DefaultMutableTreeNode) jtreeNodes.get(parentLoc);
			pn.add(n);
	...
	/**
	 * This method returns a collection of objects representing the children
	 * of the given parent object, or null if the parent object does not
	 * exist.
	 *
	...
	public JComponent getTreeVisualization() {
		TreePath path = new TreePath(((DefaultMutableTreeNode) jtreeNodes.get(0)).getPath());
...
//			Message.add("" + path, Message.DEBUG);
	 ...
	 *
	 * @param selectObject the object to select.
	 */
	 ...
	 * Note that it is only called after the constructor of a subclass has set
	 * <code>initialized</code> to true
	 *
