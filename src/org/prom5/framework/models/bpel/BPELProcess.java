...
/**
 * <p>Title: BPELProcess</p>
 *
 * <p>Description: Class for a BPEL process</p>
 *
...
public class BPELProcess implements BPELVisitable {
	...
	/*
	 * The next two methods are typically used if a BPEL model is imported from file, which yields a document with (a tree of) elements.
	 * On top of this document and elements, the BPEL activities need to be constructed.
	 */

	/**
	 * Create a new BPEL process from the given element.
	 * @param element Element This should be the element underlying the BPEL process.
	 */
	...
	/*
	 * The next three methods are typically used when creating a BPEL model from scratch, in which case the underlying elements do not exist yet.
	 */

	/**
	 * Create a new BPEL process with given name.
	 * @param name String The name attribute of the new process.
	 */
	 ...
	 * @param activity BPELActivity The child activity.
	 */
	public void setChildActivity(BPELActivity activity) {
		...
		if (!sources.isEmpty()) {
			...
			Element linksElement = flowElement.getOwnerDocument().createElement(BPELConstants.stringLinks);
			...
			for (String source: sources) {
				Element linkElement = flowElement.getOwnerDocument().createElement(BPELConstants.stringLink);
	...
	/**
	 * Accept a visitor.
	 * @param visitor BPELVisitor The visitor.
	 */
	 ...
	 * @param name String The tag name of the activities to count.
	 * @return int The numbe rof activities in ht eproces swith the given tag name.
	 */
