...
/**
 * <p>Title: BPELSequence</p>
 *
 * <p>Description: CLass for a BPEL sequence activity.</p>
 *
...
public class BPELSequence extends BPELStructured {
	...
	public BPELSequence cloneActivity() {
		BPELSequence clone = new BPELSequence(element.getAttribute(BPELConstants.stringName));
