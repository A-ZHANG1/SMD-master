package org.prom5.framework.models.bpel.visit;
...
public abstract class BPELVisitor {
	...
	public void visit(Object o) {
		if (o instanceof BPELProcess) visitProcess((BPELProcess)o);
		else if (o instanceof BPELAssign) visitAssign((BPELAssign)o);
		else if (o instanceof BPELEmpty) visitEmpty((BPELEmpty)o);
		else if (o instanceof BPELFlow) visitFlow((BPELFlow)o);
		else if (o instanceof BPELInvoke) visitInvoke((BPELInvoke)o);
		else if (o instanceof BPELPick) visitPick((BPELPick)o);
		else if (o instanceof BPELReceive) visitReceive((BPELReceive)o);
		else if (o instanceof BPELReply) visitReply((BPELReply)o);
		else if (o instanceof BPELScope) visitScope((BPELScope)o);
		else if (o instanceof BPELSequence) visitSequence((BPELSequence)o);
		else if (o instanceof BPELSwitch) visitSwitch((BPELSwitch)o);
		else if (o instanceof BPELWait) visitWait((BPELWait)o);
		else if (o instanceof BPELWhile) visitWhile((BPELWhile)o);
	}
