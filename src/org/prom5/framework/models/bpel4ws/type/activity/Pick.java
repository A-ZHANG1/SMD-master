...
import org.prom5.framework.models.bpel4ws.unit.Pair;
...
public class Pick extends Composed {
    ...
    public Activity cloneActivity () {
        ...
        for (Activity activity : messages.keySet())
            clonedMessages.put(activity.cloneActivity(),messages.get(activity));
        ...
        for (Activity activity : alarms.keySet()) {
            ...
            clonedAlarms.put(activity.cloneActivity(),new Pair<String,String>(pair.first, pair.second));
        }
