...
public abstract class BpmnElement implements BpmnDotOutput, BpmnXMLOutput
{
   ...
   * @return String of the DOT file section of this element, line break included
   */
  ...
  protected void outputProperty(StringBuffer sb, String propName, String propValue)
  {
  ...
  protected void outputAttribute(StringBuffer sb, String attName, String attValue)
  {
