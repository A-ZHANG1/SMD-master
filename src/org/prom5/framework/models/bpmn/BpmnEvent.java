 ...
 * class for a flow object event, including elements "Start", "End" and "Intermediate"
 */
public class BpmnEvent extends BpmnObject
{
  ...
  protected BpmnEventTriggerType trigger; // if trigger is None, then this event is a result
...
//    String label = (name != null) ? name : getId();
  ...
  protected void outputProperties(StringBuffer sb)
  {
    ...
    outputProperty(sb, BpmnXmlTags.BPMN_PROP_TRIGGER, String.valueOf(this.trigger));
