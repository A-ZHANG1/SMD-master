...
//    String label = (name != null) ? name : getId();
  ...
  public String toXMLString()
  {
    ...
    {
      outputProperty(sb, BpmnXmlTags.BPMN_PROP_GATEWAYTYPE, String.valueOf(this.type));
    }
    else {outputProperty(sb,BpmnXmlTags.BPMN_PROP_GW_XORTYPE, "Event");
      outputProperty(sb, BpmnXmlTags.BPMN_PROP_GATEWAYTYPE, String.valueOf(this.type));
    }
    sb.append("</" + BpmnXmlTags.BPMN_GATEWAY + ">");
    return sb.toString();
