 ...
 *  Base class of BPMN flow objects and swinlanes
 */
abstract public class BpmnObject extends BpmnElement
{
  ...
  public String toDotString()
  {
    ...
    if (shapeClass != null)
    {
      String shapeStr = "shapefile=\"" + shapeClass.getName() + "\",shape=\"custom\"";
