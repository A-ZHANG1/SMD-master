 ...
 * This class represent one level of process, a process is the main diagram of defined
 * in a SubProcess node
 */
public class BpmnProcessModel {
  protected HashMap<String, BpmnSubProcess> subProcesses;  // all BMPN sub process
  protected HashMap<String, BpmnObject> nodes;  // all BPMN nodes except sub process
  ...
  /**
   * If this is a sub process, get the Id of node to which the incoming edge should point
   * @return
   */
  ...
  /**
   * If this is a sub process, get the Id of node from which the outgoing edge should point
   * @return
   */
