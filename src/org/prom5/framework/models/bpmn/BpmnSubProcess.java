...
public class BpmnSubProcess extends BpmnTask
{
  ...
  protected BpmnProcessModel processModel; // the process model inside the subprocess
  ...
  protected void outputProperties(StringBuffer sb)
  {
    ...
    outputProperty(sb, BpmnXmlTags.BPMN_PROP_ADHOC, String.valueOf(this.adHoc));
    outputProperty(sb, BpmnXmlTags.BPMN_PROP_EXPANDED, String.valueOf(this.expanded));
