 ...
 *
 */
public class BpmnSwimPool extends BpmnObject
{
   ...
   * TODO implement the constructor to extract properties in document node
   */
  public BpmnSwimPool(Element element)
  {
    super(element);
  }
  
  public BpmnSwimPool(String id)
  {
    super(id);
  }
  ...
  /**
   * Set a property value, return true if the property name is in the object, otherwise false
   * @param name
   * @param value
   * @return
   */
  ...
  public boolean setProperty(String name, String value)
  {
    ...
    // note the CSSclass is not interpreted, it is not needed because this object is
    // already the event
  ...
  @Override
  //lane is a more bigger container
  ...
  public String toXMLString()
  {
    ...
    //start tag
    sb.append("<" + BpmnXmlTags.BPMN_POOL);
    //id attribute
  ...
  protected void outputProperties(StringBuffer sb)
  {
    ...
    outputProperty(sb, BpmnXmlTags.BPMN_PROP_SIZE, String.valueOf(this.size));
    outputProperty(sb, BpmnXmlTags.BPMN_PROP_MAXLEVEL, String.valueOf(this.maxLevel));
    outputProperty(sb, BpmnXmlTags.BPMN_PROP_LENGTH, String.valueOf(this.length));
  }
}
