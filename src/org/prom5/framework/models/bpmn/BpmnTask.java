 ...
 * Class for BPMN activity and task
 */
public class BpmnTask extends BpmnObject
{
  ...
  /**
   * Constructor from a document node
  ...
  public boolean setProperty(String name, String value)
  {
    ...
    else if (name.equalsIgnoreCase(BpmnXmlTags.BPMN_PROP_COMPENSATIONACTIVITY))
    {
  ...
  public String toXMLString()
  {
    ...
    if(typeTag == BpmnTaskType.Activity)
      outputProperty(sb, BpmnXmlTags.BPMN_PROP_CSSCLASS, BpmnXmlTags.BPMN_CSSC_ACTIVITY);
    else
      outputProperty(sb, BpmnXmlTags.BPMN_PROP_CSSCLASS, BpmnXmlTags.BPMN_CSSC_TASK);
    sb.append("</" + BpmnXmlTags.BPMN_TASK + ">");
    return sb.toString();
  }
  ...
  protected void outputProperties(StringBuffer sb)
  {
    ...
    if(this.compensationactivity)
      outputProperty(sb, BpmnXmlTags.BPMN_PROP_COMPENSATIONACTIVITY, String.valueOf(this.compensationactivity));
  }
}
