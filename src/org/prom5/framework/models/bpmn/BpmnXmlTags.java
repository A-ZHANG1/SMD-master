...
public class BpmnXmlTags {
  ...
  public static String[] EVENTYPE = {BPMN_NODETYPE, BPMN_POOLLANE, BPMN_EVENTTYPE,BPMN_PROP_TRIGGER};
  public static String[] TASKTYPE = {BPMN_TASKTYPE, BPMN_POOLLANE, BPMN_SUBTYPE,BPMN_PROP_LOOPTYPE,BPMN_PROP_TIMING,BPMN_PROP_COMPENSATIONACTIVITY,BPMN_PROP_ADHOC,BPMN_PROP_EXPANDED,BPMN_PROP_TRANSACTION};
  public static String[] EDGETYPE = {BPMN_EDGETYPE, BPMN_PROP_CONDITION, BPMN_PROP_DEFAULT, BPMN_PROP_MESSAGE};
