 ...
 * @version 1.0
 */
public class EPCInfSysObject extends EPCObject implements DOTCodeWriter{

	private String label;

	private EPCFunction function;

	public EPCInfSysObject(String label, EPCFunction function) {
	...
	public void writeDOTCode(Writer bw, HashMap nodeMapping) throws IOException {
		bw.write("node" + getId() +
				" [shapefile=\"att.grappa.epc.EPCInfSysObjShape\",shape =\"custom\",style=\"filled\""+
