...
import org.prom5.framework.util.MethodsToMakeDeepCopiesOfDataStructures;
...
public class HNTestStructures {
	...
	public static long timeTreeSetCopy(int N) {
		...
		for (int n = 0; n < N; n++) {
			TreeSet set = MethodsToMakeDeepCopiesOfDataStructures.cloneTreeSet(tree);
		}
	...
	public static long timeTreeSetRemove(int N) {
		...
		for (int n = 0; n < N; n++) {
			TreeSet copy = MethodsToMakeDeepCopiesOfDataStructures.cloneTreeSet(tree);
	...
	public static void main(String[] args) {
		...
		// 3000000 -> 16000ms
		//System.out.println("timeTreeSetIteration: " + timeTreeSetIteration(iterationN));
		// 3000000 -> 1900ms
		//System.out.println("timeHNSubSetSetIteration: " + timeHNSubSetSetIteration(iterationN));

		//System.out.println("timeTreeSetAdd: " + timeTreeSetAdd(addN)); // 300000 -> 4900ms
		//System.out.println("timeHNSubSetSetAdd: " + timeHNSubSetSetAdd(addN)); // 300000 -> 3800ms

		// 300000 -> 15600ms
		//System.out.println("timeTreeSetCopy: " + timeTreeSetCopy(copyN));
		// 300000 -> 450ms
		//System.out.println("timeHNSubSetSetCopy: " + (timeHNSubSetSetCopy(copyN * 10) / 10));

		// 30000000 -> 7100ms
		//System.out.println("timeTreeSetContains: " + timeTreeSetContains(containsN));
		// 30000000 -> 2900ms
		//System.out.println("timeHNSubSetSetContains: " + (timeHNSubSetSetContains(containsN)));
		...
		// 300000 -> 2050ms
		//System.out.println("timeHNSetSetCopy: " + (timeHNSetSetCopy(hashCopyN)));
		...
		// 300000 -> 3650ms
		//System.out.println("timeHashSetContains: " + timeHashSetContains(hashContainsN));
		// 300000 -> 12500ms
		//System.out.println("timeHNSetContains: " + (timeHNSetContains(hashContainsN)));

		// 300000 -> 1650ms
		//System.out.println("timeHashSetIteration: " + timeHashSetIterate(hashIterationN));
		// 300000 -> 185ms
		//System.out.println("timeHNSetIteration: " + timeHNSetIterate(hashIterationN * 10) / 10);
