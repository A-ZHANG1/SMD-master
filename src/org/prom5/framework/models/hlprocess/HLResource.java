...
/**
 * A resource represents a resource entity (e.g., a person or
 * machine) in the high level process.
 * <br>
 * Currently, a resource only has a name and an identity.
 * In the future, more characteristics can be added to, e.g., specify
 * the working scheme of a person (like working part-time or not).
 *
 * @see HLGroup
 * @see HLProcess
 */
public class HLResource extends HLProcessElement implements Cloneable {
	 ...
	 * @param aProc the high level process this resource belongs to
	 */
