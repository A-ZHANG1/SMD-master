...
import org.prom5.framework.models.hlprocess.gui.att.dist.HLBernoulliDistributionGui;
...
public class HLBernoulliDistribution extends HLDistribution {
	 ...
	 * @param probability double the probability value. Note that this value always has to
	...
	public boolean equals(Object obj) {
		return (obj instanceof HLBernoulliDistribution) &&
				(this.getProbability() ==  ((HLBernoulliDistribution) obj).getProbability());
	}
