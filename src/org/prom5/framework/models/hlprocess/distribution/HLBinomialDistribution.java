...
import org.prom5.framework.models.hlprocess.gui.att.dist.HLBinomialDistributionGui;
...
public class HLBinomialDistribution extends HLDistribution implements Cloneable {
	 ...
	 * @param value the number of experiments
	 */
	...
	public boolean equals(Object obj) {
		return (obj instanceof HLBinomialDistribution) &&
				(this.getNumberOfExperiments() == ((HLBinomialDistribution) obj).getNumberOfExperiments()) &&
				(this.getProbability() == ((HLBinomialDistribution) obj).getProbability());
	}
