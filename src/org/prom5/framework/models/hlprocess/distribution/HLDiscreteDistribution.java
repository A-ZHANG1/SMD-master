...
import org.prom5.framework.models.hlprocess.gui.att.dist.HLDiscreteDistributionGui;
import org.prom5.framework.ui.MainUI;

/**
 * Represents a discrete distribution.
 * It is assumed that the min value that is provided will be less than the max value that
 * is provided.
 *
...
public class HLDiscreteDistribution extends HLDistribution {
	 ...
	 * @param value the minimum value of this discrete distribution.
	 */
	 ...
	 * @param value the maximum value of this discrete distribution.
	 */
	...
	public boolean checkValuesOfTimeParameters(String info) {
		if (this.getMax() == 0 ||
			...
			JOptionPane.showMessageDialog(MainUI.getInstance().getDesktop(),
					"One or more parameters of the Distribution of " + info + "has value zero",
					"0 value warning",
