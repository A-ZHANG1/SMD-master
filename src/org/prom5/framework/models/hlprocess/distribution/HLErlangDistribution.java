...
import org.prom5.framework.models.hlprocess.gui.att.dist.HLErlangDistributionGui;
...
public class HLErlangDistribution extends HLDistribution {
	 ...
	 * @param n Emergence of n events. Note that the number of events always has to be equal or
	 * greater than 1.
	 * @param intensity double the intensity value. Note that the intensity value always has to be equal or greater than 0.
	 */
	 ...
	 * @param value the number of drawings
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.processmining.framework.models.hlprocess.distribution.HLDistribution#getDistributionType()
	 */
	...
	public boolean equals(Object obj) {
		return (obj instanceof HLErlangDistribution) &&
				(this.getEmergenceOfEvents() == ((HLErlangDistribution) obj).getEmergenceOfEvents()) &&
				(this.getIntensity() == ((HLErlangDistribution) obj).getIntensity());
	}
