package org.prom5.framework.models.hlprocess.distribution;
...
/**
 * Represents soke kind of meta distribution to which a lot of distribution related information
 * can be provided, so that based on the provided information to this object separate
 * distributions (like a <code>HLUniformDistribution</code> object or a
 * <code>HLNormalDistribution</code>) can be provided. If no specific value for some
 * distribution related attribute has been set, a default value will be used (e.g.
 * when no value for variance is given, as value <code>0</code> will be used).
 * For setting the best distribution, an instance of HLGeneralDistribution.DistributionEnum has to be chosen.
 *
 * <p>Note that the validity of provided values is not checked. For example, it is assumed that if 
 * a min and a max value is provided, that the min value is less than the max value.
 *
 * @author arozinat
 * @author rmans
 */
public class HLGeneralDistribution extends HLDistribution {
	...
	/**
	 * Creates a general distribution based on values for the mean, variance, min, max
	 * and the bestDistribution
	 * @param constant the constant value of the distribution
	 * @param mean double (arithmetic) mean value of the distribution
	 * @param variance double the variance of the distribution
	 * @param min the minumum value of the distribution
	 * @param max the maximum value of the distribution
	 * @param probability the probability value. Note that this value always has to
	 * be bigger or equal to 0 and equal or less than 1.
	 * @param numberExperiments the number of experiments. Note that this value always has to bigger or equal to 1.
	 * @param degreesFreedom double the degrees of freedom value. Not that this value always
	 * has to be equal or greater to 1.
	 * @param emergenceEvents Emergence of <it>emergenceEvents</it> events. Note that the number of events always has to be equal or
	 * greater than 1.
	 * @param intensity the intensity value of the distribution
	 * @param bestDistribution the best distribution. Based on the values that are provided
	 */
	public HLGeneralDistribution(double constant, double mean, double variance, double min, double max, double intensity,
			double probability, int numberExperiments, int degreesFreedom, int emergenceEvents) {
		if(mean==0&&intensity!=0) mean=1/intensity;
		if(mean!=0&&intensity==0) intensity=1/mean;
		if(mean==0&&intensity==0) intensity = Double.MAX_VALUE;
		if(probability==-1.0) probability=0.5;
		if(numberExperiments==-1) {
			if(probability!=0.0&&(int)(mean/probability)>=1) numberExperiments = (int)(mean/probability);
		    else numberExperiments = 1;
		}
		if(emergenceEvents==-1&&(int)(mean*intensity)>=1) emergenceEvents = (int)(mean*intensity);
		else emergenceEvents = 1;
	...
	/**
	 * Creates a general distribution with default values for some of the values in the
	 * generaldistribution
	 * @param constant the constant value of the distribution
	 * @param mean double (arithmetic) mean value of the distribution
	 * @param variance double the variance of the distribution
	 ...
	 * @param bestDistribution the best distribution. Based on the values that are provided
	 */
	public HLGeneralDistribution(double constant, double mean, double variance, double min, double max) {
	 ...
	 * Creates a general distribution with default values for some of the values in the
	 * generaldistribution
	 * @param constant double the constant value of the distribution
	 * @param intensity double the intensity value of the distribution
	 * @param bestDistribution DistributionEnum the best distribution. Based on the values that are provided.
	 */
	public HLGeneralDistribution(double constant, double intensity, DistributionEnum bestDistribution) {
	 ...
	 * @param min double the min value of the distribution
	 * @param max double the max value of the distribution
	 * @param variance double the variance value of the distribution
	 * @param intensity double the intensity value of the distribution
	 * @param bestDistribution DistributionEnum the best distribution. Based on the values that are provided.
	 */
	public HLGeneralDistribution(double constant, double mean, double variance, double min, double max,
			double intensity, DistributionEnum bestDistribution) {
		this(constant, mean, variance, min, max, intensity, -1.0, -1, -1, -1);
	}

	/**
	 * Sets the best distribution.
	 * @param bestDistribution DistributionEnum the best distribution
	 */
	 ...
	 * @param mean double the mean value
	 */
	 ...
	 * @param variance double the variance.
	 */
	 ...
	 * @param max double the max value. Note that the max value always has to be bigger or equal
	 * to the min value (if it has been provided).
	 */
	 ...
	 * @param min double the min value. Note that the min value always has to be less or equal
	 * than the max value (if it has been provided).
	 */
	 ...
	 * @param intensity double the intensity value. Note that this value always has to be
	 ...
	 * @param probability double the probability value. Note that this value always has to be
	 * bigger or equal to 0 and less than or equal to 1.
	 */
	 ...
	 * @param numberExperiments int the number of experiments. Note that this value always has to be
	 * bigger or equal to 1.
	 */
	 ...
	 * @param degreesFreedom int the degrees of freedom. Note that this value always has to be
	 * bigger or equal to 1.
	 */
	 ...
	 * @param emergenceEvents int the emergence of <it>emergenceEvents</it> events. Note that this value
	 * always has to be bigger or equal to 1.
	 */
	 ...
	 * <p>Note that does not include bernoulli, chisquare, poisson, and student
	...
	/**
	 * Returns a <code>HLUniformDistribution</code> object. If no specific value has been
	 * set for some attribute specifically related to this distribution, a default value will be used.
	 * @return HLUniformDistribution a <code>HLUniformDistribution</code> object.
	 */
	...
	/**
	 * Returns a <code>HLNormalDistribution</code> object. If no specific value has been
	 * set for some attribute specifically related to this distribution, a default value will be used.
	...
	/**
	 * Returns a <code>HLConstantDistribution</code> object. If no specific value has been
	 * set for some attribute specifically related to this distribution, a default value will be used.
	 * @return HLConstantDistribution a <code>HLConstantDistribution</code> object.
	 */
	...
	/**
	 * Returns a <code>HLExponentialDistribution</code> object. If no specific value has been
	 * set for some attribute specifically related to this distribution, a default value will be used.
	 * @return HLExponentialDistribution a <code>HLExponentialDistribution</code> object.
	 */
	...
	/**
	 * Returns a <code>HLBernoulliDistribution</code> object. If no specific value has been
	 * set for some attribute specifically related to this distribution, a default value will be used.
	 * @return HLBernoulliDistribution a <code>HLBernoulliDistribution</code> object.
	 */
	...
	/**
	 * Returns a <code>HLBinomialDistribution</code> object. If no specific value has been
	 * set for some attribute specifically related to this distribution, a default value will be used.
	 * @return HLBinomialDistribution a <code>HLBinomialDistribution</code> object.
	 */
	...
	/**
	 * Returns a <code>HLChiSquareDistribution</code> object. If no specific value has been
	 * set for some attribute specifically related to this distribution, a default value will be used.
	 * @return HLChiSquareDistribution a <code>HLChiSquareDistribution</code> object.
	 */
	...
	/**
	 * Returns a <code>HLDiscreteDistribution</code> object. If no specific value has been
	 * set for some attribute specifically related to this distribution, a default value will be used.
	 ...
	 * are of type double.
	 * @return HLDiscreteDistribution a <code>HLDiscreteDistribution</code> object.
	 */
	public HLDiscreteDistribution getDiscreteDistribution() {
		return new HLDiscreteDistribution(Math.round((int) myMin),(int) Math.round(myMax));
	}

	/**
	 * Returns a <code>HLErlangDistribution</code> object. If no specific value has been
	 * set for some attribute specifically related to this distribution, a default value will be used.
	...
	/**
	 * Returns a <code>HLPoissonDistribution</code> object. If no specific value has been
	 * set for some attribute specifically related to this distribution, a default value will be used.
	 * @return HLPoissonDistribution a <code>HLPoissonDistribution</code> object.
	 */
	...
	/**
	 * Returns a <code>HLStudentDistribution</code> object. If no specific value has been
	 * set for some attribute specifically related to this distribution, a default value will be used.
	 * @return HLStudentDistribution a <code>HLStudentDistribution</code> object.
	 */
	...
	/**
	 * Creates a distribution of the requested type based on the values in 
	 * this meta disribution object. 
	 * <p>Note that the created distribution object will be independent and 
	 * changes in either of both will not affect the other. 
	 * @param requestedType the type of distribution asked for
	...
	/*
	 *  (non-Javadoc)
	 * @see org.processmining.framework.models.hlprocess.Distribution#getDistributionType()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.processmining.framework.models.hlprocess.distribution.HLDistribution#equals(java.lang.Object)
	 */
	public boolean equals(Object obj) {
		return (obj instanceof HLGeneralDistribution) &&
				(this.getConstant() == ((HLGeneralDistribution) obj).getConstant()) &&
				(this.getDegreesOfFreedom() == ((HLGeneralDistribution) obj).getDegreesOfFreedom()) &&
				(this.getEmergenceofEvents() == ((HLGeneralDistribution) obj).getEmergenceofEvents()) &&
				(this.getIntensity() == ((HLGeneralDistribution) obj).getIntensity()) &&
				...
				(this.getNumberExperiments() == ((HLGeneralDistribution) obj).getNumberExperiments()) &&
				(this.getProbability() == ((HLGeneralDistribution) obj).getProbability()) &&
				(this.getVariance() == ((HLGeneralDistribution) obj).getVariance());
	}

	/*
	 * (non-Javadoc)
	 * @see org.processmining.framework.models.hlprocess.distribution.HLDistribution#hashCode()
	 */
	public int hashCode() {
	...
	/*
	 * (non-Javadoc)
	 * @see org.processmining.framework.models.hlprocess.distribution.HLDistribution#writeDistributionToDot(java.lang.String, java.lang.String, java.lang.String, java.io.Writer)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.processmining.framework.models.hlprocess.distribution.HLDistribution#timeMultiplicationValue(double)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.processmining.framework.models.hlprocess.distribution.HLDistribution#checkValuesOfTimeParameters(java.lang.String)
	 */
	public boolean checkValuesOfTimeParameters(String info) {
		if (Math.round(this.getMean()) == 0 ||
				Math.round(this.getMax()) == 0 ||
			...
			JOptionPane.showMessageDialog(MainUI.getInstance().getDesktop(),
					"One or more parameters of the Distribution of " + info + "has a value that will be rounded to zero",
