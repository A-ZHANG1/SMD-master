...
import org.prom5.framework.models.hlprocess.gui.att.dist.HLPoissonDistributionGui;
...
public class HLPoissonDistribution extends HLDistribution {
		 ...
		 * @param intensity double the intensity value. Remark that the intensity value
	    ...
	    public boolean equals(Object obj) {
			return (obj instanceof HLPoissonDistribution) &&
					(this.getIntensity() == ((HLPoissonDistribution) obj).getIntensity());
		}
