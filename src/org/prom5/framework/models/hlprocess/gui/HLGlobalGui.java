...
/**
 * Creates a gui representation for the global properties of the 
 * high level process.
 * <br>
 * Allows to view and edit the global characteristics 
...
public class HLGlobalGui implements GuiDisplayable, GuiNotificationTarget {
	 ...
	 * @param glob the global process to be represented by this gui object
	 */
	...
	private void createPanel() {
		...
		String description = new String("Here you can specify global properties of the process. " +
		...
		name = new GUIPropertyString("Process Name", 
				"Specifies the name of this process", 
				global.getName(), 
				this, 200);
		...
		resultPanel.add(Box.createHorizontalGlue());
		outmostPanel.add(GuiUtilities.getSimpleScrollable(resultPanel, HLProcessGui.bgColor), BorderLayout.CENTER);
