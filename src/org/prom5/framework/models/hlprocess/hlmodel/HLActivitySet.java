...
import org.prom5.framework.models.hlprocess.visualization.HLActivitySetVisualization;

/**
 * High-level process model implementation for models without
 * a concrete control-flow model.
 * <br>
 * Provides a means to create a high-level process model without
 * having a process model at hand. Choices only refer to target
 * activities and, therefore, can also be specified for a high-
 * level activity set. 
 * <br>
 * Creates and maps graph nodes onto HLActivities and HLChoices. 
 * The default visualization for the underlyzing ActivityGraph 
 * is a set of rectangular shapes representing the tasks in the 
 * model.
 */
public class HLActivitySet extends HLModel {
	 ...
	 * task node in the activity model, and establishing the mapping between them. 
	 */
	...
	/**
	 * Adds the given HLActivity to this HLActivitySet. 
	 * <br>
	 * Also creates a new graph node in the underlying ActivityGraph.
	 * @param act the HLActivity to be added
	 */
