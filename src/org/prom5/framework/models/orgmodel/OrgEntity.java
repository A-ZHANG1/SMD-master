...
public class OrgEntity implements Cloneable {
	...
	public static final ArrayList<String> ORGENTITYTYPE_ARRAYLIST = new ArrayList<String>(Arrays.asList(new String[]{ORGENTITYTYPE_ORGUNIT,ORGENTITYTYPE_ROLE,ORGENTITYTYPE_MININGRESULT}));
	...
	public void writeToXML(Writer bw) throws IOException {
		...
		bw.write("<EntityType>"+getEntityType()+"</EntityType>\n</OrgEntity>\n");
	}
