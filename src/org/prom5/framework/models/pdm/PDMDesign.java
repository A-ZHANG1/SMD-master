...
/**
 * <p>Title: PDMDesign</p> *
 * <p>Description: Represents a PDM design, i.e. a grouping over the PDM model.</p> *
...
public class PDMDesign {
	...
	public JTable activitiesTable = new JTable();   // the table contains all cohesion values for all activities
	public String[] tableHeader = {"Activity", "Activity Cohesion", "Relation Cohesion (lambda)", "Information Cohesion (mu)"};
	...
	public PDMDesign(String id) {
		this.designID = id;
//		String[] tableHeader = {"Activity", "Activity Cohesion", "Relation Cohesion (lambda)", "Information Cohesion (mu)"};
	}

	/**
	 * Adds an activity to the list of activities.
	 * @param activity PDMActivity
	 */
	 ...
	 * values for every activity and dividing that number by the total number
	 * of activities.
	 *
	 * @return Double
	 */
...
//		tableHeader = ["Activity", "Activity Cohesion", "Relation Cohesion (lambda)", "Information Cohesion (mu)"];
