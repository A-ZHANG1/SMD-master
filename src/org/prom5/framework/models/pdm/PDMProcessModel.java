...
/**
 * <p>Title: PDM Process Model </p>
 * <p>Description: Represents a process model based on a pdm. </p>
...
public class PDMProcessModel {
	...
	HashMap designs = new HashMap();         // the list of designs on the product data model
