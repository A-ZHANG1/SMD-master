...
import org.prom5.framework.models.pdm.PDMActivity;
...
import org.prom5.framework.models.pdm.PDMProcessModel;
import org.w3c.dom.Document;
import org.w3c.dom.Node;
import org.w3c.dom.NodeList;

/**
 * <p>Title: PDM design reader</p>
 * <p>Description: Parses and reads the incoming PDM design file, loads the corresponding activities into
 * the ProM framework and connects it to the corresponding elements of the PDM model. </p>
...
*/
	...
	private String pdmmodel;                  // the name of the PDM model on which the XML file to be read is defining a process model.
	private PDMModel model;                    // the PDM model on which the XML file to be read is defining a process model.
	 ...
	 */
	public PDMProcessModel read(InputStream input, PDMModel model) throws Exception {
		this.model=model;
