...
public class Marking implements Comparable {
	 ...
	 * @param place The place to add the tokes to.
	 ...
	 * @param place The place to remove the tokens from.
	 ...
	 * @param marking The marking to check this marking against.
	...
	public boolean equals(Object marking) {
		...
		while (it.hasNext() && b) {
			...
			b = tokens.get(place.getIdKey()).equals(((Marking) marking).tokens.get(place.getIdKey()));
		}
		return b;
	}
	 ...
	 * @param marking The given marking.
	 ...
	 * @param object The marking given for comparison. object *must be* a marking..
	 * @return 0 if identical, <0 if this marking considered smaller then given marking, >0 if considered greater.
	 */
	 ...
	 * @param marking The marking to subtract
	 */
