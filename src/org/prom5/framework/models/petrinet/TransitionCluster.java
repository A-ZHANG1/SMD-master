 ...
 * grouped together.
 * For example, the {@link PetriNet#makeClusters makeClusters} procedure groups
 ...
 * <p>
 * Note that the transition contained in the cluster must be also contained
 * in the transition list of the Petri net. The grouping is considered to be
...
public class TransitionCluster extends ArrayList {
	...
	/**
	 * Default constructor.
	 * @param label the name of the cluster
	 */
	 ...
	 * template cluster.
	 * Note that referenced Transitions are not cloned themselves (not a deep
	 * copy).
	 * @param copyTemplate the given cluster serving as a template for this object
	 */
	 ...
	 * @return <code>true</code> if the transition is not contained yet, and
	 * the transition could be added. <code>False</code> otherwise
	 */
