...
/**
 * <p>Title: InvariantCalculator </p>
 * <p>Description: This static class calculates a minimal set of semi-positive
 * vectors v, such that incidencMatrix*v = 0</p>
...
//			Message.add("Sweeping with row: " + j + ", due to column " + k);
			...
			for (int row = 0; row < rows; row++) {
				...
				DoubleMatrix2D newrowcpy = DoubleFactory2D.dense.make(1, newrow.size());
