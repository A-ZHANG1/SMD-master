...
/**
 * <p>Title: ReachabilityGraphBuilder </p>
 * <p>Description: This static class provides an implemantation to build the reachabilitygraph of a
...
public class ReachabilityGraphBuilder {
	...
	private static synchronized void extendReachabilityGraph(PetriNet net, StateSpace graphSoFar,
			HashSet newNodes) {
		...
		while (it.hasNext()) {
			...
			if (t.isEnabled()) {
				...
				if (i != -1) {
					...
					FSMTransition e = new FSMTransition(state, s, t.getIdentifier());
