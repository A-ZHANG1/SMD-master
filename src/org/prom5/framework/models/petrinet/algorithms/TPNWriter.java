...
/**
 * <p>Title: TPNWriter </p>
 * <p>Description: This static class returns  a TPN representation of a PetriNet.</p>
...
public class TPNWriter {
	...
	public static String write(PetriNet net) {
		...
		while (it.hasNext()) {
			...
			/*
			 * The use of getPredecessors() and getSuccessors() in the following piece of code
			 * results in wrong results in case of arc weights > 1.
			 * Therefore, we need to iterate over the incoming and outgoing edges.
			 */
