 ...
 * As an example, it is used for each tab in the
...
public class AnalysisGUI extends JPanel implements Provider {
	...
	/**
	 * Default constructor.
	 * @param analysisResults the set of the
	 * {@link AnalysisResult AnalysisResult} objects this category registered for
	 */
	...
	/**
	 * Updates the analysis results for the current subset of the log
	 * (i.e., only for the selected process instances).
	 * @param updatedAnalysisResults the result object filled with new values
	 */
