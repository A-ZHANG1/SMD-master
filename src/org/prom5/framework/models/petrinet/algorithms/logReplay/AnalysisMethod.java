 ...
 * {@link org.prom5.analysis.conformance.AnalysisMethodExecutionThread AnalysisMethodExecutionThread}.
 * <br>
 * Note that this interface is not related to the notion of an
 * {@link org.prom5.analysis.AnalysisPlugin org.processmining.analysis.AnalysisPlugin AnalysisPlugin}, but rather helps coordinating
...
public interface AnalysisMethod {
	...
	/**
	 * Starts the analysis.
	 * @param analysisConfiguration the given analysis configuration determining
	 ...
	 * In order to implement a new analysis method one has to extend the
	 * {@link AnalysisMethodEnum AnalysisMethodEnum} class by another nominal
