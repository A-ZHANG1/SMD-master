...
public class AnalysisMethodEnum implements Cloneable {
	...
	/**
	 * The constructor is private to only allow for pre-defined analysis methods.
	 * @param name the name of the analysis method.
	 */
	 ...
	 *
	 * @param o Object the <code>AnalysisMethodEnum</code> to be compared with
	 * @return boolean <code>true</code> if they relate to the same nominal value,
