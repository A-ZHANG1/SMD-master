 ...
 * relevant information needed afterwards to, e.g., calculate metrics, or provide
...
public abstract class AnalysisResult {
	...
	/**
	 * Constructor.
	 * @param analysisOptions the configuration settings that have been chosen
	 * by the user (if <code>null</code>, the complete analysis should be carried out)
	 */
