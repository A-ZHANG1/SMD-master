...
/**
 * <p>Title: Protos activity data</p>
 *
 * <p>Description: Holds Protos activity data</p>
 *
...
public class ProtosActivityData {
	 ...
	 * @param activityDataNode Node The "activitydata" node that contains the Activity Data.
	 ...
	 * @param tag String The tag to use for this Activity Data object.
	...
	public String writeXMLExport(String tag) {
		...
		xml += "<" + tag + ">";
		{
			xml += ProtosUtil.writeString(ProtosString.DataObject, dataObjectID);
