...
/**
 * <p>Title: Protos activity party</p>
 *
 * <p>Description: Holds a Protos activity data</p>
 *
...
public class ProtosActivityParty {
	 ...
	 * @param activityPartyNode Node The "activityparty" node that contains the Activity Party.
	 ...
	 * @param tag String The tag to use for this Activity Party object.
	...
	public String writeXMLExport(String tag) {
		...
		xml += "<" + tag + ">";
		{
			xml += ProtosUtil.writeString(ProtosString.RoleGroupObject, rolegroupobjectID);
