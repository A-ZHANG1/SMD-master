...
/**
 * <p>Title: Protos data element</p>
 *
 * <p>Description: Holds a Protos data element</p>
 *
...
public class ProtosDataElement {
	...
	private HashSet parties;           // Scalar, Document, Folder, Struct, Application (contains IDs)
	private HashSet metaValues;        // Scalar, Document, Folder, Struct, Application (contains MetaValues)
	private boolean deactivated;       // Scalar, Document, Folder, Struct, Application
	private String iospec;             //         Document
	private HashSet datas;             //         Document, Folder, Struct, Application (contains IDs)
	...
	private int nrVarArgs;             //                                   Application
        ...
        /**
	 * Constructs a Data Element object (except for its type) out of a "scalar", "document", "folder", "struct", or "application" Node.
	 * @param anyNode Node The "scalar", "document", "folder", "struct", or "application" node that contains the Data Element.
	 ...
	 * @param dataElementNode Node The "dataelement" node that contains the Data Element.
	 * @return String Any error message.
	 */
	 ...
	 * @param tag String The tag to use for this Data Element object.
	...
	public String writeXMLExport(String tag) {
		...
		xml += "<" + tag + ">";
		{
			if (type == DataElementScalar) {
				xml += "<" + ProtosString.Scalar + " " + ProtosString.Id + "=\"" + ID + "\">";
				{
					...
					xml += ProtosUtil.writeString(ProtosString.YesLabel, yesLabel);
					xml += ProtosUtil.writeString(ProtosString.NoLabel, noLabel);
					xml += ProtosUtil.writeString(ProtosString.SwitchValues, switchValues);
					for (Iterator it = parties.iterator(); it.hasNext(); ) {
						String party = (String) it.next();
						xml += ProtosUtil.writeString(ProtosString.ScalarParty, party);
					}
				...
				xml += "<" + ProtosString.Document + " " + ProtosString.Id + "=\"" + ID + "\">";
				{
					xml += ProtosUtil.writeString(ProtosString.Name, name);
					xml += ProtosUtil.writeString(ProtosString.Type, dataType);
					...
					for (Iterator it = datas.iterator(); it.hasNext(); ) {
						...
						xml += ProtosUtil.writeString(ProtosString.DocumentData, data);
					}
					for (Iterator it = parties.iterator(); it.hasNext(); ) {
						String party = (String) it.next();
						xml += ProtosUtil.writeString(ProtosString.DocumentParty, party);
					}
					xml += ProtosUtil.writeString(ProtosString.Label, label);
					xml += ProtosUtil.writeString(ProtosString.StandardLetter, standardLetter);
					for (Iterator it = metaValues.iterator(); it.hasNext(); ) {
						ProtosMetavalue metavalue = (ProtosMetavalue) it.next();
						xml += metavalue.writeXMLExport(ProtosString.Metavalue);
					}
				...
				xml += "<" + ProtosString.Folder + " " + ProtosString.Id + "=\"" + ID + "\">";
				{
					xml += ProtosUtil.writeString(ProtosString.Name, name);
					xml += ProtosUtil.writeString(ProtosString.Description, description);
					xml += ProtosUtil.writeString(ProtosString.Workinstruction, workinstruction);
					for (Iterator it = datas.iterator(); it.hasNext(); ) {
						String data = (String) it.next();
						xml += ProtosUtil.writeString(ProtosString.FolderData, data);
					}
					for (Iterator it = parties.iterator(); it.hasNext(); ) {
						String party = (String) it.next();
						xml += ProtosUtil.writeString(ProtosString.FolderParty, party);
					}
					xml += ProtosUtil.writeString(ProtosString.Label, label);
					for (Iterator it = metaValues.iterator(); it.hasNext(); ) {
						ProtosMetavalue metavalue = (ProtosMetavalue) it.next();
				...
				xml += "<" + ProtosString.Struct + " " + ProtosString.Id + "=\"" + ID + "\">";
				{
					xml += ProtosUtil.writeString(ProtosString.Name, name);
					xml += ProtosUtil.writeString(ProtosString.Description, description);
					xml += ProtosUtil.writeString(ProtosString.Workinstruction, workinstruction);
					for (Iterator it = datas.iterator(); it.hasNext(); ) {
						String data = (String) it.next();
						xml += ProtosUtil.writeString(ProtosString.StructData, data);
					}
					for (Iterator it = parties.iterator(); it.hasNext(); ) {
						String party = (String) it.next();
						xml += ProtosUtil.writeString(ProtosString.StructParty, party);
					}
					xml += ProtosUtil.writeString(ProtosString.Label, label);
					for (Iterator it = metaValues.iterator(); it.hasNext(); ) {
						ProtosMetavalue metavalue = (ProtosMetavalue) it.next();
				...
				xml += "<" + ProtosString.Application + " " + ProtosString.Id + "=\"" + ID + "\">";
				{
					xml += ProtosUtil.writeString(ProtosString.Name, name);
					xml += ProtosUtil.writeBool(ProtosString.Automatic, automatic);
					xml += ProtosUtil.writeString(ProtosString.Description, description);
					xml += ProtosUtil.writeString(ProtosString.Workinstruction, workinstruction);
					for (Iterator it = datas.iterator(); it.hasNext(); ) {
						String data = (String) it.next();
						xml += ProtosUtil.writeString(ProtosString.ApplicationData, data);
					}
					for (Iterator it = parties.iterator(); it.hasNext(); ) {
						String party = (String) it.next();
						xml += ProtosUtil.writeString(ProtosString.ApplicationParty, party);
					}
					xml += ProtosUtil.writeString(ProtosString.Label, label);
					xml += ProtosUtil.writeString(ProtosString.ComScript, comScript);
					xml += ProtosUtil.writeInt(ProtosString.NrVarArgs, nrVarArgs);
					for (Iterator it = metaValues.iterator(); it.hasNext(); ) {
						ProtosMetavalue metavalue = (ProtosMetavalue) it.next();
						xml += metavalue.writeXMLExport(ProtosString.Metavalue);
					}
