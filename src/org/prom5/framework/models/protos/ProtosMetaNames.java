...
/**
 * <p>Title: Protos meta names</p>
 *
 * <p>Description: Hodls Protos meta names</p>
 *
...
public class ProtosMetaNames {
	// All HashSets contain ProtosMetaNames, that is, objects of the class ProtosMetaName.
	 ...
	 * @param metaNamesNode Node The node that contains the Meta Names.
	 ...
	 * @param tag String The tag to use for this Meta Names object.
