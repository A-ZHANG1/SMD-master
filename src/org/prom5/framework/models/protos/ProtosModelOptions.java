...
/**
 * <p>Title: Protos model options</p>
 *
 * <p>Description: Holds the Protos model options</p>
 *
...
public class ProtosModelOptions {
	 ...
	 * @param optionsNode Node The node that contains the Model Options.
	 ...
	 * @param tag String The tag to use for this Model Options object.
	...
	public String writeXMLExport(String tag) {
		String xml = "";
                xml += "<" + tag + ">";
		{
                    xml += simulationArrival.writeXMLExport(ProtosString.SimulationArrival);
                }
                xml += "</" + tag + ">";
		return xml;
	}
