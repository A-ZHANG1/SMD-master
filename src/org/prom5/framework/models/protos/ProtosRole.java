...
/**
 * <p>Title: Protos role</p>
 *
 * <p>Description: Holds a Protos role</p>
 *
...
public class ProtosRole {
	 ...
	 * @param roleNode Node The node that contains the Role.
	 * @return String Any error message.
	 */
	public String readXMLExport(Node roleNode) {
		String msg = "";
		ID = roleNode.getAttributes().getNamedItem(ProtosString.Id).getNodeValue();
		organisation = roleNode.getAttributes().getNamedItem(ProtosString.Organisation).
					   getNodeValue();
	 ...
	 * @param tag String The tag to use for this Role object.
