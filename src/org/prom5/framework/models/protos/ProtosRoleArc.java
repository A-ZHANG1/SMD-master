...
/**
 * <p>Title: Protos role arc</p>
 *
 * <p>Description: Holds a Protos role arc (from/to)</p>
 *
...
public class ProtosRoleArc {
	...
	public String readXMLExport(Node roleArcNode) {
		String msg = "";
		fromID = roleArcNode.getAttributes().getNamedItem(ProtosString.From).getNodeValue();
		toID = roleArcNode.getAttributes().getNamedItem(ProtosString.To).getNodeValue();
		return msg;
	}

	/**
	 * Returns the Role Arc object in Protos XML Export format.
	 * @param tag String The tag to use for this Role Arc object.
