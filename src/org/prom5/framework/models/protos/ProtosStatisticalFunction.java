...
/**
 * <p>Title: Protos statistical function</p>
 *
 * <p>Description: Holds a Protos statistical function</p>
 *
...
public class ProtosStatisticalFunction {
	 ...
	 * @param anyNode Node The "Nexp", "Beta", "Normal", "Erlang", "Gamma", "Uniform", or "Constant" node that contains the Statistical Function.
	 ...
	 * @param statisticalFunctionNode Node The node that contains the Statistical Function.
	 * @return String Any error message.
	 */
	 ...
	 * @param tag String The tag to use for this Statistical Function object.
	 * @return String The Statistical Function object in Protos XML Export format.
	 */
	public String writeXMLExport(String tag) {
		...
		xml += "<"+ tag + ">";
		{
			if (type == StatisticalFunctionNexp) {
				xml += "<" + ProtosString.Nexp + " " + ProtosString.Mean + "=\"" + mean + "\"/>";

			} else if (type == StatisticalFunctionBeta) {
				xml += "<" + ProtosString.Beta + " " + ProtosString.Mean + "=\"" + mean  + "\" " + ProtosString.Minimum + "=\"" + minimum + "\" " + ProtosString.Maximum + "=\"" + maximum + "\"/>";

                        } else if (type == StatisticalFunctionNormal) {
				xml += "<" + ProtosString.Normal + " " + ProtosString.Mean + "=\"" + mean + "\" " + ProtosString.Variance + "=\"" + variance + "\"/>";

                        } else if (type == StatisticalFunctionErlang) {
				xml += "<" + ProtosString.Erlang + " " + ProtosString.Mean + "=\"" + mean + "\" " +ProtosString.Number + "=" + number + "\"/>";

                        } else if (type == StatisticalFunctionGamma) {
				xml += "<" + ProtosString.Gamma + " " + ProtosString.Mean + "=\"" + mean + "\" " + ProtosString.Variance + "=\"" + variance + "\"/>";

                        } else if (type == StatisticalFunctionUniform) {
				xml += "<" + ProtosString.Uniform + " " + ProtosString.Minimum + "=\"" + minimum + "\" " + ProtosString.Maximum + "=\"" + maximum + "\"/>";

                        } else if (type == StatisticalFunctionConstant) {
				xml += "<" + ProtosString.Constant + " " + ProtosString.Mean + "=\"" + mean + "\"/>";
