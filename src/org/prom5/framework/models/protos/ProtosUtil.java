...
public class ProtosUtil {
	 ...
	 * @param node Node The fiven node.
	...
	static public String writeString(String tag, String value) {
		String xml = "<" + tag + ">";
		if (value != null) {
			xml += value.replaceAll("&", "&amp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;");
		}
		xml += "</" + tag + ">";
		return xml;
	}
	 ...
	 * @param tag String The given tag.
	 * @param value String The given value.
	 * @return String The tagged value, if non-empty. Otherwise the empty string..
	 */
	...
	static public String writeBool(String tag, boolean value) {
		return "<" + tag + ">" + ( value ? ProtosString.True : ProtosString.False) + "</" + tag + ">";
	}
	 ...
	 * Tags (XML-style) the given value with the given tag.
	 * @param tag String The given tag.
	 * @param value double The given value.
	 * @return String The tagged value.
	 */
