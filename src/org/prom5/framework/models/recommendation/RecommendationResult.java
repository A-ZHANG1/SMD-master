...
/**
 * Data structure for storing a result for
 * requesting recommendation for scheduling in a process management system.
 * (based on an array list of Recommendation objects)
 *
...
public class RecommendationResult extends ArrayList<Recommendation> {
	 ...
	 * @param queryId the unique ID of the query to which this is a result.
	 */
