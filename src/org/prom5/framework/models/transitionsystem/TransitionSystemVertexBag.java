...
public class TransitionSystemVertexBag extends TransitionSystemVertex
{
	...
	public TransitionSystemVertexBag(Collection<String> docs, Collection<String> exLogs, TransitionSystem g)
	{
		super(g);
	...
	public TransitionSystemVertexBag(Collection<String> docs, String exLog, TransitionSystem g)
	{
		super(g);
		this.docs = new MultiSet<String>(docs);
