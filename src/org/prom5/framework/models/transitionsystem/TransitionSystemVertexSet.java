...
public class TransitionSystemVertexSet extends TransitionSystemVertex
{
	...
	public TransitionSystemVertexSet(Collection<String> docs, Collection<String> exLogs, TransitionSystem g)
	{
		super(g);
	...
	public TransitionSystemVertexSet(Collection<String> docs, String exLog, TransitionSystem g)
	{
		super(g);
		this.docs = new HashSet<String>(docs);
