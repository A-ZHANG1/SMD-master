...
/**
 * <p>Title: YAWL edge</p>
 * <p>Description: Holds a YAWL edge</p>
...
public class YAWLEdge extends ModelGraphEdge {
     ...
     * @param fromVertex The given source node
     * @param toVertex The given destination node
    ...
    public YAWLEdge(YAWLNode fromNode, YAWLNode toNode, boolean isDefaultFlow,
        ...
        init(isDefaultFlow, predicate,
             ordering == null ? 0 : Integer.valueOf(ordering).intValue());
    }
