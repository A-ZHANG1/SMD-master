...
/**
 * <p>Title: YAWL Model</p>
 * <p>Description: Holds an imported YAWL model</p>
...
public class YAWLModel extends ModelGraph {
	...
	private HashMap<String,YAWLDecomposition> decompositions = new HashMap(); // All decompositions of the YAWL model
	...
	/**
	 * Writes the model to dot. For the time being, the first decompositionis written.
	 * @param bw The writer
