...
public class About extends JDialog {
	...
	public final static String NAME_FULL =
			"<html><center>The <B>Pro</B>cess <B>M</B>ining framework<br>" +
	...
	public final static String INFO = "<html><center>Version:&nbsp;&nbsp;" + About.VERSION + "<br>Released:&nbsp;&nbsp;"+VERSION_DATE+"</center></html>";
	 ...
	 * File.separator + "lib" + file.separator + "documentation" + file.separator
	 */
	...
	/**
	 * EXTLIBLOCATION stores the location of the external library files, i.e. "user.dir" +
	 * File.separator + "lib" + file.separator + "external" + file.separator
	 */
	public static String EXTLIBLOCATION() {
		return System.getProperty("user.dir") + File.separator
		  + "lib" + File.separator + "external" + File.separator;
	}
	...
	public static String MODELLOCATION() {
		return System.getProperty("user.dir") + File.separator
		 + "lib" + File.separator + "models" + File.separator;
	}
	...
	/**
	 * CORPORATEIMAGELOCATION stores the location of the corporate image files, i.e. "user.dir" +
	 * File.separator + "lib" + file.separator + "images" + file.separator + "corporate" + file.separator
	 */
	public static String CORPORATEIMAGELOCATION() {
		return System.getProperty("user.dir") + File.separator
			+ "images" + File.separator + "corporate" + File.separator;
	}


	/**
	 * WATERMARKIMAGELOCATION stores the location of the corporate image files, i.e. "user.dir" +
	 * File.separator + "lib" + file.separator + "images" + file.separator + "watermark" + file.separator
	 */
	public static String WATERMARKIMAGELOCATION() {
		return System.getProperty("user.dir") + File.separator
			+ "images" + File.separator + "watermark" + File.separator;
	}
...
//											 "the framework starts mining immediately including all events of the given process.</td></tr>" +
	...
	/**
	 * Returns information about the optional command-line parameters of the ProM
	...
	/**
	 * unHTML removes HTML tags from a string. It replaces the following substrings
	 * (in this order):
	 * <br>
	 * 1) "</tr>" is replaced by "\n"
	 * 2) "<&nbsp;>" is replaced by " "
	...
	/**
	 * Returns information about the optional command-line parameters of the ProM
	 * framework in an HTML formatted String.
	 *
	 * @return String
	 */
	...
	public About(JFrame owner) {
		...
		String customIconPath = UISettings.getInstance().getPreferredIconTheme() + "/applogo_small.png";
		...
		sponsorPane.setText(
				"<html><table halign=center valign=center>" +
		...
		JLabel pluginCountLabel = new JLabel(
								  ...
								  MiningPluginCollection.getInstance().size() + "</td>" +
								  "<td>Analysis: </td><td align=right>" +
								  AnalysisPluginCollection.getInstance().size() + "</td></tr>" +

								  "<tr><td>Import: </td><td align=right>" +
								  ImportPluginCollection.getInstance().size() + "</td>" +
								  "<td>Export: </td><td align=right>" +
								  ExportPluginCollection.getInstance().size() + "</td></tr>" +

								  "<tr><td>Conversion: </td><td align=right>" +
								  ConvertingPluginCollection.getInstance().size() + "</td>" +
								  "<td>LogFilters: </td><td align=right>" +
								  LogFilterCollection.getInstance().size() + "</td></tr>" +
	...
	private String getSystemInfo() {
		return  "<html><table>" +
				...
				"<tr><td>&nbsp;</td><td>" +
					nz(System.getProperty("java.vm.name")) + " " + nz(System.getProperty("java.vm.info")) + "</td></tr>" +
				"<tr><td>Home directory:</td><td>" + nz(System.getProperty("java.home")) + "</td></tr>" +
				"<tr><td colspan=2>&nbsp;</td></tr>" +
				"<tr><td>Operating system:</td><td>" + nz(System.getProperty("os.name")) + " " + System.getProperty("sun.os.patch.level") + "</td></tr>" +
				"<tr><td>Version:</td><td>" + nz(System.getProperty("os.version")) + "</td></tr>" +
				"<tr><td>Architecture:</td><td>" + nz(System.getProperty("os.arch")) + "</td></tr>" +
				"</table></html>";
	}
