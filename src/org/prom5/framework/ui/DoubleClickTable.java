...
public class DoubleClickTable extends JTable {
	...
	public DoubleClickTable(Object[][] rowData, Object[] columnNames, JButton button) {
	...
	public DoubleClickTable(TableModel dm, TableColumnModel cm, ListSelectionModel sm,
			JButton button) {
		super(dm, cm, sm);
		addButton(button);
	}
	...
	private void addButton(final JButton button) {
		...
		final MyPopupMenu rightMenu = new MyPopupMenu("select", DoubleClickTable.this);
