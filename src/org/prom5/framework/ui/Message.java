...
public class Message {
	...
	public static void clearMessages() {
		synchronized (listeners) {
			ActionListener[] list = (ActionListener[]) listeners.getListeners(ActionListener.class);
