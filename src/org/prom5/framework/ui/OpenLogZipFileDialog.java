...
public class OpenLogZipFileDialog extends JDialog {
	...
	void chooseLogButton_actionPerformed(ActionEvent e) {
		...
		chooser.setFileFilter(new GenericMultipleExtFilter(new String[] {"xml", "zip"}
				, "XML and ZIP files (*.xml, *.zip)"));
	...
	void openButton_actionPerformed(ActionEvent e) {
		if (workflowLogFile.getText() == null || workflowLogFile.getText().equals("")) {
			JOptionPane.showMessageDialog(MainUI.getInstance(), "Please choose a log file.");
