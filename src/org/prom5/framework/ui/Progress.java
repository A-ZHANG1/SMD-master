...
public class Progress implements CancelationComponent{
	 ...
	 * @param caption the text to be displayed above the progress visualization
	 */
	 ...
	 * @param minimum the minimum range value (from)
	 * @param maximum the maximum range value (t0)
	 */
	 ...
	 * @param caption the text to be displayed above the progress visualization
	 * @param minimum the minimum range value (from)
	 * @param maximum the maximum range value (to)
	 */
	public Progress(String caption, int minimum, int maximum) {
		progress = new ProgressMonitor(MainUI.getInstance(), caption, "", minimum, maximum);
	 ...
	 * progress dialog.
	 * @return <code>true</code> if user has clicked "cancel", <code>false</code> otherwise
	 */
	 ...
	 * @param m the number towards the progress will move
	 */
	 ...
	 * @param m the number from which the progress will move
	 */
	 ...
	 * @param min the number from which the progress will move
	 * @param max the number towards the progress will move
	 */
	 ...
	 * Can be used to give more detailed feedback to the user than the progress
	 * visualization (e.g., what exactly is currently happening).
	 * @param note the updated text to be displayed in progress dialog
	 */
	 ...
	 * This will move the progress bar to the new status position
	 * (relative to the minimum and maximum range values).
	 * @param nv the new progress status
	 */
