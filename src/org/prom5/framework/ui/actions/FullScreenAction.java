...
import com.fluxicon.slickerbox.util.FullScreenView;
...
public class FullScreenAction extends CatchOutOfMemoryAction {
	...
	static {
		try {
			icon = ImageIO.read(new File(About.IMAGELOCATION() + "actionbarlogo.png"));
	...
	public static Icon getIcon() {
		String customIconPath = UISettings.getInstance().getPreferredIconTheme() + "/toolbar_fullscreen.png";
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.ui.actions.CatchOutOfMemoryAction#execute(java.awt.event.ActionEvent)
	 */
	@Override
	public void execute(ActionEvent e) {
		...
		for(JInternalFrame frame : frames) {
			if(frame.isSelected()) {
				...
				FullScreenView.enterFullScreen(wrapper, frame.getTitle(), null, new ActionListener() {
	...
	/* (non-Javadoc)
	 * @see org.processmining.framework.ui.actions.CatchOutOfMemoryAction#handleOutOfMem()
	 */
	@Override
