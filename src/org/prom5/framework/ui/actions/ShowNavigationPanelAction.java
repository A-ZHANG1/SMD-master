...
public class ShowNavigationPanelAction extends CatchOutOfMemoryAction {
	...
	public ShowNavigationPanelAction(MDIDesktopPane desktop) {
		super("Toggle navigation panel...", Utils.getStandardIcon("toolbar_navigation.png", "general/History24"), desktop);
		putValue(SHORT_DESCRIPTION, "Show or hide the navigation panel on the right side");
