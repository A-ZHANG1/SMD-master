...
import org.prom5.framework.ui.actions.ExportAction;
...
public class ExportMenu extends JMenu {
	...
	private JMenuItem none = new JMenuItem(
			RuntimeUtils.stripHtmlForOsx("<html><font color=\"#999999\">No export available <br>for selected frame</font></html>"));
	private JMenuItem noneshort = new JMenuItem(
			RuntimeUtils.stripHtmlForOsx("<html><font color=\"#999999\">No export available</font></html>"));
	...
	private void buildChildMenus(ProvidedObject[] objects, JMenuItem noneFound) {
		ExportPluginCollection collection = ExportPluginCollection.getInstance();
	...
	private void buildSubMenus(JMenu superMenu, ExportPluginCollection collection, ProvidedObject po) {
