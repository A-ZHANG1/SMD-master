...
public class HelpMenu extends JMenu {
	...
	private JMenuItem noneshort = new JMenuItem(
			RuntimeUtils.stripHtmlForOsx("<html><font color=\"#999999\">No help available</font></html>"));
	...
	public HelpMenu() {
		...
		addMenuListener(new MenuListener() {
			...
			public void menuSelected(MenuEvent e) {
				buildChildMenus(MainUI.getInstance().getDesktop().getPluginSelectedFrame(),
						noneshort);
			}
		});
	...
	class HelpAction extends AbstractAction {
		...
		public HelpAction(Plugin plugin) {
			super(RuntimeUtils.stripHtmlForOsx("<html>" + plugin.getName() + "</html>"));
			this.plugin = plugin;
		}
