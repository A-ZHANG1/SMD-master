...
import org.prom5.framework.ui.actions.MineAction;
...
public class MineMenu extends JMenu {
	...
	private JMenuItem none = new JMenuItem(
							 RuntimeUtils.stripHtmlForOsx(
							 "<html><font color=\"#999999\">No partial log available<br>in selected frame</font></html>"));
	...
	private void buildChildMenus(ProvidedObject[] po) {
		MiningPluginCollection collection = MiningPluginCollection.getInstance();
