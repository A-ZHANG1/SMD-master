 ...
 *
 */
package org.prom5.framework.ui.slicker;
...
public class LogView extends JPanel {
	...
	public LogView(LogReader log) {
		...
		for(int i=0; i<log.numberOfInstances(); i++) {
			ProcessInstanceView instanceView = new ProcessInstanceView(log.getInstance(i), log.getLogSummary());
		...
		vBar.setUI(new SlickerScrollBarUI(vBar, new Color(30, 30, 30), new Color(140, 140, 140), new Color(80, 80, 80), 4, 12));
		JScrollBar hBar = scrollPane.getHorizontalScrollBar();
		hBar.setUI(new SlickerScrollBarUI(hBar, new Color(30, 30, 30), new Color(140, 140, 140), new Color(80, 80, 80), 4, 12));
