 ...
 *
 */
package org.prom5.framework.ui.slicker.console;
...
public class SlickerMessageBar extends GradientPanel {
	...
	public SlickerMessageBar() {
		...
		largeConsoleScrollPane.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
		largeConsoleScrollPane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
		JScrollBar vBar = largeConsoleScrollPane.getVerticalScrollBar();
		vBar.setUI(new SlickerScrollBarUI(vBar, new Color(0, 0, 0, 0), new Color(140, 140, 140), new Color(110, 110, 110), 4, 12));
		...
		final TypeToggleButton messageButton = new TypeToggleButton("messages", "M", SlickerConsole.colorNormal);
		messageButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				console.setShowMessages(!console.isShowMessages());
			}
		});
		final TypeToggleButton warningButton = new TypeToggleButton("warnings", "W", SlickerConsole.colorWarning);
		warningButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				console.setShowWarnings(!console.isShowWarnings());
			}
		});
		final TypeToggleButton errorButton = new TypeToggleButton("errors", "E", SlickerConsole.colorError);
		errorButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				console.setShowErrors(!console.isShowErrors());
			}
		});
		final TypeToggleButton debugButton = new TypeToggleButton("debug messages", "D", SlickerConsole.colorDebug);
		debugButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				console.setShowDebug(!console.isShowDebug());
			}
		});
		final TypeToggleButton testButton = new TypeToggleButton("test messages", "T", SlickerConsole.colorTest);
