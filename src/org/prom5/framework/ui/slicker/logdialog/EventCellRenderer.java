 ...
 *
 */
public class EventCellRenderer extends GradientPanel implements ListCellRenderer {
	...
	public Component getListCellRendererComponent(JList list, Object value,
		...
		// configure yourself
		if(isSelected) {
			this.setColors(LogPreviewUI.COLOR_LIST_SELECTION_BG, LogPreviewUI.COLOR_LIST_SELECTION_BG_LOWER);
		} else {
