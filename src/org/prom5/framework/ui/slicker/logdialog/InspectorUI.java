...
public class InspectorUI extends JPanel {
	...
	public InspectorUI(SlickerOpenLogSettings parent) {
		...
		tabPane = new FlatTabbedPane("Log inspector", new Color(240, 240, 240, 230), new Color(180, 180, 180, 120), new Color(220, 220, 220, 150));
		this.parent = parent;
	...
	protected void updateLog() {
		removeAll();
		progress.setNote("Filtering log using " + parent.getActiveLogFilterName());
