...
public class Func {
	...
	public static <T1, T2> void map(Iterable<T1> seq, Fun1<T2, T1> fun, Collection<T2> dest) {
		for (T1 t : seq) {
	...
	public static String joinAtMost(int maxnum, Iterable<String> sequence, String separator, String whenExceeded) {
	...
	public static String joinAtMost(int maxnum, Iterable<String> sequence, String separator, String beforeExceeded, String afterExceeded) {
		StringBuffer result = new StringBuffer();
		int i = 0;
		int hasMore = 0;
