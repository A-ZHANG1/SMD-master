...
public class GUIPropertyBoolean {
	 ...
	 */
	public GUIPropertyBoolean(String name, boolean defaultValue, GuiNotificationTarget target) {
	 ...
	 * @param defaultValue the default value of this property
	 */
	public GUIPropertyBoolean(String name, String description, boolean defaultValue) {
	 ...
	 * @param b boolean true if the radio button needs to be selected, otherwise false
	 */
