...
public class GUIPropertyDouble implements ChangeListener {
	 ...
	 */
	public GUIPropertyDouble(String name, double defaultValue, double minValue, double maxValue, double stepSize) {
	 ...
	 * @param stepSize the distance between two adjacent values
	 */
	public GUIPropertyDouble(String name, String description, double defaultValue, double minValue, double maxValue, double stepSize) {
	 ...
	 */
	public GUIPropertyDouble(String name, double defaultValue, double minValue, double maxValue,
	 ...
	 * @param target the object to be notified as soon the state of this property changes
	 */
	public GUIPropertyDouble(String name, String description, double defaultValue, double minValue,
	 ...
	 * @param target the object to be notified as soon the state of this property changes
	 */
	public GUIPropertyDouble(String name, String description, double defaultValue, double stepSize, GuiNotificationTarget target) {
		myName = name;
		myDescription = description;
		myValue = defaultValue;
		myTarget = target;
