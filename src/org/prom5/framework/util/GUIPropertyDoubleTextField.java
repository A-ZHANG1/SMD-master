 ...
 * name of the property and a textfield.
...
public class GUIPropertyDoubleTextField implements KeyListener {
	 ...
	 */
	public GUIPropertyDoubleTextField(String name, double defaultValue, double minValue, double maxValue) {
	 ...
	 * @param stepSize the distance between two adjacent values
	 */
	public GUIPropertyDoubleTextField(String name, String description, double defaultValue, double minValue, double maxValue) {
	 ...
	 * @param target the object to be notified as soon the state of this property changes
	 */
	public GUIPropertyDoubleTextField(String name, String description, double defaultValue, double minValue,
			double maxValue, GuiNotificationTarget target) {
		this(name, description, defaultValue, target, false, minValue, false, maxValue, 100);
	}
	 ...
	 * @param target the object to be notified as soon the state of this property changes
	 */
	public GUIPropertyDoubleTextField(String name, String description, double defaultValue, 
	 ...
	 * @param defaultValue the default value of this property
	 */
	public GUIPropertyDoubleTextField(String name, double defaultValue, GuiNotificationTarget target) {
		this(name, null, defaultValue, target, true, 0, true, 0, 100);
	}
	
	public GUIPropertyDoubleTextField(String name, String description, double defaultValue, 
			GuiNotificationTarget target, boolean noMin, double minValue, 
			boolean noMax, double maxValue, int width) {
		myName = name;
		myDescription = name;
	 ...
	 * @param name the name of this property
	 * @param defaultValue the default value of this property
	 * @param value the minimal or maximal value of this property, based on the value set for minOrMax
	 * @param minOrMax if true then with value the minimal value will be specified (and there is no 
	 * maximum value), otherwise the maximal value will be specified (and there is no minimal value)
	 */
	public GUIPropertyDoubleTextField(String name, double defaultValue, double value, 
			boolean minOrMax, GuiNotificationTarget target) {
		this(name, null, defaultValue, target, (minOrMax?false:true), (minOrMax?value:0), 
				(minOrMax?true:false), (minOrMax?0:value), 100);
	}

	/**
	 * The method automatically invoked when changing the text field status.
	 * @param e the passed action event (not used)
	 */
	...
	public void keyReleased(KeyEvent e) {
		try {
			...
			// check whether the new value is between the minimal and maximal value
			if (myNoMin == false && myNoMax == false && (myValue >= myMinValue) && (myValue <= myMaxValue)) {
	...
	public JPanel getPropertyPanel() {
		...
		myTextField.setSize(new Dimension(myWidth, (int) myTextField.getPreferredSize().getHeight()));
		myTextField.setPreferredSize(new Dimension(myWidth, (int) myTextField.getPreferredSize().getHeight()));
		myTextField.setMaximumSize(new Dimension(myWidth, (int) myTextField.getPreferredSize().getHeight()));
		myTextField.setMinimumSize(new Dimension(myWidth, (int) myTextField.getPreferredSize().getHeight()));
