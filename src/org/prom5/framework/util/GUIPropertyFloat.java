...
/**
 * A float property that can be readily displayed as it maintains its own GUI panel.
...
public class GUIPropertyFloat implements ChangeListener {
	 ...
	 */
	public GUIPropertyFloat(String name, float defaultValue, float minValue, float maxValue, float stepSize) {
	 ...
	 * @param stepSize the distance between two adjacent values
	 */
	public GUIPropertyFloat(String name, String description, float defaultValue, float minValue, float maxValue, float stepSize) {
	 ...
	 * @param target the object to be notified as soon the state of this property changes
	 */
	public GUIPropertyFloat(String name, String description, float defaultValue, float minValue, float maxValue,
			float stepSize, GuiNotificationTarget target) {
		myName = name;
		...
		myStepSize = stepSize;
		// GUI attributes
		//myModel = new SpinnerNumberModel(myValue /*initial value*/, minValue /*min*/, maxValue /*max*/, stepSize /*step*/);
	...
	public JPanel getPropertyPanel() {
		if (myModel == null) {
			myModel = new SpinnerNumberModel(myValue /*initial value*/, myMinValue /*min*/, myMaxValue /*max*/, myStepSize /*step*/);
			mySpinner = new JSpinner(myModel);
			mySpinner.setSize(new Dimension(100, (int) mySpinner.getPreferredSize().getHeight()));
			mySpinner.setPreferredSize(new Dimension(100, (int) mySpinner.getPreferredSize().getHeight()));
			mySpinner.setMaximumSize(new Dimension(100, (int) mySpinner.getPreferredSize().getHeight()));
