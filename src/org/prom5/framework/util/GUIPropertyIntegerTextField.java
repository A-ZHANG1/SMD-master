...
public class GUIPropertyIntegerTextField implements KeyListener {
	 ...
	 */
	public GUIPropertyIntegerTextField(String name, int defaultValue, int minValue, int maxValue) {
	 ...
	 * @param maxValue the maximal value that can be assigned to this property
	 */
	public GUIPropertyIntegerTextField(String name, String description, int defaultValue, int minValue, int maxValue) {
	 ...
	 * @param target the object to be notified as soon the state of this property changes
	 */
	public GUIPropertyIntegerTextField(String name, String description, int defaultValue, 
			GuiNotificationTarget target) {
		myName = name;
		myDescription = description;
		myValue = defaultValue;
	 ...
	 * @param minOrMax if true then with value the minimal value will be specified, otherwise the maximal value will be specified
	 */
	public GUIPropertyIntegerTextField(String name, int defaultValue, int value, boolean minOrMax, 
			GuiNotificationTarget target) {
		myName = name;
		myValue = defaultValue;
		myTarget = target;
	...
	public JPanel getPropertyPanel() {
		// create the textfield, when the guipropertydouble is asked for its panel
		if (myTextField == null) {
			myTextField = new JTextField();
			myTextField.setText(new Integer(myValue).toString());
		}
		myTextField.setSize(new Dimension(100, (int) myTextField.getPreferredSize().getHeight()));
		myTextField.setPreferredSize(new Dimension(100, (int) myTextField.getPreferredSize().getHeight()));
		myTextField.setMaximumSize(new Dimension(100, (int) myTextField.getPreferredSize().getHeight()));
		myTextField.setMinimumSize(new Dimension(100, (int) myTextField.getPreferredSize().getHeight()));
