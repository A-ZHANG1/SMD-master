...
public class GUIPropertyListEnumeration implements ActionListener {
	 ...
	 * @param values the possible values of this property. The objects in this
	 ...
	 * first value in the list is considered as the default value
	 */
	public GUIPropertyListEnumeration(String name, String description, List values) {
	 ...
	 */
	public GUIPropertyListEnumeration(String name, List values, GuiNotificationTarget target) {
	 ...
	 * Note that it is assumed that this value is in the list 
	 * of possible values
	...
	public JPanel getPropertyPanel() {
		if (myComboBox == null) {
			...
			myComboBox.setSize(new Dimension(myWidth, (int) myComboBox.getPreferredSize().getHeight()));
			myComboBox.setPreferredSize(new Dimension(myWidth, (int) myComboBox.getPreferredSize().getHeight()));
			myComboBox.setMaximumSize(new Dimension(myWidth, (int) myComboBox.getPreferredSize().getHeight()));
			myComboBox.setMinimumSize(new Dimension(myWidth, (int) myComboBox.getPreferredSize().getHeight()));
