...
public class GUIPropertyLong implements ChangeListener {
	 ...
	 */
	public GUIPropertyLong(String name, long defaultValue, long minValue, long maxValue) {
	 ...
	 * @param maxValue the maximal value that can be assigned to this property
	 */
	public GUIPropertyLong(String name, String description, long defaultValue, long minValue, long maxValue) {
	...
	public GUIPropertyLong(String name, String description, long defaultValue, long minValue, long maxValue,
		...
		myTarget = target;
		// GUI attributes
		//myModel = new SpinnerNumberModel(myValue /*initial value*/, minValue /*min*/, maxValue /*max*/, 1 /*step*/);
		//mySpinner = new JSpinner(myModel);
		//mySpinner.setSize(new Dimension(70, (int) mySpinner.getPreferredSize().getHeight()));
		//mySpinner.setPreferredSize(new Dimension(70, (int) mySpinner.getPreferredSize().getHeight()));
		//mySpinner.setMaximumSize(new Dimension(70, (int) mySpinner.getPreferredSize().getHeight()));
		//mySpinner.setMinimumSize(new Dimension(70, (int) mySpinner.getPreferredSize().getHeight()));
