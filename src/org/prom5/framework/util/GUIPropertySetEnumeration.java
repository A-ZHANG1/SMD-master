...
public class GUIPropertySetEnumeration implements ActionListener {
	 ...
	 */
	public GUIPropertySetEnumeration(String name, Set values, GuiNotificationTarget target) {
	 ...
	 * @param target the object to be notified as soon the state of this property changes
	 */
	public GUIPropertySetEnumeration(String name, String description, Set values, GuiNotificationTarget target) {
	...
	public GUIPropertySetEnumeration(String name, String description, Set values,
		...
		myComboBox.setSize(new Dimension(width, (int) myComboBox.getPreferredSize().getHeight()));
		myComboBox.setPreferredSize(new Dimension(width, (int) myComboBox.getPreferredSize().getHeight()));
		myComboBox.setMaximumSize(new Dimension(width, (int) myComboBox.getPreferredSize().getHeight()));
		myComboBox.setMinimumSize(new Dimension(width, (int) myComboBox.getPreferredSize().getHeight()));
