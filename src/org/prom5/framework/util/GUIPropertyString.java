...
/**
 * A string property that can be readily displayed as it maintains its own GUI panel.
 * The property will be graphically represented as a (single line) text field that can be edited.
...
public class GUIPropertyString implements KeyListener {
	 ...
	 * @param defaultValue the default value of this property
	 */
	public GUIPropertyString(String name, String description, String defaultValue) {
	 ...
	 */
	public GUIPropertyString(String name, String defaultValue, GuiNotificationTarget target) {
	 ...
	 * @param target the object to be notified as soon the state of this property changes
	 */
	public GUIPropertyString(String name, String description, String defaultValue, GuiNotificationTarget target) {
	 ...
	 * @param defaultValue the default value of this property
	 * @param target the object to be notified as soon the state of this property changes
	 * @param width a custom width may be specified (default value is 100 otherwise)
	 */
	public GUIPropertyString(String name, String description, String defaultValue, 
	 ...
	 * @param target the object to be notified as soon the state of this property changes
	 * @param width a custom width may be specified (default value is 100 otherwise)
	 * @param editable whether the string should be editable or not
	 */
	public GUIPropertyString(String name, String description, String defaultValue, 
