...
public class GUIPropertyStringArea implements DocumentListener {
	 ...
	 * @param defaultValue the default value of this property
	 */
	public GUIPropertyStringArea(String name, String description, String defaultValue) {
	 ...
	 */
	public GUIPropertyStringArea(String name, String defaultValue, GuiNotificationTarget target) {
	 ...
	 * @param target the object to be notified as soon the state of this property changes
	 */
	public GUIPropertyStringArea(String name, String description, String defaultValue, GuiNotificationTarget target) {
	 ...
	 */
	public GUIPropertyStringArea(String name, String description, String defaultValue, GuiNotificationTarget target, int width) {
		myName = name;
