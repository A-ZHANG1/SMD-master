...
public class GuiPropertyListRadio implements MouseListener {
	 ...
	 * first value in the list is considered as the default value
	 */
	public GuiPropertyListRadio(String name, String description, List<String> values) {
	 ...
	 */
	public GuiPropertyListRadio(String name, List<String> values, GuiNotificationTarget target) {
	 ...
	 * @see #enable(String)
	 * @param the name of the radio button to disable
	 */
	 ...
	 * GUI panel.
	 * @see #disable(String)
	 * @param the name of the radio button to enable
	 */
	...
	/**
	 * Sets the state of respective radio button. In the case that the radiobutton
	 * had been disabled and it needs to be selected, the call will be ignored.
	 * @param toSetSelected String the name of the radio button to select/deselect
	 * @param b boolean true if the radio button is selected, otherwise false
	 */
	 ...
	 * @param toCheck String the name of the radiobutton
