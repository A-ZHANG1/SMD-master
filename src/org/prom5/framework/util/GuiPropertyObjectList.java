...
public class GuiPropertyObjectList implements ListSelectionListener {
	 ...
	 */
	public GuiPropertyObjectList(String name, List initialValues, List availableValues) {
	 ...
	 * contain the initial values
	 */
	public GuiPropertyObjectList(String name, String description, List initialValues, List availableValues) {
	 ...
	 */
	public GuiPropertyObjectList(String name, List initialValues, List availableValues, GuiNotificationTarget target) {
	...
	public GuiPropertyObjectList(String name, String description, List initialValues, List availableValues,
		...
		myAvailableList = new GUIPropertyListEnumeration("", "", myAvailableValues, null, 150);
	...
	/*
	 * Helper mehtod to redraw property panel as soon as list of selected
	 * values has changed.
	 */
