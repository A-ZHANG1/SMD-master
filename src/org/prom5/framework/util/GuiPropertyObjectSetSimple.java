 ...
 */
public class GuiPropertyObjectSetSimple implements ListSelectionListener,GuiNotificationTarget {
         ...
         */
        public GuiPropertyObjectSetSimple(String name, List initialValues, List availableValues) {
         ...
         * contain the initial values
         */
        public GuiPropertyObjectSetSimple(String name, String description, List initialValues, List availableValues) {
         ...
         */
        public GuiPropertyObjectSetSimple(String name, List initialValues, List availableValues, GuiNotificationTarget target) {
