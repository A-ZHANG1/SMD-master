...
public class GuiPropertyStringList implements ListSelectionListener {
	 ...
	 * @param values the initial string values of this property
	 */
	 ...
	 * @param values the initial string values of this property
	 */
	public GuiPropertyStringList(String name, String description, List<String> values) {
	 ...
	 */
	public GuiPropertyStringList(String name, List<String> values, GuiNotificationTarget target) {
	 ...
	 * @param values the initial string values of this property
	 * @param target the object to be notified as soon the state of this property changes
	 * @param height the preferred height for the list property (default value is 50)
	 */
	public GuiPropertyStringList(String name, String description, List<String> values,
