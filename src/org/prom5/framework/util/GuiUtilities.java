...
public class GuiUtilities {
	...
	/**
	 * Puts the given component in a rounded panel, with the given title and description.
	 * Scrollbars will appear for the component if needed.
	 * @param scrollable the component to be made scrollable
	 * @param title the title 
	 * @param description the description
	 * @param bgColor the background color of the rounded panel
	 * @return the panel containing the given component in a scrollpane and with title and description
	 */
	public static JComponent configureAnyScrollable(JComponent scrollable, String title, String description, 
			Color bgColor) {
		...
		listScrollPane.getVerticalScrollBar().setUI(new SlickerScrollBarUI(listScrollPane.getVerticalScrollBar(), bgColor, new Color(70, 70, 70), new Color(120, 120, 120), 2, 11));
		listScrollPane.getHorizontalScrollBar().setUI(new SlickerScrollBarUI(listScrollPane.getHorizontalScrollBar(), bgColor, new Color(70, 70, 70), new Color(120, 120, 120), 2, 11));
	...
	/**
	 * Creates a slicker scrollbar around the given component and respects the given background color.
	 * @param scrollable the item to be made scrollable
	 * @param bgColor the background color to be used for scrollbar
	 * @return the scrollable component
	 */
	public static JComponent getSimpleScrollable(JComponent scrollable, Color bgColor) {
		JScrollPane listScrollPane = new JScrollPane(scrollable);
		listScrollPane.setOpaque(false);
		listScrollPane.getViewport().setOpaque(false);
		listScrollPane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
	 ...
	 * @param component the component to be aligned
	 ...
	 * @param component the component to be placed in the center.
	 * @return the panel containing the aligned component
	 */
	 ...
	 * @param component the component to be placed in the middle.
	 * @return the panel containing the aligned component
	 */
