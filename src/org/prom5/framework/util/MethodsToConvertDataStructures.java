...
/**
 * <p>Title: </p>
 * <p>Description: This class has various methods to convert between classes or data types in Java.</p>
...
public class MethodsToConvertDataStructures {
	 ...
	 * @param iterator to be converted
	 * @return TreeSet. If Iterator equals null, the returned TreeSet is also null.
	 */
	 ...
	 * @param i iterator to convert.
	 * @return Hashtable where: <br/>
	 * - Keys = elements in i <br/>
	 * - Values = an Integer equals -1. <br/>
	 * @throws java.lang.NullPointerException if i equals null.
	 */
	 ...
	 * @param hashSet HashSet that contains TreeSets.
	...
	public static TreeSet getSetUnion(HashSet hashSet) {
		...
		if (hashSet != null) {
			...
			while (iterator.hasNext()) {
				Iterator iteratorSubSets = ((TreeSet) iterator.next()).iterator();
