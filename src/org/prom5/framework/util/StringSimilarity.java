...
public class StringSimilarity {
	...
	/**
	 * Returns a number to express the difference between two strings. The smaller
	 * the number, the more equal the strings are. Equal strings return 0.
	 * The result is the number of operations required to go from one string
	 * to the other by inserting, removing or replacing characters. Therefore, for the
	 * result r holds that 0 <= r <= s.length()+t.length()
	 *
	 * @param s String
	 * @param t String
	 * @return int
