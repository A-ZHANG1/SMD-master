...
package org.prom5.importing.bpel;
...
import org.prom5.framework.models.bpel.BPELConstants;
...
/**
 * <p>Title: BPELImport</p>
 *
 * <p>Description: Import a BPEL 1.1 file</p>
 *
...
public class BPELImport implements LogReaderConnectionImportPlugin {
	...
	public MiningResult importFile(InputStream input) throws IOException {
		try {
			...
			Message.add("<BPELImport nofInvokes=\"" + process.countActivities(BPELConstants.stringInvoke) +
					"\" nofReceives=\"" + process.countActivities(BPELConstants.stringReceive) +
					"\" nofReplies=\"" + process.countActivities(BPELConstants.stringReply) +
					"\"/>", Message.TEST);
