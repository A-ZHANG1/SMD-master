...
package org.prom5.importing.fsm;
...
public class FSMImport implements LogReaderConnectionImportPlugin {
	...
	public void parse(TransitionSystem ts, InputStream input) throws IOException {
		...
		while ((s = readNextLine(input)) != null) {
			...
			TransitionSystemEdge edge = new TransitionSystemEdge(label, fromVertex, toVertex);
			ts.addEdge(edge);
		}
