...
public class TpnParser implements TpnParserConstants {
	private void addPlace(PetriNet net, String placeName, int init) throws ParseException {
		...
		for (int i = 0; i < init; i++) {
			p.addToken(new org.prom5.framework.models.petrinet.Token());
		}
	}

	private void addTrans(PetriNet net, String name, String label, ArrayList in,
			ArrayList out) throws ParseException {
		// create transition
		Transition t = net.addTransition(new Transition((label.equals("") ? name : label), net));
	...
	final public void Place(PetriNet net) throws ParseException {
		...
		jj_consume_token(8);
		addPlace(net, stripQuotes(placeName.toString()),
				init == null ? 0 : Integer.parseInt(init.toString()));
	}
	...
	final public void Trans(PetriNet net) throws ParseException {
		...
		jj_consume_token(8);
		addTrans(net, stripQuotes(transName.toString()),
				stripQuotes(label == null ? "" : label.toString()), in, out);
	}
