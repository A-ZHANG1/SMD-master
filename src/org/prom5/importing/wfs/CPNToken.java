...
/**
 * Helper class in generating CPN token values in 
...
public class CPNToken {
	 ...
	 * @return a string representing the token value in the form of (caseID,startTime,resource)
	 */
	public String convertToCPNTokenFormat() { //Format (1,"0","Moe")
		String result = "";
		if (resource == "") { //it could be for enabled conditions or tasks without resources
