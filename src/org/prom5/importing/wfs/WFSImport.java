package org.prom5.importing.wfs;
...
/**
 * ProM import plug-in that converts a given WFState file 
 * to an SML file that can be loaded into a previously generated
 * simulation model. 
 * <br>
...
public class WFSImport implements ImportPlugin {
	...
	/* (non-Javadoc)
	 * @see org.processmining.importing.ImportPlugin#importFile(java.io.InputStream)
	 */
	public MiningResult importFile(InputStream input) throws IOException {
        ...
        String specID = xmlresponse.replaceFirst(".*<Process\\s+id\\s*=\\s*[\"'](.+?)[\"'].*", "$1");
	...
	/*
	 * Class generating a visual component containing a user message
	 * stating the import result. 
	 */
