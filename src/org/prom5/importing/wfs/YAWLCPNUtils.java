...
public class YAWLCPNUtils {
	 ...
	 * @param name String the original name in YAWL
	 ...
	 * @return String a name which is prefix with an appropriate label from ProM/CPN
	 */
	public static String getYawlCpnValidConditionName(String name,
		...
		if (name != null && name.equals("") == false) {
			...
			if (elementType.equalsIgnoreCase("ENABLE")) {
				...
				/* Input and Output conditions are special cases.
				 * The token should be put into the Overview CPN page instead.*/
