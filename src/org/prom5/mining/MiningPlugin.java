 ...
 * See the documentation on how to implement mining algorithms for more information.
 *
...
public interface MiningPlugin extends Plugin {
	 ...
	 * or <code>null</code> if it has no options panel.
	 ...
	 *
	 * @param summary all known information about the log that's going to be mined with this algorithm
	 * @return the option panel associated with this mining algorithm
	 * or <code>null</code> if it has no options panel
	 */
	 ...
	 * The <code>log</code> parameter provides methods to
	 * extract the process instances and audit trail entries (cases) from the log file.
	 * This method is allowed to return <code>null</code> in case there are no results.
	 *
	 * @param log process instances and audit trail entries
	 * @return the result of the mining algorithm, in a <code>MininResult</code> object
	 */
