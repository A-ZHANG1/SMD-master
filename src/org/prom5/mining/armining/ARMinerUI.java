 ...
 * <p>Title: ARMinerUI</p>
 *
 * <p>Description:Builds the Input GUI </p>
 *
...
public class ARMinerUI extends JPanel {
	...
	//return the combo box's current selection made by the user (type of algorithm)
	public AssociationAnalyzer getAnalyzerObject() {
		AssociationAnalyzer currentlySelectedAlgorithm = (AssociationAnalyzer)
				algorithmToUseComboBox.getSelectedItem();
...
//----------------------------------------------------------------------------------------------------------------
		...
		selectAlgorithmPanel.setLayout(new BoxLayout(selectAlgorithmPanel, BoxLayout.LINE_AXIS));
		JLabel algorithmToUseLabel = new JLabel("Use algorithm:");
		//add items to combo box- Apriori algorithm and predictive apriori algorithm
		algorithmToUseComboBox.addItem(analyzer);
		algorithmToUseComboBox.addItem(p_Analyzer);
		algorithmToUseComboBox.setMaximumSize(algorithmToUseComboBox.getPreferredSize());
...
//1st--->
		...
		aprioriDescriptionPanel.setLayout(new BoxLayout(aprioriDescriptionPanel, BoxLayout.X_AXIS));
...
//2nd--->
		...
		aprioriParametersPanel.setLayout(new BoxLayout(aprioriParametersPanel, BoxLayout.Y_AXIS));
		// Inner Panel-aprioriParametersLabelPanel
		JPanel aprioriParametersLabelPanel = new JPanel();
		aprioriParametersLabelPanel.setLayout(new BoxLayout(aprioriParametersLabelPanel,
				BoxLayout.X_AXIS));
		JLabel aprioriParametersLabel = new JLabel("The following parameters are available:");
...
//----add both 1st and 2nd (apriori panels) to the main content panel i.e. myContentPanel
		...
		myContentPanel.setBorder(BorderFactory.createEmptyBorder(30, 30, 30, 30));

//---------------------------------------------------------------------------------------------------------------------------
//For Predictive Apriori algorithm----
//1st--->
		//Panel for describing the Predictive Apriori algorithm-
		p_AprioriDescriptionPanel.setLayout(new BoxLayout(p_AprioriDescriptionPanel,
				BoxLayout.X_AXIS));
		// Inner Panel-descriptionPanel
		JPanel p_DescriptionPanel = new JPanel();
		p_DescriptionPanel.setLayout(new BoxLayout(p_DescriptionPanel, BoxLayout.X_AXIS));
...
//2nd--->
		p_AprioriParametersPanel.setLayout(new BoxLayout(p_AprioriParametersPanel, BoxLayout.Y_AXIS));
		// Inner Panel-p_ParametersPanel
		JPanel p_ParametersPanel = new JPanel();
		p_ParametersPanel.setLayout(new BoxLayout(p_ParametersPanel, BoxLayout.LINE_AXIS));
