...
/**
 * <p>Title: MyPredApriori</p>
 *
 * <p>Description: MyPredApriori extends PredictiveApriori()</p>
 *
...
//			   }
//		   }
//		   myRulesArray2.add(numberRules2 + tempString2 + " " + " (Accuracy: " + accValue2 + ")");
//	   }
...
//removing the unnecessary rules
		...
		for (int k = 0; k < myLHSList.size(); k++) {
			...
			if (tempString.contains(",noname")) {
				...
				myRulesArray.add(numberRules + newTempString + "   " + "(accuracy: " + accValue +
						")");
			} else {
				if (tempString.contains(", noname")) {
					newTempString = tempString.replace(", noname", " ");
					myRulesArray.add(numberRules + newTempString + "   " + "(accuracy: " +
							accValue +
							")");
				} else {
					if (tempString.contains("noname,")) {
						...
						if (tempString.contains("noname, ")) {
							...
							myRulesArray.add(numberRules + tempString + "   " + "(accuracy: " +
									accValue + ")");
						}
					}
				}
