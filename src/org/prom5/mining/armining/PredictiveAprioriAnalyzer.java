...
/**
 * <p>Title: PredictiveAprioriAnalyzer</p>
 *
 * <p>Description:This class tells the plug-in that the type of Association rule algorithm to be used is the Predictive Apriori algorithm. </p>
 * It also prepares the GUI objects accordingly (specific to the chosen algorithm). </p>
 *
...
public class PredictiveAprioriAnalyzer extends AssociationAnalyzer {
	...
	public boolean checkWithEC(ProcessInstance pi, int ruleIndex) {
		return ((MyPredApriori) myAssociator).checkRuleWithEventCare(pi, ruleIndex);
	}
