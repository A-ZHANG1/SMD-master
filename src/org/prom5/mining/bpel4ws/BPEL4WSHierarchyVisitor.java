...
package org.prom5.mining.bpel4ws;

import java.util.Stack;

import org.prom5.framework.models.bpel4ws.type.BPEL4WS;
import org.prom5.framework.models.bpel4ws.type.BPEL4WSProcess;
import org.prom5.framework.models.bpel4ws.type.BPEL4WSVisitor;
import org.prom5.framework.models.bpel4ws.type.activity.Activity;
...
public class BPEL4WSHierarchyVisitor extends BPEL4WSVisitor {
	...
	public static synchronized void Build(BPEL4WS model, BPEL4WSHierarchy hierarchy) {
	...
	public void visitWhile(While whileActivity) {
		hierarchy.addHierarchyObject(whileActivity, stack.peek(), whileActivity.name);
