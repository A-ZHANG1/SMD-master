...
import org.prom5.framework.models.bpel4ws.type.activity.Composed;
 ...
 * @version 1.0
 */
public class BPEL4WSResult implements MiningResult, Provider, LogReaderConnection {
	...
	public ProvidedObject[] getProvidedObjects() {
		return new ProvidedObject[] {
				new ProvidedObject("BPEL2WS model", new Object[] {model})
		};
	}
