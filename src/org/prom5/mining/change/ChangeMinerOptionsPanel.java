...
public class ChangeMinerOptionsPanel extends JPanel {
	...
	public ChangeMinerOptionsPanel() {
		...
		dependencyPanel.setLayout(new BoxLayout(dependencyPanel, BoxLayout.X_AXIS));
	...
	public boolean isConflictingCausalityAllowed() {
		return (causalityBox.getSelectedItem().equals(ChangeMinerOptionsPanel.CAUSALITY_CONFLICTING));
	}
}
