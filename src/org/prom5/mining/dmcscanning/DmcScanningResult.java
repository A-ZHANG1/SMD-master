...
import org.prom5.mining.dmcscanning.ui.DmcResultView;

/**
 * Custom class used for storing and visualizing the results of
 * DMC scanning (incl. derived ADMC and MDMC sets).
 * 
 * @author Christian W. Guenther (christian at deckfour dot org)
 */
public class DmcScanningResult implements MiningResult {
	...
	/**
	 * constructor
	 * @param aReader the LogReader instance used for mining
	 * @param dmc the set of initially scanned DMCs
	 * @param admc the set of aggregated DMCs, ADMC
	 * @param mdmc the set of minimal DMCs, MDMC
	 */
	public DmcScanningResult(LogReader aReader, DmcSet dmc, AdmcSet admc, MdmcSet mdmc) {
		reader = aReader;
		dmcSet = dmc;
		admcSet = admc;
		mdmcSet = mdmc;
