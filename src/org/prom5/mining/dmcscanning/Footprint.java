...
/**
 * This class wraps a footprint, i.e. an unordered set of
 * data objects that are typically modified in a clustered
 * way.
 * 
 * @author Christian W. Guenther (christian at deckfour dot org)
 */
public class Footprint {
	...
	/**
	 * add a new data object to this footprint,
	 * keeps the set minimal (no double entries)
	 * @param data
	 */
	...
	/**
	 * Computes the relative overlap of this footprint with another one,
	 * i.e. if the intersection of this and another footprint contains
	 * exactly half of each footprint's elements, the overlap will be 0.5.
	 * Identical footprints will yield an overlap of 1.0, those whose 
	 * intersection is empty will yield an overlap of 0.0.
	 * @param other further footprint
	...
	/**
	 * Checks whether this footprint is a subset of another footprint,
	 * i.e. all its data objects are also contained within the other footprint
	 * @param other
	 * @return
	 */
