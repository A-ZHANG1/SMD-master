...
public class SplitOnBreakDmcScanner {
	...
	public static DmcSet scanInitialDmcs(LogReader reader, Progress progress, 
			long breakThreshold, long maxEventsThreshold, ObjectEquivalence equivalence) {
		...
		while(reader.hasNext()) {
			...
			while(ates.hasNext()) {
				...
				if(event.getTimestamp().getTime() > lastTimestamp + breakThreshold) {
					...
					// no break; adjust last timestamp and add to current cluster
