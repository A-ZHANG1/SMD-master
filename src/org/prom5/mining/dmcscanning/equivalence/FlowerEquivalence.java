...
/**
 * Equivalence relation implementation for data logs extracted
 * from the Case Handling system 'FLOWer' (Pallas Athena)
 * 
 * @author Christian W. Guenther (christian at deckfour dot org)
 */
public class FlowerEquivalence implements ObjectEquivalence {
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.dmcscanning.equivalence.ObjectEquivalence#matches(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.processmining.mining.dmcscanning.equivalence.ObjectEquivalence#getCanonicalName(java.lang.String)
	 */
	public String getCanonicalName(String aWfmElement) {
		String canonical = aWfmElement.replaceAll("_plan(\\d+)_id(\\d+)\\z", "");
		return canonical.trim();
	}

	/* (non-Javadoc)
	 * @see org.processmining.mining.dmcscanning.equivalence.ObjectEquivalence#equivalent(java.lang.String, java.lang.String)
	 */
	public boolean equivalent(String wfmElementOne, String wfmElementTwo) {
		return getCanonicalName(wfmElementOne).equals(getCanonicalName(wfmElementTwo));
	}
