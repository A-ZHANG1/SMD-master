...
public class AbstractEvent implements LogItem {
	 ...
	 * @param aPosition logical log position (first=0, ascending)
	 */
	...
	/**
	 * Convenience method for AuditTrailEntry compatibility;
	 * mapped to start event.
	 * @return
	 */
	...
	public String toString() {
		return "AbstractEvent '" + startEvent.getElement() + "' (" + startEvent.getTimestamp() + ")";
	}
}
