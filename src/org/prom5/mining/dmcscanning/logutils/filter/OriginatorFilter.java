...
public class OriginatorFilter implements EventFilter {
	...
	/**
	 * constructor
	 * @param anOriginator the pattern to match
	 * @param isRegex whether the pattern is to be fully matched (false) or in fact a regular expression (true)
	 */
	protected OriginatorFilter(String anOriginator, boolean isRegex, boolean isNegated) {
