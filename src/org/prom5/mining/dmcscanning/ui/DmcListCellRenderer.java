...
/**
 * Custom component to implement the in-list representation
 * rendering of xDMC objects (i.e., ADMCs or DMCs, etc.).
 * 
 * @author Christian W. Guenther (christian at deckfour dot org)
 */
public class DmcListCellRenderer extends DefaultListCellRenderer {
	...
	public Component getListCellRendererComponent(
	    ...
	    if(value instanceof Dmc) {
	    	...
	    	Admc obj = (Admc)value;
	    	setText("Aggregated Cluster " + obj.getIdNumber() + " (" + obj.size() + ")");
	    } else {
	    	setText("ERROR!");
	    }
