...
/**
 *  Gathers the input parameters used by the DWS mining plugin.
 *  
 *  @author Gianluigi Greco, Antonella Guzzo and Luigi Pontieri
 *  @version 1.0
 */

public class MiningInputPanel extends JPanel {
	...
	private JLabel testoLabel6;

	
	public MiningInputPanel(){
	...
	private void jbInit() throws Exception{
		...
		testoLabel6.setText("(Max.) Number of splits");
        ...
        mField.setText("2");
        mField.setPreferredSize(new Dimension(40, 21));
        mField.setMinimumSize(new Dimension(6, 21));
     
        firstPanel.setLayout(new GridBagLayout());
        
        firstPanel.add(testoLabel1,new GridBagConstraints(0, x+y, 1, 1, 0.0D, 0.0D, 17, 0, new Insets(0, 33, 0, 0), 0, 0));
        firstPanel.add(sigma,new GridBagConstraints(1, x+y++ , 1, 1, 0.0D, 0.0D, 17, 0, new Insets(0, 33, 0, 0), 0, 0));
        firstPanel.add(testoLabel2,new GridBagConstraints(0, x+y, 1, 1, 0.0D, 0.0D, 17, 0, new Insets(0, 33, 0, 0), 0, 0));
        firstPanel.add(gamma,new GridBagConstraints(1, x+y++, 1, 1, 0.0D, 0.0D, 17, 0, new Insets(0, 33, 0, 0), 0, 0));
        firstPanel.add(testoLabel3,new GridBagConstraints(0, x+y, 1, 1, 0.0D, 0.0D, 17, 0, new Insets(0, 33, 0, 0), 0, 0));
        firstPanel.add(kField,new GridBagConstraints(1, x+y++, 1, 1, 0.0D, 0.0D, 17, 0, new Insets(0, 33, 0, 0), 0, 0));
        firstPanel.add(testoLabel4,new GridBagConstraints(0, x+y, 1, 1, 0.0D, 0.0D, 17, 0, new Insets(0, 33, 0, 0), 0, 0));
        firstPanel.add(lField,new GridBagConstraints(1, x+y++, 1, 1, 0.0D, 0.0D, 17, 0, new Insets(0, 33, 0, 0), 0, 0));
        firstPanel.add(testoLabel6,new GridBagConstraints(0, x+y, 1, 1, 0.0D, 0.0D, 17, 0, new Insets(0, 33, 0, 0), 0, 0));
        firstPanel.add(mField,new GridBagConstraints(1, x+y++, 1, 1, 0.0D, 0.0D, 17, 0, new Insets(0, 33, 0, 0), 0, 0));
        firstPanel.add(testoLabel5,new GridBagConstraints(0, x+y, 1, 1, 0.0D, 0.0D, 17, 0, new Insets(0, 33, 0, 0), 0, 0));
        firstPanel.add(maxFeatField,new GridBagConstraints(1, x+y++, 1, 1, 0.0D, 0.0D, 17, 0, new Insets(0, 33, 0, 0), 0, 0));
