...
public class EPCGrappaAdapter extends GrappaAdapter {
	...
	private JMenuItem orgMenu = new JCheckBoxMenuItem("Show organizational entities");
	private JMenuItem dataMenu = new JCheckBoxMenuItem("Show data objects");
	private JMenuItem infSysMenu = new JCheckBoxMenuItem("Show information systems");
		...
		if ((modifiers & i) == i &&
			...
			if (t.getSubstitutedEPC() != null) {
				...
				JOptionPane.showMessageDialog(MainUI.getInstance(),
						"Substitution function does not point to underlying EPC", "No EPC found",
