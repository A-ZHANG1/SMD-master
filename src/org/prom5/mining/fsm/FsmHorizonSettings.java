...
/**
 * <p>Title: FsmHorizonSettings</p>
 *
 * <p>Description: Settings for a single horizon</p>
 *
...
public class FsmHorizonSettings {
     ...
     * @param newHorizon int new value.
     ...
     * @param newAbstraction int new value.
     * @return int old value.
     */
     ...
     * @param newFilteredHorizon int new value.
     * @return int old value.
     */
