...
import org.prom5.converting.fsm.FsmModificationConvertor;
import org.prom5.converting.fsm.FsmModificationSettings;
 ...
 * <p>Title: FSM Miner</p>
 *
 * <p>Description: Mining an FSM from a log file</p>
 *
...
public class FsmMiner {
    ...
    @Miner(
            name = "FSM miner",
            help =
            "http://www.win.tue.nl/~hverbeek/doku.php?id=projects:prom:plug-ins:mining:fsm",
            settings = FsmGui.class
            )
    /**
    ...
    public static JComponent mine(LogReader log, FsmSettings settings) {
        ...
        try {
            ...
            for (ProcessInstance pi : log.getInstances()) {
                ...
                for (int i = 0; i < atel.size(); i++) {
                    ...
                    FSMState fromState = new FSMState(fsm, fromPayload.toString(),
                            fromPayload);
                    ...
                    /**
                     * If the model element is filtered out, the empty string is used as the model element.
                     */
                    String label;
                    ...
                    /**
                     * Note: if the transition already exists, a new one will not be added.
                     */
        ...
        FsmModificationConvertor modificationConvertor = new
                FsmModificationConvertor();
