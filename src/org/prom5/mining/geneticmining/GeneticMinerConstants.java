...
public class GeneticMinerConstants {
	...
	public static final String[] logLine = {FN, BF, AF, SD, PC, PS, GN, FT, MR, S, ST, UGO, MTp,
										   MRt, CTp,
										   CRt, IPT, POW, ELI, ET, FP};

	/**
	 * Returns the index of a certain constant in the logLine array.
	 * @param constant String constant value
	 * @return int the index of this constant. If the vector does not contain the constant, -1 is returned.
	 */
