...
public class GeneticMinerSettings {
	...
	public GeneticMinerSettings(int populationSize, int maxNumGenerations, double mutationRate,
			int crossoverType, double crossoverRate, long seed,
			int fitnessType, int selectionMethodType, double elitismRate,
			int mutationType, long power, int initialPopulationType, boolean useGeneticOperators,
