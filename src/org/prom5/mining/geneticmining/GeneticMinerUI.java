...
public class GeneticMinerUI extends JPanel {
	...
	private ToolTipComboBox initialPopulationType = new ToolTipComboBox(InitialPopulationFactory.
...
//	private JCheckBox useContinuousSemantics = new JCheckBox();
	...
	private ToolTipComboBox fitnessType = new ToolTipComboBox(FitnessFactory.getAllFitnessTypes());
	...
	private ToolTipComboBox crossoverType = new ToolTipComboBox(CrossoverFactory.
											getAllCrossoverTypes());
	private JLabel mutationTypeLabel = new JLabel();
	private ToolTipComboBox mutationType = new ToolTipComboBox(MutationFactory.getAllMutationTypes());
	...
	private void jbInit() throws Exception {
		...
		fitnessType.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (FitnessFactory.getAdvancedFitnessParametersNames(fitnessType.getSelectedIndex()).
						length > 0) {
	...
	private void updateTheAdvanceFitnessFeaturesComponent() {
		...
		ParameterValue[] parameterNames = FitnessFactory.getAdvancedFitnessParametersNames(
