...
public class DescriptiveStatistics {
	 ...
	 * @param ms multiset
	 * @return the most frequent element. If all of them occurr as often, one of them is returned.
	 * If the multiset is empty, the MIN_VALUE for an Integer is returned.
	 */
