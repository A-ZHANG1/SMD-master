...
public class PrecisionRecallFactory {
	...
	public static String[] getAllPrecisionRecallTypes() {
		return new String[] {"Behavioral Precision/Recall", "Structural Precision/Recall", "Duplicates Precision/Recall"};
	}

	public static PrecisionRecall getPrecisionRecall(int indexFitnessType, LogReader log,
