...
/**
 * <p>This class retrieves all the files that have a certain termination in
 * a directory and, if required, all of its subdirectories. </p>
 *
...
public class RetrieveFiles {
	...
	public RetrieveFiles(String rootDirFiles, String fileTermination, boolean includeSubdirectories) throws FileNotFoundException {
	...
	private void retrieveAllFileInDirectory(File rootDirFiles, String fileTermination, boolean includeSubdirectories) {
		if (includeSubdirectories){
			files = MethodsForFiles.getAllSubFiles(rootDirFiles, fileTermination);
		}else{
	 ...
	 * @throws FileNotFoundException if the provided "directory" does not exists or is not a directory.
	 */
	public static void checkIfDirectoryExists(File directory) throws FileNotFoundException {
	...
	public static void main(String args[]) throws FileNotFoundException {
		...
		RetrieveFiles rf = new RetrieveFiles(
						   "C:\\AKThesisExperiments\\DGAnoiseFree\\setup\\desiredNets", ".hn", true);
