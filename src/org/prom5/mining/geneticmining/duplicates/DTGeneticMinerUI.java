...
import org.prom5.framework.util.GUIPropertyDouble;
...
import org.prom5.mining.geneticmining.util.ParameterValue;
...
public class DTGeneticMinerUI extends JPanel {
	...
	private ToolTipComboBox initialPopulationType = new ToolTipComboBox(DTInitialPopulationFactory.
...
//	private JCheckBox useContinuousSemantics = new JCheckBox();
	...
	private ToolTipComboBox fitnessType = new ToolTipComboBox(DTFitnessFactory.getAllFitnessTypes());
	...
	private ToolTipComboBox selectionMethodType = new ToolTipComboBox(DTSelectionMethodFactory.
												  getAllSelectionMethodsTypes());
	private JLabel crossoverTypeLabel = new JLabel();
	private ToolTipComboBox crossoverType = new ToolTipComboBox(DTCrossoverFactory.
											getAllCrossoverTypes());
	private JLabel mutationTypeLabel = new JLabel();
	private ToolTipComboBox mutationType = new ToolTipComboBox(DTMutationFactory.
										   getAllMutationTypes());
	...
	public GeneticMinerSettings getSettings() {
		return new GeneticMinerSettings(getPopulationSize(), getMaxNumGenerations(),
				getMutationRate(), getCrossoverType(), getCrossoverRate(),
				getSeed(), getFitnessType(), getSelectionMethodType(),
				getElitismRate(), getMutationType(), getPower(), getInitialPopulationType(),
	...
	private double[] getFitnessParametersValues() {
		...
		for (int i = 0; i < fitnessParameterValues.length; i++) {
			fitnessParameterValues[i] = advancedFitnessFeaturesProperties[i].getValue();
		}
	...
	private int getPopulationSize() {
		try {
			...
			popSize.setText(Integer.toString(DTGeneticMinerConstants.POPULATION_SIZE));
		}
	...
	private int getMaxNumGenerations() {
		try {
			...
			maxGeneration.setText(Integer.toString(DTGeneticMinerConstants.MAX_GENERATION));
		}
...
//		selectionMethodTypeLabel.setToolTipText("Sets the kind of tournament to be used while selecting parents to undergo crossover and mutation.");
		...
		selectionMethodType.setSelectedIndex(DTGeneticMinerConstants.SELECTION_TYPE);
		crossoverLabel.setText("Crossover rate");
		crossoverRate.setPreferredSize(new Dimension(50, 21));
		crossoverRate.setText(Double.toString(DTGeneticMinerConstants.CROSSOVER_RATE));
		...
		mutationRate.setText(Double.toString(DTGeneticMinerConstants.MUTATION_RATE));
		mutationType.setSelectedIndex(DTGeneticMinerConstants.MUTATION_TYPE);

		usingGenOpPanel = new JPanel(new GridBagLayout());

		usingGenOpPanel.add(selectionMethodTypeLabel, new GridBagConstraints(0, x + y, 1, 1, 0.0,
				0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 33, 0, 0), 0, 0));
		usingGenOpPanel.add(selectionMethodType, new GridBagConstraints(1, x + y, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));

		usingGenOpPanel.add(crossoverTypeLabel, new GridBagConstraints(0, x + (++y), 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 33, 0, 0), 0, 0));
		usingGenOpPanel.add(crossoverType, new GridBagConstraints(1, x + y, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
		usingGenOpPanel.add(crossoverLabel, new GridBagConstraints(0, x + (++y), 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 33, 0, 0), 0, 0));
		usingGenOpPanel.add(crossoverRate, new GridBagConstraints(1, x + y, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));

		usingGenOpPanel.add(mutationTypeLabel, new GridBagConstraints(0, x + (++y), 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 33, 0, 0), 0, 0));

		usingGenOpPanel.add(mutationType, new GridBagConstraints(1, x + y, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));

		usingGenOpPanel.add(mutationLabel, new GridBagConstraints(0, x + (++y), 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 33, 0, 0), 0, 0));
		usingGenOpPanel.add(mutationRate, new GridBagConstraints(1, x + y, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
		...
		showingAdvancedFitnessFeatures.setVisible(showAdvancedFitnessFeatures.isSelected());

		notShowingAdvancedFitnessFeatures = new JPanel(new GridBagLayout());
		notShowingAdvancedFitnessFeatures.setVisible(!showAdvancedFitnessFeatures.isSelected());
		...
		showAdvancedFitnessFeatures.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				showingAdvancedFitnessFeatures.setVisible(showAdvancedFitnessFeatures.isSelected());
				notShowingAdvancedFitnessFeatures.setVisible(!showAdvancedFitnessFeatures.
						isSelected());
		...
		initialPopulationType.setSelectedIndex(DTGeneticMinerConstants.INITIAL_POPULATION_TYPE);
		...
		fitnessType.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (DTFitnessFactory.getAdvancedFitnessParametersNames(fitnessType.getSelectedIndex()).
						length > 0) {
		...
		elitismRate.setText(Double.toString(DTGeneticMinerConstants.ELITISM_RATE));
		...
		otherOptionsPanel.add(popSize, new GridBagConstraints(1, x + y, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));

		//initial population type
		otherOptionsPanel.add(initialPopulationTypeLabel, new GridBagConstraints(0, x + (++y), 1, 1,
				0.0,
				0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 5, 0, 0), 0, 0));
		otherOptionsPanel.add(initialPopulationType, new GridBagConstraints(1, x + y, 1, 1, 0.0,
				0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));

		//max runs
		otherOptionsPanel.add(maxGenerationLabel, new GridBagConstraints(0, x + (++y), 1, 1, 0.0,
				0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 5, 0, 0), 0, 0));
		otherOptionsPanel.add(maxGeneration, new GridBagConstraints(1, x + y, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
		//seed
		otherOptionsPanel.add(seedLabel, new GridBagConstraints(0, x + (++y), 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 5, 0, 0), 0, 0));
		otherOptionsPanel.add(seed, new GridBagConstraints(1, x + y, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));

		//power
		otherOptionsPanel.add(powerLabel, new GridBagConstraints(0, x + (++y), 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 5, 0, 0), 0, 0));
		otherOptionsPanel.add(power, new GridBagConstraints(1, x + y, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));

		//elitism rate
		otherOptionsPanel.add(elitismLabel, new GridBagConstraints(0, x + (++y), 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 5, 0, 0), 0, 0));
		otherOptionsPanel.add(elitismRate, new GridBagConstraints(1, x + y, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
		...
		otherOptionsPanel.add(fitnessTypeLabel, new GridBagConstraints(0, x + (++y), 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 5, 0, 0), 0, 0));
		otherOptionsPanel.add(fitnessType, new GridBagConstraints(1, x + y, 1, 1, 0.0, 0.0,
				GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
	...
	private void updateTheAdvanceFitnessFeaturesComponent() {
		...
		ParameterValue[] parameterNames = DTFitnessFactory.getAdvancedFitnessParametersNames(
										  fitnessType.getSelectedIndex());
		...
		if (advancedFitnessFeaturesProperties == null ||
			...
			for (int i = 0; i < parameterNames.length; i++) {
				GUIPropertyDouble dp = new GUIPropertyDouble(parameterNames[i].getParameter(),
									parameterNames[i].getDescription(),
									parameterNames[i].getDefaultValue(),
									parameterNames[i].getMinValue(),
									parameterNames[i].getMaxValue(), parameterNames[i].getStepSize());
		...
		for (int i = 0; i < parameterNames.length; i++) {
			showingAdvancedFitnessFeatures.add(advancedFitnessFeaturesProperties[i].
					getPropertyPanel());
		}
