...
package org.prom5.mining.geneticmining.fitness;

import org.prom5.framework.log.LogReader;
import org.prom5.mining.geneticmining.fitness.duplicates.DTContinuousSemanticsFitness;
import org.prom5.mining.geneticmining.fitness.duplicates.DTExtraBehaviorPunishmentFitness;
import org.prom5.mining.geneticmining.fitness.duplicates.DTImprovedContinuousSemanticsFitness;
import org.prom5.mining.geneticmining.fitness.duplicates.DTProperCompletionFitness;
import org.prom5.mining.geneticmining.fitness.duplicates.DTStopSemanticsFitness;
import org.prom5.mining.geneticmining.util.ParameterValue;
import org.prom5.mining.heuristicsmining.fitness.ContinuousParsingMeasure;
...
public class FitnessFactory {
	...
	public static String[] getAllFitnessTypes() {
		return new String[] {"ProperCompletion", "StopSemantics", "ContinuousSemantics",
				"ImprovedContinuousSemantics", "ExtraBehaviorPunishment", 
				"ContinuousParsingMeasure"}; //, "ExtraBehaviorPunishmentSplittedLog"};
	}
	 ...
	 * When the fitness does not have a special parameter (e.g. kappa ou gama), the returned array is empty.
	 * @param fitnessIndex int index of the fitness type.
	 * @return String[] Array containing the names of the parameters. If the fitness does not require any special
	 * parameter, an empty array is returned.
	 */
	public static ParameterValue[] getAdvancedFitnessParametersNames(int fitnessIndex) {
		...
		switch (fitnessIndex) {
			...
			case EXTRA_BEHAVIOR_PUNISHMENT_INDEX:
				...
				parametersNames[0] = new ParameterValue("           Extra Behavior Punishment  ", 0.025/*default*/, 0.000/*min*/, 1.000/*max*/, 0.001/*step size*/,
	 ...
	 * @param indexFitnessType int Fitness type.
	 * @param log LogReader Log to be parsed by the created fitness type object.
	 * @param parameters double[] the parameters to be used by the specificied fitness type.
