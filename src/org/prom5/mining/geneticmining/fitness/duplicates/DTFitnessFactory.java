...
/**
 * <p>Title: Duplicate Tasks Fitness Measures </p>
 * <p>Description: This class provides objects of the interface <code>Fitness</code>.</p>
...
public class DTFitnessFactory {
	...
	public static String[] getAllFitnessTypes() {
		return new String[] {"ProperCompletion", "ImprovedContinuousSemantics", "ExtraBehavior"};
	}
		...
		switch (fitnessIndex) {
			...
			case 2:
				...
				parametersNames[1] = new ParameterValue(
									 "           Duplicates With Common In/Out Tasks Punishment  ", 0.025/*default*/, 0.000/*min*/, 1.000/*max*/, 0.001/*step size*/, "Sets the amount of punishment (gamma) for the amount of duplicates sharing input/output tasks that an individual has.");
				break;
		}
