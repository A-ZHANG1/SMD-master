...
public class EnhancedCrossover implements Crossover {

	private Random generator = null;

	public EnhancedCrossover(Random generator) {
	 ...
	 * (3) Remove from an existing subset in the individual the elements that are also in sp, and
