...
public class DTEnhancedMutation implements Mutation {

	private Random generator = null;
	private double mutationRate = 0;

	public DTEnhancedMutation(Random gen, double mutationRate) {
		this.generator = gen;
	 ...
	 * <ol>
	 * <li> Randomly choose a double number r. If r <i>less than</i> mutation rate, do one of the following
	 * operations for its INPUT/OUTPUT sets:
	 * <ol>
	 * <li> Add a task to one of the INPUT/OUTPUT subsets of this workflow model element.</li>
	 * <li> Remove a task from one of the INPUT/OUTPUT subsets of this workflow model element.</li>
	 * <li> Redistribute the tasks of the INPUT/OUTPUT sets of this workflow model element.</li>
	 * </li>
	...
	public HeuristicsNet doMutation(HeuristicsNet ind) {
		...
		for (int i = 0; i < mutatedPositions.size(); i++) {
			MethodsOverIndividuals.updateRelatedElements(ind, mutatedPositions.get(i), generator);
		}
