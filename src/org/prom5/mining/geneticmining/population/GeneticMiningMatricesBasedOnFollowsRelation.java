...
/**
 * <p>Title: </p>
 * <p>Description: No heuristics is used to build the individuals, but the follows
 * matrix is taken into consideration. This means that 0 entries in the follows
...
public class GeneticMiningMatricesBasedOnFollowsRelation implements GeneticMiningMatrices {
	...
	public GeneticMiningMatricesBasedOnFollowsRelation(Random gen, LogReader logReader) {
		//random generator
		generator = gen;
