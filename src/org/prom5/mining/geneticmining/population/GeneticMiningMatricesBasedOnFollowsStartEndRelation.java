...
/**
 * <p>Title: </p>
 * <p>Description: No heuristics is used to build the individuals, but the follows, start and
 * end matrices are taken into consideration. This means that 0 entries in the follows
 * matrix are kept 0 in the causal matrices of the individuals. Follows >=0 maybe be
 * set to causal = 1. A similar reasoning holds for the other matrices.</p>
...
public class GeneticMiningMatricesBasedOnFollowsStartEndRelation implements GeneticMiningMatrices {
	...
	public GeneticMiningMatricesBasedOnFollowsStartEndRelation(Random gen, LogReader logReader) {
		//random generator
		generator = gen;
...
//getting information about follows relation
	...
	public static void main(String[] args) {
		...
		try {
			log = LogReaderFactory.createInstance(filter, LogFile.getInstance(args[0]));
		} catch (Exception e) {
			log = null;
			e.printStackTrace();
		}
