...
/**
 * <p>Title: Duplicate Tasks Build Next Random Generation</p>
 * <p>Description: The individuals of the next generation are randomly created. It is
 * possible to keep some individuals of the previous generation by specify an
 * 'elitism rate' bigger than 0.</p>
...
public class DTBuildNextRandomGeneration implements BuildPopulation {
	...
	/*
	 * Randomly creates a new population, but a percentage of the best individuals (elite)
	...
	public HeuristicsNet[] build(HeuristicsNet[] oldPopulation) {
		...
		randomIndividualsPopulation = randomPopulationBuilder.build(new HeuristicsNet[oldPopulation.
									  length -
									  indexNewPopulation]);

		for (int indexRandomIndividuals = 0; indexNewPopulation < newPopulation.length;
										  indexNewPopulation++, indexRandomIndividuals++) {
