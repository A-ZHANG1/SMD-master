 ...
 * @version 1.0
 */
public class DTGeneticMiningMatricesNoDuplicateTasks implements DTGeneticMiningMatrices {
	...
	public DTGeneticMiningMatricesNoDuplicateTasks(Random gen, LogReader logReader,
			double power) {
		this.power = power;
		generator = gen;
