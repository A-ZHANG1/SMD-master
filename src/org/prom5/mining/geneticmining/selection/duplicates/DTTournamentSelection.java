...
package org.prom5.mining.geneticmining.selection.duplicates;
...
public class DTTournamentSelection implements SelectionMethod {
	...
	/**
	 * This methods randomly selects two individuals (in population) to play
	 * the tournament. The fittest of these two individuals is returned in threshold%
	 * of the cases.
	 * @param population Array of individuals to take part in the selection
