...
// 2 1private int positiveObservationsThreshold = POSITIVE_OBSERVATIONS_THRESHOLD;
...
public class HeuristicsMinerGUI extends JPanel implements FocusListener {
	...
	public HeuristicsMinerGUI(LogSummary summary, HeuristicsMinerParameters parameters) {
	...
	private void jbInit() throws Exception {
		...
		relativeToBestThresholdLabel.setText(parameters.RELATIVE_TO_BEST_THRESHOLD_L);
		relativeToBestThresholdText.setText(Double.toString(parameters.RELATIVE_TO_BEST_THRESHOLD));
		positiveObservationsThresholdLabel.setText(parameters.POSITIVE_OBSERVATIONS_THRESHOLD_L);

		positiveObservationsThresholdText.setText(Integer.toString(parameters.
		...
		dependencyThresholdText.setText(Double.toString(parameters.DEPENDENCY_THRESHOLD));
		...
		LDThresholdText.setText(Double.toString(parameters.LONG_DISTANCE_THRESHOLD));

		dependencyDivisorLabel.setText(parameters.DEPENDENCY_DIVISOR_L);
		dependencyDivisorText.setText(Integer.toString(parameters.DEPENDENCY_DIVISOR));
		...
		useAllConnectedHeuristics.setText("Use all-activities-connected-heuristic");
		useLongDistanceDependency.setSelected(false);
		useLongDistanceDependency.setText("Use long distance dependency heuristics");
	...
	public void setHeuristicsMinerParameters(HeuristicsMinerParameters parameters) {
		parameters.setRelativeToBestThreshold(readRelativeToBestThreshold());
		parameters.setPositiveObservationsThreshold(readPositiveObservationsThreshold());
		...
		parameters.setUseAllConnectedHeuristics(readUseAllConnectedHeuristics());
		parameters.setUseLongDistanceDependency(readUseLongDistanceDependency());
	}
	...
	private double readRelativeToBestThreshold() {
		try {
			...
			relativeToBestThresholdText.setText(Double.toString(parameters.
	...
	private int readPositiveObservationsThreshold() {
		try {
			...
			positiveObservationsThresholdText.setText(Double.toString(parameters.
					POSITIVE_OBSERVATIONS_THRESHOLD));
		}
	...
	private double readDependencyThreshold() {
		try {
			...
			dependencyThresholdText.setText(Double.toString(parameters.
...
// 6 private int dependencyDivisor = DEPENDENCY_DIVISOR;
	private int readDependencyDivisor() {
		try {
			...
			dependencyDivisorText.setText(Double.toString(parameters.
					DEPENDENCY_DIVISOR));
		}
