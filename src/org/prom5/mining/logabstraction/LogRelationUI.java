...
public class LogRelationUI extends JPanel {
	...
	private ImageIcon timeParallelIcon = new ImageIcon(System.getProperty("user.dir") +
										 System.getProperty("file.separator") + "images" +
										 System.getProperty("file.separator") +
										 "emit_parallel_choice.gif");
	...
	public String[][] getIntervals() {
		return timeParCheck.isSelected()
				? tableContents.getIntervals()
				: new String[0][0];
	}
	...
	private void jbInit() throws Exception {
		...
		usePOInfo.setText("Use partial order information to derive succession relation.");
		...
		// ------- FSM log filter ---------------------------------------
		fsmLogFilter.setText("Enforce causal dependencies between events of the same activity.");
		...
		timeParCheck.setText(
				"<html>Enforce parallelism relations between all event of activities,<br>" +
		...
		timeParSubPanel.add(iconLabel, new GridBagConstraints(0, 0, 1, 2, 0.0, 0.0
				, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		timeParSubPanel.add(addTimePar, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 10, 0, 0), 0, 0));
		timeParSubPanel.add(removeTimePar, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 10, 0, 0), 0, 0));
		timeParSubPanel.add(timeParScrollPane, new GridBagConstraints(0, 2, 2, 1, 0.0, 0.0
				, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(10, 0, 10, 0), 0,
				0));
		...
		showIntermediateResultsPanel.add(showIntermediateResults, BorderLayout.CENTER);

		// ------- main panel ------------------------------
		mainPanel.setLayout(gridBagLayout1);
		mainPanel.add(usePOInfoPanel, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0
		...
		mainPanel.add(fsmPanel, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(10, 10, 10, 10), 0,
				0));
		mainPanel.add(timeParPanel, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(10, 10, 10, 10), 0,
				0));
		mainPanel.add(showIntermediateResultsPanel, new GridBagConstraints(0, 3, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(10, 10, 10, 10), 0,
				0));
