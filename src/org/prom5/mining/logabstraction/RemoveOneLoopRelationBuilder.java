...
public class RemoveOneLoopRelationBuilder implements LogRelationBuilder {
	...
	public RemoveOneLoopRelationBuilder(LogRelations relations) {
		this.relations = new LogRelationsImpl(relations.getCausalFollowerMatrix(),
						 relations.getParallelMatrix(),
						 relations.getEndInfo(),
						 relations.getStartInfo(),
						 DoubleFactory1D.sparse.make(relations.getOneLengthLoopsInfo().size(), 0),
