...
import org.prom5.mining.organizationmining.ui.hierarchicalui.HierOrgModelGraph;
...
public class HierOrgMiningResult extends OrgMiningResult {// implements MiningResult, Provider, LogReaderConnection {
	...
	public HierOrgMiningResult(LogReader log, OrgModel orgModel, ClusteringAlgorithm algorithm) {
		super(log,orgModel);
	...
	public ProvidedObject[] getProvidedObjects() {
		ProvidedObject[] objects = {
						   ...
						   new ProvidedObject("Organizational Simulation Model No." + simulationModelCounter,
							   new Object[] {actSet}),
		...
		tabbedPane.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent evt) {
				...
				if (sel == 1) {
					...
					tabbedPane.setComponentAt(1,new HierOrgModelGraph(orgModel));
					updateActivitySet();
				}
			}
	    });
