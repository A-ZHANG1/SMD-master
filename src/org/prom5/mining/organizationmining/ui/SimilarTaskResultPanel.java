...
//	private JButton generateButton = new JButton("Generate Org Model ");
	...
	public SimilarTaskResultPanel(OrgModel orgmodel, SocialNetworkMatrix snmatrix, OrgMiningResult parent) {
		...
		menuPane.add(thresholdSlider, new GridBagConstraints(0, 2, 3, 1, 0.0, 0.0
				...
				0,
				0));
/*		menuPane.add(generateButton, new GridBagConstraints(0, 3, 4, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0),
				0,
				0));
