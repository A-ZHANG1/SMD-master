...
public class PartialOrderMiningUI extends JPanel{
	...
	private GUIPropertyBoolean parallel = new GUIPropertyBoolean("add partial order between events with the same timestamp?", false);
	...
	public void jbInit () {
		...
		dboxTimeUnits = new GUIPropertyListEnumeration("TimeUnit", valuesTimeUnit);
