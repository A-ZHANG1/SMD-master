 ...
 * The following time units can be represented by this class
 * TimeUnit.YEARS, TimeUnit.MONTHS, TimeUnit.WEEKS, TimeUnit.DAYS, TimeUnit.HOURS, TimeUnit.MINUTES,
 * TimeUnit.SECONDS, TimeUnit.MILLISECONDS.
 * Actually, an instance of the class TimeUnit can simply be create by TimeUnit. and followed by the constant
 * (e.g. DAYS)
 *
 * @author arozinat
 * @author rmans
...
public enum TimeUnit {
	...
	/**
	 * Returns the value by which a time value in seconds
	 * needs to be devided in order to yield the respective time unit.
