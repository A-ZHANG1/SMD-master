...
public class WorkflowPatternsMiner implements MiningPlugin{
	...
	public MiningResult mine(LogReader log) {
		...
		message("Starting workflow patterns mining...                                    ", 1, progress);*/
		...
		/*
		// walid on le fait pour le test externe
		frametest= new JFrame("Workflow Patterns Miner");
		frametest.setBounds(0,0,700,500);
		frametest.getContentPane().add(resultdebug.getVisualization(), BorderLayout.CENTER);
		frametest.show();
		relationsEditor = new LogRelationEditor(frametest,Deptab);
		*/
