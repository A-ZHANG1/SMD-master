package org.prom5.mining.pdmmining;
...
import org.prom5.framework.models.pdm.PDMPetriNet;
 ...
 * @version 1.0
 */
public class PDMPetriNetResult implements MiningResult, Provider, LogReaderConnection{
	 ...
	 * This function should return <code>null</code> if this result cannot be visualized.
	 *
	 * @return a component that contains the visualization of this mining result or
	 * <code>null</code> if this result cannot be visualized
	 */
	...
	/**
	 * Returns the <code>LogReader</code> object that was used to generate this mining result.
	 * This function may return null.
	 *
	 * @return the <code>LogReader</code> object that was used to generate this mining result or null.
	 */
	...
	public ProvidedObject[] getProvidedObjects() {
		return new ProvidedObject[] {
				new ProvidedObject("PDM petri net", new Object[] {net})
		};
	}

	/**
	 * Connects a <code>LogReader</code> to the object.
	 * The <code>eventsMapping</code> variable is a <code>HashMap</code> that has a key
	 * for every <code>LogEvent</code> returned by the <code>getLogEvents</code> method.
	 * Each key is a <code>LogEvent</code> and it is associated with
	 * a <code>Object[2]</code> object. This array contains two objects. The first object
	 * is again a <code>LogEvent</code> object, to which the original should be mapped. The
	 * second is a <code>String</code> object, representing the label that should be used for
	 * the identifier of the underlying graphical object.
	 * All <code>LogEvent</code>s in the underlying model will be translated using this mapping.
	 * The <code>eventsMapping</code> parameter may be <code>null</code>.
	 *
