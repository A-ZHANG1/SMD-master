...
/**
 * <p>Title: PDM Result</p>
 * <p>Description: MiningResult for PDM
...
public class PDMStateSpaceResult implements MiningResult, Provider, LogReaderConnection {
	...
	public ProvidedObject[] getProvidedObjects() {
		return new ProvidedObject[] {
				new ProvidedObject("PDM Statespace", new Object[] {statespace})
		};
	}
