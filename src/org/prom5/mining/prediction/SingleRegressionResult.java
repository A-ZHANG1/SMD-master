...
/**
 * @author Ronald Crooy
 * this class holds a single part of the result of the cross validation
 */
public class SingleRegressionResult{
	...
	public void setResult(double val,int type){
		switch(type){
		case 1: npMSE=val;break;
		case 2: npMAPE=val;break;
		case 3:	npMAE=val;break;
		case 4:	avgMSE=val;break;
		case 5: avgMAPE=val;break;
		case 6: avgMAE=val;break;
		}
	}

	
	/**
	 * type 1,2,3,4,5,6 are NP prediction, avg prediction, actual value, np errors, avg errors, bandwidth
	 * @param pred
	 * @param type
	 */
	public void setPrediction(double[] pred, int type){
		switch(type){
		case 1:nppredictions=Array2Vector(pred);break;
		case 2:avgpreditions=Array2Vector(pred);break;
		case 3:actualvalues=Array2Vector(pred);break;
		case 4:nperrors=Array2Vector(pred);break;
		case 5:avgerrors=Array2Vector(pred);break;
		case 6:bandwidth=Array2Vector(pred);break;
		}
	}
