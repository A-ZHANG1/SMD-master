...
package org.prom5.mining.protosmining;
...
import org.prom5.framework.models.protos.ProtosHierarchy;
...
/**
 * <p>Title: Protos mining result</p>
 *
 * <p>Description: Holds a Protos mining result</p>
 *
 ...
 * @version 1.0
 */
public class ProtosResult implements MiningResult, Provider, LogReaderConnection {
	// The loaded Protos model
	protected ProtosModel model;
	protected LogReader log;
	protected ProtosSubprocess subprocess = null; // Selected subprocess, if null then model is selected.
	...
	public ProtosResult(LogReader log, ProtosModel model) {
		...
		while (it.hasNext()) {
			...
			hierarchy.addHierarchyObject(subprocess, model, subprocess.getName());
		}
		this.log = log;
	}
	...
	public ProvidedObject[] getProvidedObjects() {
		return new ProvidedObject[] {
				new ProvidedObject(subprocess == null ? "Protos model" : "Protos subprocess", new Object[] {subprocess == null ? model : subprocess})
		};
	}
