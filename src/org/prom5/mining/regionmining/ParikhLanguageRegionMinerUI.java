...
public class ParikhLanguageRegionMinerUI extends JPanel {
    ...
    private String[] OPTIONS = new String[] {ParikhLanguageRegionMinerOptions.
                               NO_RES,
    ...
    public ParikhLanguageRegionMinerUI(LogSummary summary, JPanel rightPanel,
        ...
        thisOptionsPanel.add(netTypePanel,
        ...
        // ==========================================================================
        elementaryNetCheck.setText(
                "Return elementary net.");
        ...
        thisOptionsPanel.add(elementaryNetPanel,
                             new GridBagConstraints(0, i++, 2, 1, 0.0, 0.0
                , GridBagConstraints.WEST, GridBagConstraints.BOTH, INSETS, 0,
                0));
        // ==========================================================================
        ...
        // ==========================================================================
        useCausalDepCheck.setText(
                "Use causal dependencies to direct search.");
        ...
        thisOptionsPanel.add(useCausalDepPanel,
                             new GridBagConstraints(0, i++, 2, 1, 0.0, 0.0
                , GridBagConstraints.WEST, GridBagConstraints.BOTH, INSETS, 0,
                0));
        // ==========================================================================
        ...
        // ==========================================================================
        disAllowNonCausalCheck.setText(
                "Do not allow places that express causal dependencies not observed.");
        ...
        thisOptionsPanel.add(disAllowNonCausalPanel,
                             new GridBagConstraints(0, i++, 2, 1, 0.0, 0.0
                , GridBagConstraints.WEST, GridBagConstraints.BOTH, INSETS, 0,
                0));
        // ==========================================================================
        ...
        thisOptionsPanel.add(searchInitMarkingPanel,
                             new GridBagConstraints(0, i++, 2, 1, 0.0, 0.0
                , GridBagConstraints.WEST, GridBagConstraints.BOTH, INSETS, 0,
                0));
        // ==========================================================================
        ...
        thisOptionsPanel.add(noSelfLoopsPanel,
                             new GridBagConstraints(0, i++, 2, 1, 0.0, 0.0
                , GridBagConstraints.WEST, GridBagConstraints.BOTH, INSETS, 0,
                0));
        // ==========================================================================
        ...
        thisOptionsPanel.add(emptyAfterCasePanel,
                             new GridBagConstraints(0, i++, 2, 1, 0.0, 0.0
                , GridBagConstraints.WEST, GridBagConstraints.BOTH, INSETS, 0,
                0));
        // ==========================================================================
        ...
        maxInEdgeSpin.setModel(new SpinnerNumberModel(options.getMaxInEdges(),
                1,
                summary.getLogEvents().size(), 1));
        maxOutEdgeSpin.setModel(new SpinnerNumberModel(options.getMaxOutEdges(),
                1,
                summary.getLogEvents().size(), 1));
        maxEdgeSpin.setModel(new SpinnerNumberModel(options.getMaxTotalEdges(),
                1,
                2 * summary.getLogEvents().size(), 1));
        ...
        thisOptionsPanel.add(maxEdgePanel,
        ...
        boundedNessSpin.setModel(new SpinnerNumberModel(options.
                getSimulationBoundedness(), 0,
                summary.getNumberOfAuditTrailEntries(), 1));
        boundedNessLabel.setText(
                "Maximum number of tokens per place while replaying log (0 = infinity).");
        ...
        thisOptionsPanel.add(boundedNessPanel,
                             new GridBagConstraints(0, i++, 2, 1, 0.0, 0.0
                , GridBagConstraints.WEST, GridBagConstraints.BOTH, INSETS, 0,
                0));
        // ==========================================================================
        ...
        thisOptionsPanel.add(maxPlacePanel,
                             new GridBagConstraints(0, i++, 2, 1, 0.0, 0.0
                , GridBagConstraints.WEST, GridBagConstraints.BOTH, INSETS, 0,
                0));
        // ==========================================================================
        ...
        // ==========================================================================
        restrictToDisconnectedTransCheck.setText(
                "Restrict search to disconnected transitions.");
        ...
        if (ISANALYSISPLUGIN) {
            thisOptionsPanel.add(restrictToDisconnectedTransPanel,
                                 new GridBagConstraints(0, i++, 2, 1,
                    0.0, 0.0
        ...
        // ==========================================================================
        removeExistingPlacesCheck.setText(
                "Remove existing places violating fitness.");
        removeExistingPlacesCheck.setEnabled(true);
        removeExistingPlacesCheck.setSelected(options.getRemoveExistingPlaces());
        ...
        // ==========================================================================
        useIntVarCheck.setText(
                "Use integer variables (not doing so gives an approximation).");
        ...
        thisOptionsPanel.add(useIntVarPanel,
                             new GridBagConstraints(0, i++, 2, 1, 0.0, 0.0
                , GridBagConstraints.WEST, GridBagConstraints.BOTH, INSETS, 0,
                0));
        // ==========================================================================
        ...
        elementaryNetCheck.addActionListener(new ActionListener() {
            ...
            private int bound = ((Integer) boundedNessSpin.getValue()).intValue();
        ...
        useCausalDepCheck.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                disAllowNonCausalCheck.setEnabled(useCausalDepCheck.isSelected());
        ...
        netTypeCombo.addActionListener(new ActionListener() {
            private int inBound = ((Integer) maxInEdgeSpin.getValue()).intValue();
            ...
            public void actionPerformed(ActionEvent e) {
                if (netTypeCombo.getSelectedItem().equals(
                    ...
                    if (maxInEdgeSpin.isEnabled()) {
                        // The in/out spinners arecurrently enabled, so store states
                        inBound = ((Integer) maxInEdgeSpin.getValue()).intValue();
    ...
    protected void updateOptions() {
        ...
        options.setMaxOutEdges(((Integer) maxOutEdgeSpin.getValue()).intValue());
