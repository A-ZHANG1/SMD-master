 ...
 * @version 1.0
 */
class RegionMinerOptionsPanel extends JPanel {
	...
	private void jbInit() throws Exception {
		...
		jRadioButton1.setText("Use all regions for calculation. This is the default setting.");
		...
		jRadioButton4.setText("Use only non-complimentary regions for calculation.");
		...
		jPanel1.add(jRadioButton1, new GridBagConstraints(0, 0, 2, 1, 1, 1,
				GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 5), 1, 0));
	...
	private JCheckBox doCleanupCheckBox = new JCheckBox("<html>Perform post-processing (i.e. regions to <br>Petri net to statespace to regions to Petrinet again)</html>",true);
