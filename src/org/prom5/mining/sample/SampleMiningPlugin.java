...
public class SampleMiningPlugin {
	...
	public SampleMiningResult mine(LogReader log, SampleMiningSettingsWithLogSummary settings) {
		return new SampleMiningResult(settings.getValue());
	}
	...
	public SampleMiningResult mine2(LogReader log, SampleMiningSettingsWithLogSummary settings) {
		return new SampleMiningResult(settings.getValue());
	}
}
