...
public class SemanticOrgMinerOptions extends JPanel implements GuiNotificationTarget {
...
//		values.add("Working Together (WT)");
		...
		bSuperOri = new GUIPropertyBoolean("Super concepts for originators", false);
...
////
		/*		ArrayList<String> values3 = new ArrayList<String>();
		  ...
		  workingTogether = new GuiPropertyListRadio("Options for WT", values3);
		 */
		...
		this.add(options.getPropertyPanel(), new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		this.add(doingSimilarTask.getPropertyPanel(), new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
//		this.add(workingTogether.getPropertyPanel(), new GridBagConstraints(0, 10, 1, 1, 0.0, 0.0
//				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		this.add(labelExtraOptions, new GridBagConstraints(0, 10, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		this.add(bSuperTask.getPropertyPanel(), new GridBagConstraints(0, 11, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		this.add(bSubTask.getPropertyPanel(), new GridBagConstraints(0, 12, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		this.add(bSuperOri.getPropertyPanel(), new GridBagConstraints(0, 13, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		this.add(bSubOri.getPropertyPanel(), new GridBagConstraints(0, 14, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
	}
	...
	/*	public int getWorkingTogetherSetting() {
	   ...
	   if (st.equals("Simultaneous appearance ratio"))return SIMULTANEOUS_APPEARANCE_RATIO;
	   else if (st.equals("Consider distance with causality"))return DISTANCE_WITH_CAUSALITY;
	   else return DISTANCE_WITHOUT_CAUSALITY;
	 }
	 */
	...
	public void updateGUI() {
		...
		/*		values = workingTogether.getAllValues();
		  if(options.getValue().equals("Working Together (WT)"))
		   for(int i=values.size()-1;i>=0;i--)
			workingTogether.enable((String)values.get(i));
		  else
		   for(int i=values.size()-1;i>=0;i--)
