...
public class OrgEditingPanel extends JPanel{
	...
	public OrgEditingPanel(OrgModelConcept orgmodel, SemanticOrgMiningResult parentpanel) {
	...
	private void init() {
		...
		OrgMiningTabbedPane gPanel = new OrgMiningTabbedPane(orgModel, parentPanel);

		JSplitPane splitPane = new JSplitPane(JSplitPane.VERTICAL_SPLIT, gPanel, graphPanel);
