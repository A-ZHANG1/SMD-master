...
public class OrgMiningResultPanel extends JTabbedPane {
		...
		public OrgMiningResultPanel(OrgModelConcept orgmod, SocialNetworkMatrix snmatrix, SemanticOrgMiningResult parent) {
			this.orgModel = orgmod;
			this.snMatrix = snmatrix;
			this.parentPanel = parent;
			if(snMatrix!=null){
				similarTaskResultPanel = new SimilarTaskResultPanel(orgModel, snMatrix, parentPanel);
				this.add(similarTaskResultPanel, "Mining Result: adjust threshold value");
			}
