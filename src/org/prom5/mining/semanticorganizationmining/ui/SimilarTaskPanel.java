...
import org.prom5.mining.semanticorganizationmining.SemanticOrgMinerOptions;
...
/*
	...
	public int getSimilarTaskSetting() {
		...
		if(st.equals("Euclidian distance")) return SemanticOrgMinerOptions.EUCLIDIAN_DISTANCE;
		else if (st.equals("Correlation coefficient")) return SemanticOrgMinerOptions.CORRELATION_COEFFICIENT;
		else if (st.equals("Similarity coefficient")) return SemanticOrgMinerOptions.SIMILARITY_COEFFICIENT;
		else return SemanticOrgMinerOptions.HAMMING_DISTANCE;
