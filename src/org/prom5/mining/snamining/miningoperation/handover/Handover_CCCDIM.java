...
public class Handover_CCCDIM extends BasicOperation {
	...
	// consider casuality, consider direct succession, ignore multiple appearance
	...
	public DoubleMatrix2D calculation() {
		...
		DoubleMatrix2D casualFollowerMatrix = relations.getCausalFollowerMatrix();
		...
		return UtilOperation.normalize(D, summary.getNumberOfProcessInstances());
	};
}
