package org.prom5.mining.snamining.miningoperation.reassignment;
...
public class Reassignment_CM extends BasicOperation {

	// consider multiple transfer

	public Reassignment_CM(LogSummary summary, LogReader log) {
		super(summary, log);
	};
			...
			if (ates.hasNext()) {
				...
				while (ates.hasNext()) {
					...
					if(ate.getOriginator()!=null){
						if (ate.getType().equals("reassign")) {
