			...
			if (ates.hasNext()) {
				...
				if (ates.hasNext()) {
					...
					while (ates.hasNext()) {
						...
						to_from = modelElements.findLogEventNumber(ate2.getElement(),ate2.getType());
						column_to = modelElements.findLogEventNumber(ate3.getElement(), ate3.getType());

						if ((casualFollowerMatrix.get(row_from, to_from) == 1)&&
								(casualFollowerMatrix.get(to_from, column_to) == 1)) {
