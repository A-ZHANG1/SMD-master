				...
				if (ates.hasNext()) {
					...
					while (ates.hasNext()) {
						...
						if(ate.getOriginator()!=null&&ate2.getOriginator()!=null&&ate3.getOriginator()!=null) {
							...
							row_from = modelElements.findLogEventNumber(ate.getElement(),
									   ate.getType());
							to_from = modelElements.findLogEventNumber(ate2.getElement(),
									  ate2.getType());
							column_to = modelElements.findLogEventNumber(ate3.getElement(),
										ate3.getType());
