...
public class PanelHandoverOfWork extends JPanel {
	...
	private void init(){
		...
		howMultipleTransfersLabel1.setText(
				"(unchecked: # of instances where HW happened / # of instances");
		howMultipleTransfersLabel2.setFont(new java.awt.Font("Dialog", 0, 9));
		howMultipleTransfersLabel2.setText(
				" checked: # of HW between originators / # of possible HWs)");
		howConsiderCausality.setText("Consider causality");
		howConsiderCausality.setSelected(true);
		howConsiderMultipleTransfers.setText("Consider multiple transfers within one instance");
		...
		this.add(howConsiderCausality, new GridBagConstraints(0, 0, 2, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		this.add(howConsiderMultipleTransfers, new GridBagConstraints(0, 1, 2, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		this.add(howConsiderDirectSuccession, new GridBagConstraints(0, 4, 2, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		...
		this.add(howDepthLabel, new GridBagConstraints(0, 6, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(3, 40, 0, 0), 0, 0));
		this.add(howBeta, new GridBagConstraints(1, 5, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 5, 0, 0), 0, 0));
		this.add(howMultipleTransfersLabel2, new GridBagConstraints(0, 3, 2, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 25, 0, 0), 0, 0));
		this.add(howMultipleTransfersLabel1, new GridBagConstraints(0, 2, 2, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 25, 0, 0), 0, 0));
