...
public class PanelReassignment extends JPanel {
	...
	private void init(){
		...
		this.add(raIgnoreMultipleTransfers, new GridBagConstraints(0, 1, 2, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
		this.add(raMultipleTransfersLabel2, new GridBagConstraints(0, 3, 2, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 25, 0, 0), 0, 0));
		this.add(raMultipleTransfersLabel1, new GridBagConstraints(0, 2, 2, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 25, 0, 0), 0, 0));
...
/*	public boolean getDirectReassignment()
	{
		return raDirectReassignment.isSelected();
	}*/
}
