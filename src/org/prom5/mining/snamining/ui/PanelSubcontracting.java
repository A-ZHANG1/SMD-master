...
public class PanelSubcontracting extends JPanel {
	...
	public void init()
	{
		...
		subMultipleTransfersLabel1.setText(
				"(unchecked: # of instances where SC happened / # of instances");
		subMultipleTransfersLabel2.setFont(new java.awt.Font("Dialog", 0, 9));
		subMultipleTransfersLabel2.setText(
				" checked: # of SCs between originators / # of possible SCs)");
		this.setLayout(gridBagLayout2);
		subConsiderCausality.setText("Consider causality");
		subConsiderCausality.setSelected(true);
		subConsiderMultipleTransfers.setText(
		...
		this.add(subConsiderCausality, new GridBagConstraints(0, 0, 2, 1,
				0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0),
				0, 0));
		this.add(subConsiderMultipleTransfers, new GridBagConstraints(0, 1,
				2, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 0, 0, 0),
				0, 0));
		...
		this.add(subBetaLabel, new GridBagConstraints(0, 5, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 40, 0, 0),
				0, 0));
		this.add(subDepth, new GridBagConstraints(1, 6, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(3, 5, 0, 0),
				0, 0));
		this.add(subDepthLabel, new GridBagConstraints(0, 6, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(3, 40, 0, 0),
				0, 0));
		this.add(subBeta, new GridBagConstraints(1, 5, 1, 1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 5, 0, 0),
				0, 0));
		this.add(subMultipleTransfersLabel1, new GridBagConstraints(0, 2, 2,
				1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 25, 0, 0),
				0, 0));
		this.add(subMultipleTransfersLabel2, new GridBagConstraints(0, 3, 2,
				1, 0.0, 0.0
				, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 25, 0, 0),
				0, 0));
