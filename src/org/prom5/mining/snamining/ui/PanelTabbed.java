package org.prom5.mining.snamining.ui;
...
public class PanelTabbed extends JTabbedPane {
	    ...
	    /**
		 * Returns the beta value specified by the user.
		 * This value only applies to SUBCONTRACTING, HANDOVER_OF_WORK and REASSIGNMENT.
		 *
		...
		/**
		 * Returns the specified depth of calculation.
		...
		/**
		 * Returns whether causality should be ignored.
		 * This value only applies to SUBCONTRACTING and HANDOVER_OF_WORK.
		 *
		...
		/**
		 * Returns whether multiple transfers should be ignored.
		 * This value only applies to SUBCONTRACTING and HANDOVER_OF_WORK.
		 *
		 ...
		 * This value only applies to SUBCONTRACTING and HANDOVER_OF_WORK.
		 *
		 * @return true if only direct succession/subcontracts should be considered, false otherwise
		 */
		...
		/**
		 * Returns the currently selected option for WORKING_TOGETHER.
		 * Can be one of the constants:
		 * SIMULTANEOUS_APPEARANCE_RATIO, DISTANCE_WITH_CAUSALITY or DISTANCE_WITHOUT_CAUSALITY.
		 *
		...
		/**
		 * Returns the currently selected option for REASSIGNMENT.
		 * Can be one of the constants:
		 * DIRECT_REASSIGNMENT or CONSIDER_DISTANCE.
		 *
		 * @return the currently selected option for REASSIGNMENT
		 */
		public int getReassignmentSetting() {
				return panelReassignment.getIgnoreMultipleTransfers() ? 0:SocialNetworkOptions.MULTIPLE_REASSIGNMENT;
		}

		/**
		 * Returns the currently selected option for SIMILAR_TASK.
		 * Can be one of the constants:
		 * EUCLIDIAN_DISTANCE, CORRELATION_COEFFICIENT, SIMILARITY_COEFFICIENT or HAMMING_DISTANCE.
		 *
