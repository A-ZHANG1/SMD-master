...
public class TSGeneratorOptionsPanel extends JPanel 
{
	...
	private void jbInit() throws Exception 
	{
		...
		topLabel = new JLabel("<html>The current log contains " +
				   summary.getNumberOfProcessInstances() + " process instances, <br>" +
				   "with " + summary.getNumberOfAuditTrailEntries() +
				   " audit trail entries <br>refering to " + summary.getLogEvents().size() +
				   " activities.</html>");
		...
		jBasicAlgoSetsButton.setText("<html>Generate Transition System with Sets<br>( Basic Algorithm )</html>");
		jBasicAlgoSetsButton.setSelected(true);
		mainPanel.add(jBasicAlgoSetsButton, 
		...
		jBasicAlgoBagsButton.setText("<html>Generate Transition System with Bags<br>( Basic Algorithm )</html>");
		jBasicAlgoBagsButton.setSelected(false);
		mainPanel.add(jBasicAlgoBagsButton, 
				 new GridBagConstraints(0, 1, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE,
						               new Insets(15,15,25,25), 1, 0)
				 );
		
		jExtendStrategyButton  = new JCheckBox();
		jExtendStrategyButton.setText("<html>Extend Strategy<br>( Algorithm adds Additional Transitions )</html>"); 
		jExtendStrategyButton.setSelected(false);
		mainPanel.add(jExtendStrategyButton, 
		...
		mainPanel.add(jLogTimestampsButton,
				 new GridBagConstraints(0, 2, 2, 1, 0, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
						 				new Insets(15,15,25,25), 0, 0)				
				 );
		...
		mainPanel.add(jEventTypesButton,
				 new GridBagConstraints(0, 3, 1, 1, 0, 0, GridBagConstraints.SOUTHWEST, GridBagConstraints.NONE,
						 				new Insets(15,15,25,25), 0, 0)				
				 );
		...
		mainPanel.add(jStateNamesButton,
				 new GridBagConstraints(1, 3, 1, 1, 0, 0, GridBagConstraints.SOUTHWEST, GridBagConstraints.NONE,
						 				new Insets(15,15,25,25), 0, 0)				
				 );
		...
		mainPanel.add(jKillLoopsButton,
				 new GridBagConstraints(0, 4, 2, 1, 0, 0, GridBagConstraints.SOUTHWEST, GridBagConstraints.NONE,
						 				new Insets(15,15,25,25), 0, 0)				
				 );
		...
		mainPanel.add(jExplicitEndButton,
				 new GridBagConstraints(1, 4, 1, 1, 0, 0, GridBagConstraints.SOUTHWEST, GridBagConstraints.NONE,
						 				new Insets(15,15,25,25), 0, 0)				
				 );
