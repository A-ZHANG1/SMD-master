...
package org.prom5.mining.yawlmining;
...
import org.prom5.framework.models.yawl.YawlNetHierarchy;
...
/**
 * <p>Title: YAWL Result</p>
 * <p>Description: MiningResult for YAWL
...
public class YAWLResult implements MiningResult, Provider, LogReaderConnection {
	...
	public YAWLResult(LogReader log, YAWLModel model) {
		...
		while (it.hasNext()) {
			...
			hierarchy.addHierarchyObject(decomposition, model, decomposition.getName());
		}
		this.log = log;
	}
	...
	public ProvidedObject[] getProvidedObjects() {
		return new ProvidedObject[] {
				new ProvidedObject("YAWL model", new Object[] {model})
		};
	}
