package org.prom6.plugins.causalnet.miner.settings;
...
//	protected double andThreshold = HeuristicsMinerConstants.AND_THRESHOLD; // NOT USED ANYMORE
	...
	protected boolean useUniqueStartEndTasks = false;
...
//	}
	...
	public boolean isUseUniqueStartEndTasks() {
		return useUniqueStartEndTasks;
	}
	
	public void setUseUniqueStartEndTasks(boolean useUniqueStartEndTasks) {
		this.useUniqueStartEndTasks = useUniqueStartEndTasks;
	}
