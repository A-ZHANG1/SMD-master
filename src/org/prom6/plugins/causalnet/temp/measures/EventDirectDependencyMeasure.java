...
public class EventDirectDependencyMeasure extends Measure {

	public static String CATEGORY = "Flow";
	public static String DESCRIPTION = "Direct Dependency Measure";
	public static String DESIGNATION = CATEGORY + "." + DESCRIPTION;
	
	public EventDirectDependencyMeasure(){
		
		super(
				new Class<?>[]{EventDirectSuccessor.class, Perspective.class, EventDirectSuccessor.class},	// Map of Event TID, Cell's constraints, Collection of Event TID 
