package org.prom6.plugins.guidetreeminer.scoringmatrices;
...
import org.prom6.plugins.guidetreeminer.util.UkkonenSuffixTree;
			...
			if (symbolContextSetMap.containsKey(symbolI)) {
				...
				for (String indelRightGivenLeftSymbolPair : countGivenLeftMap.keySet()) {
					...
					if (!leftSymbol.equals(commonSymbol)) {
						normCountSymbolPair = countGivenLeftMap.get(indelRightGivenLeftSymbolPair)
								/ normSymbolGivenLeft;
						indelRightGivenLeftScoreMap.put(indelRightGivenLeftSymbolPair, (new Double(Math
				...
				for (String indelLeftGivenRightSymbolPair : countGivenRightMap.keySet()) {
					...
					if (!rightSymbol.equals(commonSymbol)) {
						...
						indelLeftGivenRightScoreMap.put(indelLeftGivenRightSymbolPair, (new Double(Math
								.log(normCountSymbolPair
										/ (symbolProbabilityArray[i] * symbolProbabilityArray[symbolList
...
//					normSymbolGivenRight += countGivenRight;
		...
		int leftSymbolIndex, rightSymbolIndex;
			for (String indelRightGivenLeftSymbolPair : countGivenLeftMap.keySet()) {
				...
				if (!leftSymbol.equals(commonSymbol)) {
					normCountSymbolPair = countGivenLeftMap.get(indelRightGivenLeftSymbolPair)
							/ normSymbolGivenLeftArray[rightSymbolIndex];
					indelRightGivenLeftScoreMap.put(indelRightGivenLeftSymbolPair, (new Double(Math
							.log(normCountSymbolPair
									/ (symbolProbabilityArray[leftSymbolIndex] * symbolProbabilityArray[rightSymbolIndex]))).intValue()));
				}
			}
			...
			for (String indelLeftGivenRightSymbolPair : countGivenRightMap.keySet()) {
				...
				if (!rightSymbol.equals(commonSymbol)) {
					normCountSymbolPair = countGivenRightMap.get(indelLeftGivenRightSymbolPair)
							/ normSymbolGivenRightArray[leftSymbolIndex];
					indelLeftGivenRightScoreMap.put(indelLeftGivenRightSymbolPair, (new Double(Math
							.log(normCountSymbolPair
									/ (symbolProbabilityArray[leftSymbolIndex] * symbolProbabilityArray[rightSymbolIndex]))).intValue()));
				}
...
//					normSymbolGivenRight += countGivenRight;
		...
		int leftSymbolIndex, rightSymbolIndex;
			for (String indelRightGivenLeftSymbolPair : countGivenLeftMap.keySet()) {
				...
				if (!leftSymbol.equals(commonSymbol)) {
					normCountSymbolPair = countGivenLeftMap.get(indelRightGivenLeftSymbolPair)
							/ normSymbolGivenLeftArray[leftSymbolIndex];
					indelRightGivenLeftScoreMap.put(indelRightGivenLeftSymbolPair, (new Double(Math
							.log(normCountSymbolPair
									/ (symbolProbabilityArray[leftSymbolIndex] * symbolProbabilityArray[rightSymbolIndex]))).intValue()));
				}
			...
			for (String indelLeftGivenRightSymbolPair : countGivenRightMap.keySet()) {
				...
				if (!rightSymbol.equals(commonSymbol)) {
					normCountSymbolPair = countGivenRightMap.get(indelLeftGivenRightSymbolPair)
							/ normSymbolGivenRightArray[rightSymbolIndex];
					indelLeftGivenRightScoreMap.put(indelLeftGivenRightSymbolPair, (new Double(Math
							.log(normCountSymbolPair
									/ (symbolProbabilityArray[leftSymbolIndex] * symbolProbabilityArray[rightSymbolIndex]))).intValue()));
				}
