package org.prom6.plugins.heuristicsnet.miner.heuristics;
...
private int eventsNumber, tracesNumber, instancesNumber;
	...
	public void printData(){
		...
		log("Events Number: " + eventsNumber);
		log("Traces Number: " + tracesNumber);
		log("Instances Number: " + instancesNumber + "\n");

		log("Long Range Succession Count\n" + longRangeSuccessionCount + "\n");
		log("Long Range Dependency Measures\n" + longRangeDependencyMeasures + "\n");
		log("L1L Dependency Measures All\n" + L1LdependencyMeasuresAll + "\n");
		log("And In Measures All\n" + andInMeasuresAll + "\n");
		log("And Out Measures All\n" + andOutMeasuresAll + "\n");
		log("L2L Dependency Measures All\n" + L2LdependencyMeasuresAll + "\n");
		log("AB Dependency Measures All\n" + ABdependencyMeasuresAll + "\n");
		log("Dependency Measures Accepted\n" + dependencyMeasuresAccepted + "\n");
		log("Noise Counters\n" + noiseCounters + "\n");

		log("Event Counter\n" + eventCount + "\n");
		log("Start Counter\n" + startCount + "\n");
		log("End Counter\n" + endCount + "\n");
		log("Direct Succession Counter\n" + directSuccessionCount + "\n");
		log("Succession 2 Counter\n" + succession2Count + "\n");
