...
import org.prom6.models.heuristics.impl.ActivitiesMappingStructures;
import org.prom6.models.heuristics.impl.HNSet;
import org.prom6.models.heuristics.impl.HNSubSet;
import org.prom6.models.heuristics.impl.HeuristicsNetImpl;
import org.prom6.plugins.heuristicsnet.SimpleHeuristicsNet;
import org.prom6.plugins.heuristicsnet.miner.heuristics.HeuristicsMetrics;
import org.prom6.plugins.heuristicsnet.miner.heuristics.miner.fitness.ContinuousSemantics;
import org.prom6.plugins.heuristicsnet.miner.heuristics.miner.fitness.ImprovedContinuousSemantics;
...
public class HeuristicsMiner {
	...
	public HeuristicsMiner(PluginContext context, XLog log) {
	...
	public HeuristicsMiner(PluginContext context, XLog log, XLogInfo logInfo) {
	...
	public HeuristicsMiner(PluginContext context, XLog log, XLogInfo logInfo, HeuristicsMinerSettings settings) {

		this(context, log, logInfo);
		this.settings = settings;
	}

	public HeuristicsMiner(PluginContext context, XLog log, HeuristicsMinerSettings settings) {
...
//				String eventTransition = XLogInfoImpl.LIFECYCLE_TRANSITION_CLASSIFIER.getClassIdentity(event);
				...
				//log(penultEventIndex+"\t"+lastEventIndex);
			}
...
//			}
		...
		log("Best Start: " + metrics.getBestStart());
		log("Best End: " + metrics.getBestEnd() + "\n");
		...
		log("Connections Number: " + numberOfConnections);
		log("Noise: " + noiseTotal + "\n");
