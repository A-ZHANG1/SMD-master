package org.prom6.plugins.heuristicsnet.miner.heuristics.miner.gui;
...
import org.prom6.plugins.heuristicsnet.miner.heuristics.miner.operators.Operator;
	...
	public HeuristicsNetVisualization(final ProMJGraph graph,
		...
		if (this.net instanceof SimpleHeuristicsNet) {
			...
			if (this.net instanceof AnnotatedHeuristicsNet) {
				...
				this.parameters.setBounds(10, 10, 520, 360);
			} else
				this.parameters.setBounds(10, 10, 520, 390);
			...
			public void valueChanged(GraphSelectionEvent e) {
				...
				if (net instanceof AnnotatedHeuristicsNet) {
					...
					if (nodesAdded.size() == 1) {
						...
						nodeID += nodeLabel.substring(0, nodeLabel
								.indexOf("<br />"));
