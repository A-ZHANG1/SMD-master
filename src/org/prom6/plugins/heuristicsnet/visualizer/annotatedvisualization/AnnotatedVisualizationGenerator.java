package org.prom6.plugins.heuristicsnet.visualizer.annotatedvisualization;
...
//		}
		...
		for(Activity activity : graph.getActivities()){
			...
			if(keys.containsKey(activityLabel)){
				...
				String activityName = activityLabel.substring(0, divisorIndex);
				String activityType = activityLabel.substring(divisorIndex + 1);		
